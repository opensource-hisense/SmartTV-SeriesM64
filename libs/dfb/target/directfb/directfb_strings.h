...
#define DirectFBPixelFormatNames(Identifier) struct DFBPixelFormatName Identifier[] = { \
     ...
     { DSPF_LUT1, "LUT1" }, \
     { DSPF_ABGR, "ABGR" }, \
     { DSPF_BLINK12355, "BLINK12355" }, \
     { DSPF_BLINK2266, "BLINK2266" }, \
...
#define DirectFBSurfaceDrawingFlagsNames(Identifier) struct DFBSurfaceDrawingFlagsName Identifier[] = { \
     ...
     { DSDRAW_XOR, "XOR" }, \
     { DSDRAW_COLOR_GRADIENT_X, "COLOR_GRADIENT_X" }, \
     { DSDRAW_COLOR_GRADIENT_Y, "COLOR_GRADIENT_Y" }, \
     { DSDRAW_NOFX, "NOFX" } \
};
...
#define DirectFBSurfaceBlittingFlagsNames(Identifier) struct DFBSurfaceBlittingFlagsName Identifier[] = { \
     ...
     { DSBLIT_BLINK_BACKGROUND, "BLINK_BACKGROUND" }, \
     { DSBLIT_BLINK_FOREGROUND, "BLINK_FOREGROUND" }, \
     { DSBLIT_FA_SOLID, "FA_SOLID" }, \
     { DSBLIT_FA_FLASH, "FA_FLASH" }, \
     { DSBLIT_FA_TRANSLUCENT, "FA_TRANSLUCENT" }, \
     { DSBLIT_FA_TRANSPARENT, "FA_TRANSPARENT" }, \
     { DSBLIT_BA_SOLID, "BA_SOLID" }, \
     { DSBLIT_BA_NOUSE, "BA_NOUSE" }, \
     { DSBLIT_BA_TRANSLUCENT, "BA_TRANSLUCENT" }, \
     { DSBLIT_BA_TRANSPARENT, "BA_TRANSPARENT" }, \
     { DSBLIT_NOFX, "NOFX" } \
};
...
#define DirectFBSurfaceBlendFunctionNames(Identifier) struct DFBSurfaceBlendFunctionName Identifier[] = { \
     ...
     { DSBF_ACMP_OP_NONE, "ACMP_OP_NONE" }, \
     { DSBF_ACMP_OP_MAX, "ACMP_OP_MAX" }, \
...
#define DirectFBWindowOptionsNames(Identifier) struct DFBWindowOptionsName Identifier[] = { \
     ...
     { DWOP_SCALE, "SCALE" }, \
     { DWOP_SCALE_WINDOW_AUTOFIT_LAYER, "SCALE_WINDOW_AUTOFIT_LAYER" }, \
