...
#define DirectFBKeySymbolNames(Identifier) struct DFBKeySymbolName Identifier[] = { \
     ...
     { DIKS_INDEX, "INDEX" }, \
     { DIKS_MIX, "MIX" }, \
     { DIKS_TTX_MODE, "TTX_MODE" }, \
     { DIKS_PICTURE, "PICTURE" }, \
     { DIKS_MTS, "MTS" }, \
     { DIKS_SIZE, "SIZE" }, \
     { DIKS_SLEEP, "SLEEP" }, \
     { DIKS_FREEZE, "FREEZE" }, \
     { DIKS_REVEAL, "REVEAL" }, \
     { DIKS_CHANNEL_RETURN, "CHANNEL_RETURN" }, \
     { DIKS_CLOCK, "CLOCK" }, \
     { DIKS_BACKWARD, "BACKWARD" }, \
     { DIKS_CHANNEL_FAV_LIST, "CHANNEL_FAV_LIST" }, \
     { DIKS_HOLD, "HOLD" }, \
     { DIKS_BALANCE, "BALANCE" }, \
     { DIKS_PIP, "PIP" }, \
     { DIKS_GUIDE, "GUIDE" }, \
     { DIKS_SUBCODE, "SUBCODE" }, \
     { DIKS_ZOOMIN, "ZOOMIN" }, \
     { DIKS_ZOOMOUT, "ZOOMOUT" }, \
     { DIKS_MIDEA, "MIDEA" }, \
     { DIKS_DIAL_NFLX, "DIAL_NFLX" }, \
     { DIKS_DIAL_YTTV, "DIAL_YTTV" }, \
     { DIKS_F1, "F1" }, \
     { DIKS_F2, "F2" }, \
     { DIKS_F3, "F3" }, \
     { DIKS_F4, "F4" }, \
