...
void dfb_back_to_front_stretch_copy_rotation( CoreSurface *surface, const DFBRegion *regiondst,
                       const DFBRegion *regionsrc, DFBSurfaceBlittingFlags flags, int rotation);

void dfb_back_to_front_stretch_copy_with_clipRegion( CoreSurface *surface, const DFBRegion *regiondst,
                       const DFBRegion *regionsrc, DFBSurfaceBlittingFlags flags, const DFBRegion *clip);
