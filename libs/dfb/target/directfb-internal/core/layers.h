...
{
  bool bShadowLayer;
  bool bindShadowLayer;
  bool unbindShadowLayer;
...
struct __DFB_CoreLayerRegionConfig {
     ...
     DFBBoolean                 btile_mode;        /*layer tile or linear: true means tile*/

     DISPLAYER_STRETCH_HMODE    hstretchmode;      /*layer h stretch mode*/
     DISPLAYER_STRETCH_VMODE    vstretchmode;      /*layer v stretch mode */
     
     DISPLAYER_STRCH_TRANSPCOLORMODE     tstretchmode;      /*layer transparent mode*/
...
typedef struct {
   ...
   /*
   * Config ShadowLayer related info   
     */

   DFBResult (*ConfigShadowLayer)(  CoreLayer              *layer,
                                         void                   *driver_data,
                                         void                   *layer_data,
                                         ShadowLayerConfig      *shadowLayer_info);


   /*Config DisplayMode of displaylayer mode */
   DFBResult (*ConfigDisplayMode)(CoreLayer *layer,
                                  void     *driver_data,
                                  void     *layer_data,
                                  CoreSurface            *surface,
                                  CoreSurfaceBufferLock  *lock,
   ...
   /*
   *  Set Display Mirro Mode  
     */

   DFBResult (*SetHVMirrorEnable)(  CoreLayer              *layer,
                                         void                   *driver_data,
                                         void                   *layer_data,
                                         bool                    HEnable,
                                         bool                    VEnable);
   ...
   *  Set LBCouple Mode  
   ...
   DFBResult (*SetLBCoupleEnable)(  CoreLayer              *layer,
                                         void                   *driver_data,
                                         void                   *layer_data,
                                         bool                    LBCoupleEnable);

     /*
   *  Set GOP Dst ByPass Mode  
     */

   DFBResult (*SetGOPDstByPassEnable)(  CoreLayer              *layer,
                                         void                   *driver_data,
                                         void                   *layer_data,
                                         bool                    ByPassEnable);
   ...
   *  Set Display Mirro Mode  
   ...
   DFBResult (*SetHVScale)(  CoreLayer              *layer,
                                         void                   *driver_data,
                                         void                   *layer_data,
                                         void                   *region_data,
                                         int                    HScale,
   ...
   *  Set Layer GOP Dst   
   ...
   DFBResult (*SetGOPDst)(  CoreLayer              *layer,
                                         void                   *driver_data,
                                         void                   *layer_data,
                                         DFBDisplayLayerGOPDST           GopDst); 
   DFBResult (*SetForceWrite)(  CoreLayer              *layer,
                                         void                   *driver_data,
                                         void                   *layer_data,
                                         bool                    force_write);
   DFBResult (*GetGOPDst)(  CoreLayer              *layer,
                                         void                   *driver_data,
                                         void                   *layer_data,
                                         DFBDisplayLayerGOPDST           *GopDst); 


   DFBResult (*SetBootLogoPatch)( CoreLayer              *layer,
                                  void                   *driver_data,
                                  void                   *layer_data,
                                  int           miusel);     


DFBResult (*GetScreen)( CoreLayer *layer, CoreScreen **ret_screen);
...
// TO push a operation to master
FusionCallHandlerResult sync_call_handler( int           caller,
              int           call_arg,
              void         *call_ptr,
              void         *ctx,
              unsigned int  serial,
