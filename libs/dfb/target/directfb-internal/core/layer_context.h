...
DFBResult dfb_layer_context_set_screenposition ( CoreLayerContext            *context,
                                                 int                          x,
                                                 int                          y );
DFBResult dfb_layer_context_set_alphamode( CoreLayerContext                 *context,
...
DFBResult dfb_layer_context_set_tilemode        (CoreLayerContext           *context,
                                                    bool                    tilemode);


DFBResult dfb_layer_context_set_stretchsetting (CoreLayerContext * context,
                                                    DFBDisplayLayerStretchSetting stretch_setting);
...
DFBResult
dfb_layer_context_redo_activate( CoreLayerContext *context );

DFBResult 
dfb_layer_context_config_shadowlayer(CoreLayerContext *context, CoreLayerContext *shadowLayer_context, bool Bind);

DFBResult
dfb_layer_context_set_displayMode(CoreLayerContext *context,DFBDisplayLayerDeskTopDisplayMode display_mode);
