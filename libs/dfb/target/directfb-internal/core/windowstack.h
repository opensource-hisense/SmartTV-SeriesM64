...
DFBResult
dfb_windowstack_set_desktop_mode ( CoreWindowStack               *stack,
                                      DFBDisplayLayerDeskTopDisplayMode  mode );
...
DFBResult dfb_windowstack_get_cursor_position (CoreWindowStack *stack,
                                               ...
                                               int             *y);
DFBResult
dfb_windowstack_move_cursor_to( CoreWindowStack *stack, int x, int y);

DFBResult
dfb_windowstack_get_activewindow_num( CoreWindowStack *stack, int *ret_num);

DFBResult
dfb_windowstack_set_force_fullupdate(CoreWindowStack *stack,bool bforceupdate);

DFBResult
dfb_windowstack_get_force_fullupdate(CoreWindowStack *stack,void *pstate);
