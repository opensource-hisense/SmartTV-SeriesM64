...
typedef struct _TLBMemInfo     TLBMemInfo;
...
struct _SurfaceManager {
    ...
    int                  offset;                     /*addr space start*/
    int                  avail;          /* amount of available memory in bytes */
    int                  length;         /* length of the heap in bytes */
    int                  miu0_videoMem_length;
    int                  miu1_videoMem_length;
    int                  miu0_videoMem_avail;
    int                  miu1_videoMem_avail; 
    int                  min_toleration;
...
DFBResult dfb_surfacemanager_create ( CoreDFB             *core,
                                      SurfaceManager     **ret_manager, TLBMemInfo    *tlbMemInfo);
...
DFBResult dfb_surfacemanager_fragmentMerge( CoreDFB                *core,
                                            SurfaceManager          *manager,
                                            void               *pool_local);
