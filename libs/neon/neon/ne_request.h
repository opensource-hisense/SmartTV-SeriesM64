...
#define NE_RESET (10) /* Connection reset by peer */

#define NE_SOCKET_ERROR			 -1 /* for return value of ne_read_response_block(), NE_ERROR, NE_LOOKUP, NE_AUTH, NE_PROXYAUTH, NE_CONNECT, NE_FAILED, NE_RETRY, NE_REDIRECT*/
#define NE_SOCKET_TIMEOUT		 -2 /* for return value of ne_read_response_block(), NE_TIMEOUT*/
#define NE_SOCKET_RESET		     -3 /* for return value of ne_read_response_block(), NE_RESET */
