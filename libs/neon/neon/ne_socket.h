...
/* RR1358 : data type declaration */
typedef enum _NE_SSL_REVOKE_MODE {
	SSL_CRCHECKER_NONE         = 0
	, SSL_CRCHECKER_OCSP       = 1
	, SSL_CRCHECKER_OCSP_STAPLING = 2
	, SSL_CRCHECKER_CRLSET     = 4
	, SSL_CRCHECKER_noCRLSET   = SSL_CRCHECKER_OCSP | SSL_CRCHECKER_OCSP_STAPLING
	, SSL_CRCHECKER_noOCSP     = SSL_CRCHECKER_OCSP_STAPLING | SSL_CRCHECKER_CRLSET
	, SSL_CRCHECKER_noSTAPLING = SSL_CRCHECKER_OCSP | SSL_CRCHECKER_CRLSET
	, SSL_CRCHECKER_ALL        = SSL_CRCHECKER_OCSP | SSL_CRCHECKER_OCSP_STAPLING | SSL_CRCHECKER_CRLSET
} NE_SSL_REVOKE_MODE;
...
/* RR1358 set which revoke mode to socket */
void ne_sock_set_revoke_mode(ne_socket *sock, int nRevokeMode);

/* RR1358 initialize the API function pointer from libCRC.so */
int ne_sock_init_CRC_func(ne_socket *sock);

/* RR1358 call doCRCVerify API of libCRC.so */
int ne_sock_doCRCVerify(ne_socket *sock, void *chain, char* szClientCAPath);
