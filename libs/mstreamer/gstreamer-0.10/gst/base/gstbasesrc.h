...
struct _GstBaseSrcClass {
  ...
  /* get the corresponding offset of time-based seek */
  gboolean      (*get_offset_sync_with_time_seek)     (GstBaseSrc *src, guint64 *offset);
...
void            gst_base_src_neon_oomcallback (void);
G_END_DECLS
