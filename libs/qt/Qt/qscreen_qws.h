...
public:
    ...
    // fixed mantis 0867231: ginga, improve dfb performance (swap mode or blit mode)    
    virtual void setCursorId(int cursor_id) {}
...
public:
    ...
    virtual void changeResolutionReleaseTemp() = 0;
    virtual void enableMixer2VE(bool flag) = 0;
    virtual void enableMouseLeftHanded(bool isMouseLeftHanded) = 0;
    virtual void save();
    ...
    int deviceScreenWidth() const { return screenW; }
    int deviceScreenHeight() const { return screenH; }
