...
public:
    QKeyEvent(Type type, int key, Qt::KeyboardModifiers modifiers, const QString& text = QString(),
              bool autorep = false, ushort count = 1, Qt::KeyDeviceId deviceId = Qt::StandardKeyboard);
    ~QKeyEvent();
    ...
    inline Qt::KeyDeviceId deviceId() const { return devId; }
