...
public:
    ...
    static void addOriginAccessWhitelistEntry(const QUrl& sourceOrigin, const QString& destinationProtocol, const QString& destinationDomain, bool allowDestinationSubdomains);
    static void removeOriginAccessWhitelistEntry(const QUrl& sourceOrigin, const QString& destinationProtocol, const QString& destinationDomain, bool allowDestinationSubdomains);
