...
inline void _chip_flush_miu_pipe(void)
{
    ...
    *(volatile unsigned int *)(0xbf203104) |= _BIT(4);
    ...
    do
    {
      ...
      defined(CONFIG_MARLON) || \
      defined(CONFIG_MULAN)
...
#elif defined(CONFIG_KENYA) || defined(CONFIG_KERES) || defined(CONFIG_KIRIN) || defined(CONFIG_KRITI)|| (CONFIG_KRATOS) || defined(CONFIG_KRIS)|| defined(CONFIG_KAYLA) || defined(CONFIG_K5TN) || defined(CONFIG_KIWI)
...
void Chip_L2_cache_wback_inv( unsigned long addr, unsigned long size)
{
    ...
    else
    {
	  ...
	  defined(CONFIG_KRATOS)   || \
	  defined(CONFIG_KERES)    || \
	  defined(CONFIG_KIRIN)    || \
	  defined(CONFIG_KIWI)    || \
	  defined(CONFIG_KAYLA)    || \
	  defined(CONFIG_K5TN)    || \
      defined(CONFIG_KRIS)
