...
#if defined(CONFIG_TITANIA8) || defined(CONFIG_TITANIA12) || defined(CONFIG_JANUS2) || defined(CONFIG_AMBER2) || defined(CONFIG_AMBER5)
// Baud rate
#define UART_BAUD_RATE	            115200//38400 //9600 //19200 //38400 //57600 //115200 =>too frequent Rx INT
// Clock source
#define UART_CLK_FREQ               123000000//43200000 //123000000//14318180
...
#if defined(CONFIG_URANUS4) || defined(CONFIG_KRONUS) || defined(CONFIG_KAISERIN) || defined(CONFIG_KENYA) || defined(CONFIG_KERES) || defined(CONFIG_KIRIN) || defined(CONFIG_KRITI)|| defined(CONFIG_KRATOS) ||defined(CONFIG_KRIS) ||defined(CONFIG_KIWI)
#define UART_BAUD_RATE	            115200//38400 //9600 //19200 //38400 //57600 //115200 =>too frequent Rx INT
// Clock source
#define UART_CLK_FREQ               123000000//43200000 //123000000//14318180
#endif
...
#define UART_CLK_FREQ               12000000    //  12   MHz for FPGA
#else
#define UART_BAUD_RATE	            115200       // =>too frequent Rx INT
#define UART_CLK_FREQ               172800000   // 172.8 Mhz for real chip
#endif
#endif
...
#if defined(__ARM__)
#define REG_UART0_BASE              0x1F201300
#define REG_UART1_BASE              0x1F201300
#define REG_UART2_BASE              0x1F201300
#else
#define REG_UART0_BASE              0xBF201300
#define REG_UART1_BASE              0xBF201300
#define REG_UART2_BASE              0xBF201300
#endif 
