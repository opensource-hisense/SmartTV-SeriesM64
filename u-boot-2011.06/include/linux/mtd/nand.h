...
#define NAND_STATUS_HWFAIL		0x12
...
struct nand_chip {
    ...
    int          (*block_markbad_e)(struct mtd_info *mtd, loff_t ofs);    
	...
	int 		state;
    unsigned short ecc_corretable_bit;
	unsigned short ecc_bitflip_threshold;
