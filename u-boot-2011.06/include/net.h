...
#define LOAD_MAC_FROM_SPI_ENABLE 0

#if(LOAD_MAC_FROM_SPI_ENABLE==1)
#define MAC_DRAMADDR        0x80400000
#define MAC_SPIADDR            0x1D0000  //Need the same with the board config
#define MAC_LEN                     6
#endif
/*
...
//MSTAR: added
extern int uEMAC_start;
extern int uUSB_LAN_start;
//MSTAR: end
