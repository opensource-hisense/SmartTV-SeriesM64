...
#if defined(CONFIG_KENYA)||defined(CONFIG_KERES)||defined(CONFIG_KRIS)|| defined(CONFIG_KAYLA) || defined(CONFIG_K5TN) ||defined(CONFIG_KIRIN)||defined(CONFIG_KRATOS)||defined(CONFIG_KIWI)
    disable_interrupts();
