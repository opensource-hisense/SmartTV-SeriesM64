...
/****************************************************************************/
#if CVT_EN_LED_FLICKER
static BOOLEAN IsSysNeedToBoot(void)
{
    BOOLEAN ret = TRUE;
...
//Mstar Start
        ...
        if(s == NULL)
        {
            printf("ERROR: no bootcmd environment!!!\n");
...
int run_command (const char *cmd, int flag)
{
	...
	puts ("\"\n");
#endif
#if 1//defined(CONFIG_LED_FLICKER_WHEN_SW_UPDATE)
	loop_time_handle();//Evan add for SW LED timer
#endif
