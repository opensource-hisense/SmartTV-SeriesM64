...
void kernel_power_off(void)
{
      ...
      int i = 0;
#endif/*MP_PLATFORM_PM */
	printk("!!!!!!!!!!!!!!!!!!!!!HERE IS LINE:%d at FUNCTION:%s\n",__LINE__,__FUNCTION__);
...
#if defined(CONFIG_MSTAR_PM_ADDR)
#if defined(CONFIG_MP_PLATFORM_MIPS)
    //g_pm_Iaddress = 0x3412000;g_pm_Isize = 0x8000;g_pm_Daddress = 0x341A000;g_pm_Dsize = 0x8000;g_pm_run = 0x3412400;
    printk("boot : ORIGIN = 0x%x, LENGTH = 0x%x\n", (unsigned int)(g_pm_Iaddress|KSEG0_BASE), (unsigned int)g_pm_Isize);
    printk("data : ORIGIN = 0x%x, LENGTH = 0x%x\n", (unsigned int)(g_pm_Daddress|KSEG0_BASE), (unsigned int)g_pm_Dsize);
    printk("start: 0x%x\n", (unsigned int)(g_pm_run|KSEG0_BASE));

    _dma_cache_wback_inv((unsigned long)__va(g_pm_Iaddress|KSEG0_BASE), 0x10000);
    ...
    // fill icache
    ric_fill_icache((void *)(g_pm_Iaddress|KSEG1_BASE), g_pm_Isize);
    ric_fill_dcache((void *)(g_pm_Daddress|KSEG1_BASE), g_pm_Dsize);
    ...
    //*(volatile unsigned int *)(0xBF000000 + (0x101EE2 << 1)) = 0x0002;    //for ICE
