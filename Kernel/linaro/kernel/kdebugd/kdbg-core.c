 ...
 *
 */
static unsigned int kdbg_auto_key_test_buffer_size;

/*auto key test activate*/
static int kdbg_auto_key_test_activate(void);

/* for /proc/kdbeugd/auto_key_test writing */
static int kdbg_auto_key_test_write(struct file *file, const char *buffer,
				    unsigned long count, void *data);

/* for /proc/kdbeugd/auto_key_test  reading */
static int kdbg_auto_key_test_read(char *buffer, char **buffer_location,
 ...
 *
 */
int kdbg_auto_key_test_write(struct file *file, const char *buffer,
			     unsigned long count, void *data)
{
	debugd_event_t event;
	char *ptr = NULL;
