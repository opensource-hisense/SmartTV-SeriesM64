...
void Mstar_Chip_hw0_irqhyp_dispatch(void)
{
    ...
    while (32> (u32Bit = MAsm_CPU_GetTrailOne(u16Reg)))
    {
        ...
        eIntNum = (InterruptNum)(u32Bit+ E_IRQHYPL_START);
        generic_handle_irq((unsigned int)eIntNum);
        u16Reg &= ~(0x1<< u32Bit);
    }
    ...
    while (32> (u32Bit = MAsm_CPU_GetTrailOne(u16Reg)))
    {
        eIntNum = (InterruptNum)(u32Bit+ E_IRQHYPH_START);
        generic_handle_irq((unsigned int)eIntNum);
        u16Reg &= ~(0x1<< u32Bit);
    }
    ...
    while (32> (u32Bit = MAsm_CPU_GetTrailOne(u16Reg)))
    {
        eIntNum = (InterruptNum)(u32Bit+ E_IRQSUPL_START);
        generic_handle_irq((unsigned int)eIntNum);
        u16Reg &= ~(0x1<< u32Bit);
    }
    ...
    while (32> (u32Bit = MAsm_CPU_GetTrailOne(u16Reg)))
    {
        eIntNum = (InterruptNum)(u32Bit+ E_IRQSUPH_START);
        generic_handle_irq((unsigned int)eIntNum);
        u16Reg &= ~(0x1<< u32Bit);
    }
...
void Mstar_Chip_hw0_fiqhyp_dispatch(void)
{
    ...
    while (32> (u32Bit = MAsm_CPU_GetTrailOne(u16Reg)))
    {
        eIntNum = (InterruptNum)(u32Bit+ E_FIQHYPL_START);
        generic_handle_irq((unsigned int)eIntNum);
        u16Reg &= ~(0x1<< u32Bit);
    }
    ...
    while (32> (u32Bit = MAsm_CPU_GetTrailOne(u16Reg)))
    {
        eIntNum = (InterruptNum)(u32Bit+ E_FIQHYPH_START);
        generic_handle_irq((unsigned int)eIntNum);
        u16Reg &= ~(0x1<< u32Bit);
    }
    ...
    while (32> (u32Bit = MAsm_CPU_GetTrailOne(u16Reg)))
    {
        eIntNum = (InterruptNum)(u32Bit+ E_FIQSUPL_START);
        generic_handle_irq((unsigned int)eIntNum);
        u16Reg &= ~(0x1<< u32Bit);
    }
    ...
    while (32> (u32Bit = MAsm_CPU_GetTrailOne(u16Reg)))
    {
        eIntNum = (InterruptNum)(u32Bit+ E_FIQSUPH_START);
        generic_handle_irq((unsigned int)eIntNum);
        u16Reg &= ~(0x1<< u32Bit);
    }
