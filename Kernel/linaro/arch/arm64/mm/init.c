...
#ifndef CONFIG_MP_CMA_PATCH_CMA_DEFAULT_BUFFER_LIMITTED_TO_LX1
...
#else
    // this is to limit cma default buffer at LX_MEM, but if LX_MEM acrosses sections(1GB), mi->bank[0] will be splited to mi->bank[0] and mi->bank[1], --> this is for clippers
