...
#if defined(CONFIG_ARM64)
	extern unsigned int * uncached_buf;
	extern dma_addr_t   buf_phy_addr;
	extern void * arm64_swiotlb_alloc_coherent();
	uncached_buf = arm64_swiotlb_alloc_coherent(NULL,4 ,&buf_phy_addr, GFP_KERNEL,NULL); 
#endif
