...
cp ./arch/arm/Makefile_mstar ./arch/arm/Makefile
cp ./arch/arm/Kconfig_mstar ./arch/arm/Kconfig
cp ./drivers/Makefile_mstar ./drivers/Makefile
...
[ ! -e ./arch/mips/Kconfig_kdrv ] && ln -s ../../mstar/mstar/Kconfig ./arch/mips/Kconfig_kdrv
