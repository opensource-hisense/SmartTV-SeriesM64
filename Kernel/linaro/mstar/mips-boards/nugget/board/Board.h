...
#define IR_TYPE_HWRC5               26
#define IR_TYPE_XMP1                27
#define IR_TYPE_HWRC5EX             28
#define IR_TYPE_VESTEL_RC5          29
...
#if defined(CONFIG_MSTAR_TITANIA13_BD_FPGA) || defined(CONFIG_MSTAR_NUGGET_BD_FPGA)
    #define MS_BOARD_TYPE_SEL       BD_FPGA
#elif defined(CONFIG_MSTAR_TITANIA13_BD_GENERIC) || defined(CONFIG_MSTAR_NUGGET_BD_GENERIC)
