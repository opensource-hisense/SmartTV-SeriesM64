...
#include "../arch/mips/mips-boards/kratos/serial_reg.h"
#define UART_REG(addr) *((volatile unsigned int*)(0xBF201300 + ((addr)<< 2)))
#endif
...
#ifdef CONFIG_MSTAR_MULAN
#include "../arch/mips/mips-boards/mulan/serial_reg.h"
#define UART_REG(addr) *((volatile unsigned int*)(0xBF201300 + ((addr)<< 2)))
#endif

#ifdef CONFIG_MSTAR_KRIS
#include "../arch/mips/mips-boards/kris/serial_reg.h"
#define UART_REG(addr) *((volatile unsigned int*)(0xBF201300 + ((addr)<< 2)))
#endif

#ifdef CONFIG_MSTAR_KIRIN
#include "../arch/mips/mips-boards/kirin/serial_reg.h"
#define UART_REG(addr) *((volatile unsigned int*)(0xBF201300 + ((addr)<< 2)))
#endif
