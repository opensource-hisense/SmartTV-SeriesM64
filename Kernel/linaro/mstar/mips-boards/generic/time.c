...
#if defined(CONFIG_MSTAR_KAPPA) || defined(CONFIG_MSTAR_KENYA) || defined(CONFIG_MSTAR_KERES) || defined(CONFIG_MSTAR_KRITI) || defined(CONFIG_MSTAR_KIRIN) || defined(CONFIG_MSTAR_KRATOS)
