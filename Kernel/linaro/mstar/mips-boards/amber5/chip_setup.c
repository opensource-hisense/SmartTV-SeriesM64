...
static unsigned int u32L2ChipRev=0xffffffff;
//static unsigned int u32L2CacheLineMask=0xffffffff;
static unsigned int u32L2CacheEnabled=0;
static unsigned int u32L2WriteThrough=0;
static unsigned int u32L2AllInCache=0;

static unsigned int    dwCacheLineSize = 0;

#define DISABLE_MIPS_SYNC_OP    1
#define MIPS_L2_WB_INV_TH       8192    //0x100000    // 1MB
#define MIPS_L2_WB_TH           8192    //0x100000    // 1MB
#define MIPS_L2_INV_TH          8192    //0x10000000    // 256MB
...
#if defined(CONFIG_MSTAR_AMBER5_MMAP_128MB_128MB)
...
{
//#ifdef  CONFIG_MSTAR_AMBER5_BD_FPGA
#if 0
    //FOR_FPGA_UART
...
///// Switch PAD ISP//////////////////////////////////////////////////////////
    ...
    *(volatile volatile unsigned int*)(0xbf203d4c) |= 0x0004;
    ...
    //ori     $11, $11,   0x0400
    //sw      $11,        0xbf203c04
    //*(volatile volatile unsigned int*)(0xbf203c04) |= 0x0400; //decided by MBoot, not Kernel
...
inline void _chip_flush_miu_pipe(void)
{
    ...
    *(volatile unsigned int *)(0xbf203104) |= BIT4;
...
void Chip_L2_cache_wback_inv( unsigned long addr, unsigned long size)
{
	...
	else
	{
        if( size >= MIPS_L2_WB_INV_TH )
        {
            ...
            dwReadData = *(volatile unsigned int *)(0xbf203104);
            dwReadData = ((dwReadData & 0xFFFFFFF0) | 0x04);    //Flush All and Invalid
            dwReadData &= ~BIT4;
            *(volatile unsigned int *)(0xbf203104) = dwReadData;
        ...
        else // range flush
        {
            ...
            *(volatile unsigned int *)(0xbf203110) = (addr & 0xFFFF);
            *(volatile unsigned int *)(0xbf203114) = ((addr >> 16) & 0xFFFF);
            *(volatile unsigned int *)(0xbf203118) = ((addr + size - 1) & 0xFFFF);
            *(volatile unsigned int *)(0xbf20311C) = (((addr + size - 1) >> 16 ) & 0xFFFF);

            //Flush and Invalid Range
            dwReadData = *(volatile unsigned int *)(0xbf203104);
            dwReadData = ((dwReadData & 0xFFFFFFF0) | 0x06);    //Flush Range and Invalid
            dwReadData &= ~BIT4;
            *(volatile unsigned int *)(0xbf203104) = dwReadData;
...
#if 0
            //No Flush and Invalid Range
            dwReadData = *(volatile unsigned int *)(0xbf203104);
            dwReadData = ((dwReadData & 0xFFFFFFF0) | 0x07);    //Invalid the Range of Cache
            dwReadData &= ~BIT4;
            *(volatile unsigned int *)(0xbf203104) = dwReadData;
...
void Chip_L2_cache_wback( unsigned long addr, unsigned long size)
{
	...
	else
	{
        if( size >=  MIPS_L2_WB_TH )
        {
            ...
            dwReadData = *(volatile unsigned int *)(0xbf203104);
            dwReadData = ((dwReadData & 0xFFFFFFF0) | 0x03);    //Flush All and Keep Valid
            dwReadData &= ~BIT4;
            *(volatile unsigned int *)(0xbf203104) = dwReadData;
        ...
        else // range flush
        {
            ...
            *(volatile unsigned int *)(0xbf20311C) = (((addr + size - 1) >> 16 ) & 0xFFFF);
            ...
            dwReadData = *(volatile unsigned int *)(0xbf203104);
            dwReadData = ((dwReadData & 0xFFFFFFF0) | 0x05);    //Flush Range and Keep Valid
            dwReadData &= ~BIT4;
            *(volatile unsigned int *)(0xbf203104) = dwReadData;
...
{
    Chip_Read_Memory_Range(0, MIPS_L2_INV_TH);
}
...
void Chip_Query_L2_Config(void)
{
    ...
    if(u32L2ChipRev==0xffffffff)
    {
        u32L2ChipRev=Chip_Query_Rev();
    }

    if(((*(volatile unsigned int *)(0xbf203100)) & BIT1) != 0)  // H40
    {
        printk("[CPU] L2 Cache Disabled\n");
		u32L2CacheEnabled = 0;
    }
    else
    {
        printk("[CPU] L2 Cache Enabled\n");

		u32L2CacheEnabled = 1;

        dwTempData = *(volatile unsigned int *)(0xbf203100);
        dwTempData &= (BIT5 | BIT6);
        dwTempData >>= 5;
        ...
        switch(dwTempData)
        {
         	case 0:
			{
                printk("[CPU] L2 Cache Line Size: 64 Bytes\n");
            	dwCacheLineSize = 6;
			}
            break;
         	...
         	case 1:
			{
                printk("[CPU] L2 Cache Line Size: 128 Bytes\n");
            	dwCacheLineSize = 7;
			}
            break;
         	...
         	case 2:
			{
                printk("[CPU] L2 Cache Line Size: 256 Bytes\n");
            	dwCacheLineSize = 8;
			}
            break;
            ...
            default:
            {
                printk("[ERROR] Invalid L2 Cache Line Size\n");
                dwCacheLineSize = 0;
            }
            break;
        }

        if(*(volatile unsigned int *)(0xbf000000+0x203100) & _BIT(15))  // H43 enable write through
        {
            u32L2WriteThrough=1;
            printk("[CPU] L2 Type: Write Through\n");
        }
        else
        {
            u32L2WriteThrough=0;
            printk("[CPU] L2 Type: Write Back\n");
        }

        if((*(volatile unsigned int*)(0xbf000000+0x203100) & _BIT(2)) != 0) // H40
        {
            u32L2AllInCache=1;
            printk("[CPU] Force All MIU Requests into Cache Enabled\n");
        }
        else
        {
            u32L2AllInCache=0;
			printk("[CPU] Force All MIU Requests into Cache Disabled\n");
        }
	}
}
...
unsigned int Chip_Query_Rev(void)
{
	...
	dwRevisionId = *((volatile unsigned int*)(0xBF003D9C));
    dwRevisionId >>= 8;
...
unsigned int Chip_Query_MIPS_CLK(void)
{
    ...
    if( Chip_Query_Rev()  >= 0 )
    {
        u32Count = ((*((volatile u32*)0xBF22184C)) & 0x00FF)* 12000000;
        if( (((*((volatile u32*)0xBF22184C)) & _BIT(12)) == 0) &&  (((*((volatile u32*)0xBF22184C)) & _BIT(13)) == 0))
        {
            u32Count=u32Count;
        }
        else if( (((*((volatile u32*)0xBF22184C)) & _BIT(12)) == 1) &&  (((*((volatile u32*)0xBF22184C)) & _BIT(13)) == 0))
        {
            u32Count=u32Count>>1;
        }
        else if( (((*((volatile u32*)0xBF22184C)) & _BIT(12)) == 0) &&  (((*((volatile u32*)0xBF22184C)) & _BIT(13)) == 1))
        {
            u32Count=u32Count>>2;
        }
        else
