...
#define IR_TYPE_CHANGHONG           27
#define IR_TYPE_HAIER               28
//------------------------------BOARD_TYPE_SEL-----------
...
#if defined(CONFIG_MSTAR_TITANIA13_BD_FPGA) || defined(CONFIG_MSTAR_NIKON_BD_FPGA)
    #define MS_BOARD_TYPE_SEL       BD_FPGA
#elif defined(CONFIG_MSTAR_TITANIA13_BD_GENERIC) || defined(CONFIG_MSTAR_NIKON_BD_GENERIC)
