...
typedef enum
{
    ...
    E_IRQ_USB2                  = E_IRQL_START  + 13,
    //RESERVE                   = E_IRQL_START  + 14,
    E_IRQ_UHC2                  = E_IRQL_START  + 15,
    ...
    E_IRQ_UP_EMM_ECM            = E_IRQH_START  + 11,
    E_IRQ_UART_CA               = E_IRQH_START  + 12,
    //RESERVE                   = E_IRQH_START  + 13,
    E_IRQ_UHC3                  = E_IRQH_START  + 14,
    ...
    E_IRQEXPL_USB3              = E_IRQEXPL_START+4,
    ...
    E_IRQEXPL_CA_MVD_CHKSUM_FAIL= E_IRQEXPL_START+14,
    E_IRQEXPL_CA_TSP_CHKSUM_FAIL= E_IRQEXPL_START+15,
    ...
    E_IRQEXPH_HDMITX_LEVEL      = E_IRQEXPH_START+6,
    E_IRQEXPH_GPU               = E_IRQEXPH_START+7,
    ...
    //RESERVE                           = E_FIQEXPL_START+2,
    E_FIQEXPL_UP_EMM_ECM                = E_FIQEXPL_START+3,
    ...
    #define FIQ_UART_CA                         (0x1 << (E_FIQ_UART_CA          - E_FIQL_START) )
    ...
    #define IRQ_USB2                            (0x1 << (E_IRQ_USB2         - E_IRQL_START) )
    #define IRQ_UHC2                            (0x1 << (E_IRQ_UHC2         - E_IRQL_START) )
    ...
    #define IRQ_UP_EMM_ECM                      (0x1 << (E_IRQ_UP_EMM_ECM   - E_IRQH_START) )
    #define IRQ_UART_CA                         (0x1 << (E_IRQ_UART_CA      - E_IRQH_START) )
    #define IRQ_UHC3                            (0x1 << (E_IRQ_UHC3         - E_IRQH_START) )
    ...
    #define IRQEXPL_USB3                        (0x1 << (E_IRQEXPL_USB3               - E_IRQEXPL_START) )
    ...
    #define IRQEXPL_MLINK                       (0x1 << (E_IRQEXPL_GE                 - E_IRQEXPL_START) )
    #define IRQEXPL_GPD                         (0x1 << (E_IRQEXPL_GPD                - E_IRQEXPL_START) )
    #define IRQEXPL_JPD                         (0x1 << (E_IRQEXPL_JPD                - E_IRQEXPL_START) )
    #define IRQEXPL_CA_MVD_CHKSUM_FAIL          (0x1 << (E_IRQEXPL_CA_MVD_CHKSUM_FAIL - E_IRQEXPL_START) )
    #define IRQEXPL_CA_TSP_CHKSUM_FAIL          (0x1 << (E_IRQEXPL_CA_TSP_CHKSUM_FAIL - E_IRQEXPL_START) )
    ...
    #define IRQEXPH_HDMITX_LEVEL                (0x1 << (E_IRQEXPH_HDMITX_LEVEL     - E_IRQEXPH_START) )
    #define IRQEXPH_GPU                         (0x1 << (E_IRQEXPH_GPU              - E_IRQEXPH_START) )
    ...
    #define FIQEXPL_UP_EMM_ECM                  (0x1 << (E_FIQEXPL_UP_EMM_ECM                - E_FIQEXPL_START) )
    ...
    #define FIQEXPL_MIPS_VPE0_TO_AEON           (0x1 << (E_FIQEXPL_MIPS_VPE0_TO_AEON         - E_FIQEXPL_START) )
    #define FIQEXPL_MIPS_VPE0_TO_8051           (0x1 << (E_FIQEXPL_MIPS_VPE0_TO_8051         - E_FIQEXPL_START) )
