...
const char display_string[] = "        LINUX ON Kratos     ";
...
{
    unsigned int u32Count = 0,u32mipspll =0;
    unsigned int mipspll_loop_div1 = 0, mipspll_output_div1 = 0,MIPSPLL_LOOP=12,MIPSPLL_OUTPUT=48;
    //MIPSPLL_LOOP  (BIT3|BIT2)
	//MIPSPLL_OUTPUT (BIT5|BIT4)
	u32mipspll = *(volatile u32*)(0xBF221868);
	
	mipspll_loop_div1 = u32mipspll& MIPSPLL_LOOP;
    mipspll_output_div1 = (u32mipspll & MIPSPLL_OUTPUT)>>4;
    u32Count = (u32mipspll * 6000000 * mipspll_loop_div1)/2/mipspll_output_div1;
