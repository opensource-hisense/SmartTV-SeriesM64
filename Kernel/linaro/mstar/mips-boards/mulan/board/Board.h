...
#if defined(CONFIG_MSTAR_MIPS_BD_FPGA) || defined(CONFIG_MSTAR_MULAN_BD_FPGA) 
    #define MS_BOARD_TYPE_SEL       BD_FPGA
#elif defined(CONFIG_MSTAR_MIPS_BD_GENERIC) || defined(CONFIG_MSTAR_MULAN_BD_GENERIC)
