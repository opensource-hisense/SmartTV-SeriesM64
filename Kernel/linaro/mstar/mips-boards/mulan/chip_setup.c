...
#if defined(CONFIG_MSTAR_MIPS_BD_GENERIC) || defined(CONFIG_MSTAR_MULAN_BD_GENERIC)
...
{
#ifdef CONFIG_MSTAR_MULAN_BD_FPGA
         return 12;
#else
        unsigned short freq_type =  *(volatile unsigned int *)(0xBF000000 + 0x100B00 * 2 + 0x11 * 4);
    ...
    {
         freq_low = *(volatile unsigned int *)(0xBF000000 + 0x110C00 * 2 + 0x60 * 4);
         freq_high = *(volatile unsigned int *)(0xBF000000 + 0x110C00 * 2 + 0x61 * 4);
         return ((( 0xA2000000/ ((freq_high << 16) + freq_low)))*1000000);
     }
     else
     {
        printk(KERN_ERR "without clock source");
        BUG_ON(1);
     }
#endif
}
