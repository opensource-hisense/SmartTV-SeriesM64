...
//  E_IRQ_RESERVED                              = E_IRQL_START + 6,
//  E_IRQ_RESERVED                              = E_IRQL_START + 7,
...
//  E_IRQ_RESERVED                              = E_IRQH_START + 15,
...
//  E_FIQ_RESERVED                              = E_FIQH_START + 9,
    ...
    E_IRQEXPL_RESERVED                          = E_IRQEXPL_START + 0,
    E_IRQEXPL_USB1                              = E_IRQEXPL_START + 1,
    E_IRQEXPL_UHC1                              = E_IRQEXPL_START + 2,
    E_IRQEXPL_EC_BRIDGE                         = E_IRQEXPL_START + 3,
//  E_IRQEXPL_RESERVED                          = E_IRQEXPL_START + 4,
    E_IRQEXPL_MIU                               = E_IRQEXPL_START + 5,  
...
//  E_IRQEXPL_RESERVED                          = E_IRQEXPL_START + 10,  
//  E_IRQEXPL_RESERVED                          = E_IRQEXPL_START + 11,  
    ...
    E_FIQEXPL_HST0to3                           = E_FIQEXPL_START + 4,
    E_FIQEXPL_HST0to2                           = E_FIQEXPL_START + 5,
    E_FIQEXPL_HST0to1                           = E_FIQEXPL_START + 6,
//  E_FIQEXPL_RESERVED                          = E_FIQEXPL_START + 7,     
    E_FIQEXPL_HST1to3                           = E_FIQEXPL_START + 8,
    E_FIQEXPL_HST1to2                           = E_FIQEXPL_START + 9,
    E_FIQEXPL_HST1to0                           = E_FIQEXPL_START + 10,
//  E_FIQEXPL_RESERVED                          = E_FIQEXPL_START + 11,     
    E_FIQEXPL_HST2to3                           = E_FIQEXPL_START + 12,
    E_FIQEXPL_HST2to1                           = E_FIQEXPL_START + 13,
    E_FIQEXPL_HST2to0                           = E_FIQEXPL_START + 14,
//  E_FIQEXPL_RESERVED                          = E_FIQEXPL_START + 15,     
    E_FIQEXPL_END                               = 111 + MSTAR_INT_BASE,
                                                
    E_FIQEXPH_START                             = 112 + MSTAR_INT_BASE,
    E_FIQEXPH_HST3to2                           = E_FIQEXPH_START + 0,
    E_FIQEXPH_HST3to1                           = E_FIQEXPH_START + 1,
    E_FIQEXPH_HST3to0                 		= E_FIQEXPH_START + 2,
//  E_FIQEXPH_RESERVED                       	= E_FIQEXPH_START + 3, 
//  E_FIQEXPH_RESERVED                  	= E_FIQEXPL_START + 4,     
    E_FIQEXPH_LDM_DMA_DONE1                  	= E_FIQEXPL_START + 5,     
    E_FIQEXPH_LDM_DMA_DONE0                  	= E_FIQEXPL_START + 6,     
    E_FIQEXPH_AU_SPDIF_TX0                  	= E_FIQEXPL_START + 7,     
    E_FIQEXPH_AU_SPDIF_TX1                    	= E_FIQEXPH_START + 8, 
...
#define IRQEXPL_EC_BRIDGE                       (0x01 << (E_IRQEXPL_EC_BRIDGE - E_IRQEXPL_START))
