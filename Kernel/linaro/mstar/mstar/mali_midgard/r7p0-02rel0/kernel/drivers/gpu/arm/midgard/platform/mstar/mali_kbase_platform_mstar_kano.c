...
#if 0
    /* For zebu setting */
    GPU_REG(REG_GPU_MIU0_START) = /*0x0200*/0x0000;
    GPU_REG(REG_GPU_MIU0_END)   = /*0x0a00*/0x00a8;
    GPU_REG(REG_GPU_MIU1_START) = /*0x2000*/0x00a8;
    GPU_REG(REG_GPU_MIU1_END)   = /*0x3000*/0x8000;
#endif
