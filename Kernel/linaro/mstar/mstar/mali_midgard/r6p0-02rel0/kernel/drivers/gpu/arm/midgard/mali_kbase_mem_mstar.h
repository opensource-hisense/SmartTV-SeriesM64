 ...
 *                  +------------+     +------------+
 */
static __attribute__((__always_inline__)) __inline__ u64 BUS_TO_MIU_ADDRESS(phys_addr_t bus_addr)
{
    /* MIU0/MIU1 */
...
static __attribute__((__always_inline__)) __inline__ phys_addr_t MIU_TO_BUS_ADDRESS(u64 miu_addr)
{
    /* MIU0 */
