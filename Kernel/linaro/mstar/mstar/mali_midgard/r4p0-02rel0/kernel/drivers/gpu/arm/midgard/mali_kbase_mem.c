...
#ifdef MSTAR
	kctx->pgd -= PHYS_TO_BUS_ADDRESS_ADJUST; /* change to physical address temporarily when updating mmu */
#endif
...
#ifdef MSTAR
	kctx->pgd += PHYS_TO_BUS_ADDRESS_ADJUST; /* restore to bus address */
#endif
