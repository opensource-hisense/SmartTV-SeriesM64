...
/**
 * @brief Export a memory block as a dma-buf
 *
 * the base and size of the memory block must be page-aligned.
 * 
 * @param[in] base the base of the memory block
 * @param[in] size the size of the memory block
 * @param[in] is_bus_address the type of the base
 *
