...
#define UMP_REV_STRING "1.0 (" UMP_RELEASE_NAME ")"
...
#if MSTAR_UMP_MONOLITHIC != 0
#if defined(CONFIG_ION) && !defined(UMP_NO_IMPORT_ION)
int import_ion_initialize_module(void);
void import_ion_cleanup_module(void);
#endif
#if MSTAR_UMP_IMPORT_PA != 0
int import_pa_initialize_module(void);
void import_pa_cleanup_module(void);
#endif
#endif
...
#if MSTAR_UMP_MONOLITHIC != 0
#if defined(CONFIG_ION) && !defined(UMP_NO_IMPORT_ION)
	res = import_ion_initialize_module();
...
#endif
#if MSTAR_UMP_IMPORT_PA != 0
	res = import_pa_initialize_module();
...
#if MSTAR_UMP_MONOLITHIC != 0
#if defined(CONFIG_ION) && !defined(UMP_NO_IMPORT_ION)
	import_ion_cleanup_module();
#endif
#if MSTAR_UMP_IMPORT_PA != 0
	import_pa_cleanup_module();
#endif
#endif
