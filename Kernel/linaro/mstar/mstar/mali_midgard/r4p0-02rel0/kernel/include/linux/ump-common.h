...
#ifdef MSTAR_UMP_IMPORT_PA
	/* 20-25 reserved for future use */
	UMPP_ALLOCBITS_UNUSED = (0x3Fu << 20),
	/** Require the external memory to import providing bus addresses */
	UMP_CONSTRAINT_BUS_ADDRESS = (1u << 26),
#else
...
enum ump_external_memory_type
{
	...
	UMP_EXTERNAL_MEM_TYPE_PA = 2,  /* physical addresses */
#endif
