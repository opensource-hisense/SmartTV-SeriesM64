...
struct dvfs_operations {
	/* enable */
	void (*enable)(struct kbase_device *);
	/* disable */
	void (*disable)(struct kbase_device *);
	/* clock up */
	void (*gpu_clock_up)(struct kbase_device *);
	/* clock down */
	void (*gpu_clock_down)(struct kbase_device *);
};
/* MSTAR patch end */
...
struct kbase_device {
	...
	struct dvfs_operations dvfs_op;
	u32 dvfs_enable;
#endif
	/* MSTAR patch end */
