...
#ifndef _HAL_SAR_DVFS_H_
#define _HAL_SAR_DVFS_H_
...
#define CONFIG_DVFS_CORE_POWER_DROP             5
...
{
    MS_U32  bDvfsInitOk;
    MS_U32  bCpuClockLevel;
    MS_U32  dwOverCounter;
    MS_U32  dwVidSetting;

    MS_S32  dwFinalCpuTemperature;
    MS_U32  dwAvgTempBufferCpu[CONFIG_DVFS_AVERAGE_COUNT];
    MS_U32  dwAvgTempCounterCpu;
    MS_U32  dwRefTemperature;

    MS_U16  wCpuClockSetting_High;
    MS_U16  wCpuClockSetting_Low;
