                        ...
                        unsigned long len, void *data )
{
  ...
  volatile unsigned int *peri_va=0xfc000000+0x1000+0xF00;
  ...
  ts.cmd2 = (i++)%1000;
  ts.cmd3 = (i++)%1000;
  //printk("tz_write cmd1 = %d cmd2 =%d\n", ts.cmd1, ts.cmd2);
  tz_call(&ts, TZ_WQ_IRQ);

   //printk("SGI test code write ");
   //*peri_va = 0x20002;
//  BUG_ON((ts.cmd1 != 0xb) || (ts.cmd2 !=0xc));
