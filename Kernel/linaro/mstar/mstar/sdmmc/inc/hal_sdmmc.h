...
#elif (D_PROJECT == D_PROJECT__MADISON) || (D_PROJECT == D_PROJECT__KERES)
//###########################################################################################################
...
RspErrEmType Hal_SDMMC_SendCmdAndWaitProcess(IPEmType eIP, TransEmType eTransType, CmdEmType eCmdType, SDMMCRspEmType eRspType, BOOL_T bCloseClk, BOOL_T stop);
