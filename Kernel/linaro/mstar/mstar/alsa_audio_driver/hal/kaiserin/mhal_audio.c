...
#define _MAD_BYTES_IN_LINE    8
#define _MAD_ADDR_CONVERTOR    0x800
#define _MAD_MAILBOX_OFFSET    0x110000

#define _MAD_MAX_CHANNEL    2

#define _MAD_DMA_READER_BASE_OFFSET    0x280000
...
static int _mhal_alsa_dma_reader_init(void)
{
	...
	unsigned int audio_pcm_dmaRdr_base_pa_line_base = 0;
	...
	audio_pcm_dmaRdr_base_pa_line_base = audio_pcm_dmaRdr_base_pa / _MAD_BYTES_IN_LINE;
	...
	/* using decoder 4 for DMA reader */
	...
	_mhal_alsa_write_mask_byte(0x2C6C, 0xFF, 0x8F); /* CH9 sel to DMA Rdr */

	_mhal_alsa_write_mask_reg(0x2B82, 0xFFFF, 0x0000); /* reset dma reader */
	_mhal_alsa_write_mask_byte(0x2B8E, 0xFF, audio_pcm_dmaRdr_base_pa_line_base); /* setting : DMA Reader Base[7:0] */
	_mhal_alsa_write_mask_reg(0x2B84, 0xFFFF, (audio_pcm_dmaRdr_base_pa_line_base >> 8)); /* setting : DMA Reader Base[23:8] */
	_mhal_alsa_write_mask_byte(0x2B8F, 0x07, (audio_pcm_dmaRdr_base_pa_line_base >> 24)); /* setting : DMA Reader Base[26:24] */
