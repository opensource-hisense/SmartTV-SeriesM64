 ...
 * ============================================================================
 */
#define _MAD_CHIP_MODEL    "MAD T10"
...
#define _MAD_DMA_READER_BASE_OFFSET    0x146000
...
static int _mhal_alsa_dma_reader_init(void)
{
	...
	/* using decoder 2 for DMA reader */
	_mhal_alsa_write_mask_byte(0x2C64, 0xFF, 0x81); /* CH1 sel to DMA Rdr */
	_mhal_alsa_write_mask_byte(0x2CB0, 0x03, 0x02); /* Use DVB2 synthesizer for DMA reader */
	_mhal_alsa_write_mask_byte(0x2C62, 0xFF, 0xC6); /* decoder2 sel to DMA Reader */
	_mhal_alsa_write_mask_byte(0x2C6A, 0xFF, 0x81 ); /* CH4 sel to DMA Rdr */
...
static int _mhal_alsa_dma_reader_set_sample_rate(unsigned int sample_rate)
{
	...
	_mhal_alsa_write_mask_byte(0x2BCF, 0x02, 0x02); /* DVB2 synthersizer control by MCU */
	_mhal_alsa_write_mask_reg(0x2BAC, 0xFFFF, synthrate);
	_mhal_alsa_write_mask_byte(0x2BCE, 0x02, 0x02);
	_mhal_alsa_write_mask_byte(0x2BCE, 0x02, 0x00);
