...
#define FCIE_HS200_PATCH        GET_REG_ADDR(FCIE_REG_BASE_ADDR, 0x3F)
...
#define BIT_SD_BUSY_END            BIT4
#define BIT_CARD_DMA_END           BIT11
#define BIT_MIU_LAST_DONE		   BIT14
#define BIT_CARD_BOOT_DONE		   BIT15
#define BIT_ALL_CARD_INT_EVENTS    (BIT_MMA_DATA_END|BIT_SD_CMD_END|BIT_SD_DATA_END|BIT_SD_BUSY_END\
...
#define BIT_SD_JOB_CNT_SRC_MIU     BIT14
#define BIT_SD_JOB_CNT_SRC_SEL     BIT15
/* FCIE_RSP_SIZE 0x0D */
...
#define BIT_SD_BUSY_DET_ON         BIT5
/* FCIE_SD_STATUS 0x12 */
...
#define BIT_KERN_NAND              (BIT3|BIT1)
#define BIT_KERN_EMMC              (BIT3|BIT2)
#define BIT_KERN_CHK_NAND_EMMC     BIT3
#define BIT_KERN_CHK_NAND_EMMC_MSK (BIT3|BIT2|BIT1)
/* FCIE_SDIO_CTRL 0x1B */
...
#define BIT_eco_d0_busy_check       BIT3

#define BIT_csreg_miu_wp_last2_sel  BIT14
#define BIT_reg_pad_in_sel_sd       BIT15
