...
#define eMMC_DRV_KERES_LINUX            1
#endif

#if defined(CONFIG_MSTAR_KIRIN)
#define eMMC_DRV_KIRIN_LINUX            1
#endif
...
// [FIXME] add a .h file for your platform
#if defined(eMMC_DRV_EAGLE_LINUX) && eMMC_DRV_EAGLE_LINUX
    ...
    #include "eMMC_keres_linux.h"
#elif defined(eMMC_DRV_KIRIN_LINUX) && eMMC_DRV_KIRIN_LINUX
    #include "eMMC_kirin_linux.h"
