...
#define reg_fcie2macro_sd_bypass        GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x43)
#define FCIE2MACRO_SD_BYPASS            BIT1
...
#define reg_sd_pad                      GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x5B)
#define CFG_SD_PAD_MASK                 (BIT8|BIT9)

#define reg_emmc_pad                    GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x5D)
#define CFG_EMMC_PAD_MASK               (BIT14|BIT15)
#define BIT_EMMC_CFG_MODE1              (BIT14)


#define reg_nand_pad                    GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x0B)
#define CFG_NAND_PAD_MASK               (BIT0|BIT1|BIT12|BIT13|BIT14)

#define eMMC_DBUS_WIDTH                 8

#define eMMC_RST_L()    {REG_FCIE_SETBIT(reg_fcie2macro_sd_bypass, BIT_eMMC_RSTPIN_EN);\
	                      REG_FCIE_CLRBIT(reg_fcie2macro_sd_bypass, BIT_eMMC_RSTPIN_VAL);}
#define eMMC_RST_H()     REG_FCIE_SETBIT(reg_fcie2macro_sd_bypass, BIT_eMMC_RSTPIN_EN|BIT_eMMC_RSTPIN_VAL)
//--------------------------------sar5----------------------------
