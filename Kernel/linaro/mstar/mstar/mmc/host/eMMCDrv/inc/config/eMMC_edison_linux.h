...
#define eMMC_RST_L()                    {\
	                                     REG_FCIE_R(reg_fcie2macro_sd_bypass,u16_reg_chiptop_0x10_val);\
	                                     REG_FCIE_R(reg_emmc_pad,u16_reg_chiptop_0x6E_val);\
...
#define eMMC_RST_H()                    {\
                                         ...
                                         REG_FCIE_W(reg_fcie2macro_sd_bypass,u16_reg_chiptop_0x10_val);\
										 REG_FCIE_W(reg_emmc_pad,u16_reg_chiptop_0x6E_val);\
