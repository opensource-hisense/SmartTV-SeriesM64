...
//******************************************************************************
//<MStar Software>
#ifndef __eMMC_AGATE_LINUX__
#define __eMMC_AGATE_LINUX__
...
#define reg_ckg_fcie_4X         GET_REG_ADDR(CLKGEN_BASE, 0x69)				
#define BIT_FCIE_CLK4X_Gate     BIT0						
#define BIT_FCIE_CLK4X_Inverse  BIT1						
//#define BIT_FCIE_CLK4X_MASK     ((0)<<8)
//#define BIT_FCIE_CLK4X_SHIFT    0
...
//#define reg_chiptop_0x1F        GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x52)		
...
#define BIT_eMMC_CFG_MASK       (BIT6|BIT7)
#define BIT_eMMC_CFG_MODE1      (BIT6)
#define BIT_eMMC_CFG_MODE2      (BIT6|BIT7)
...
#define eMMC_RST_L()    					//{REG_FCIE_SETBIT(reg_chiptop_0x43, BIT_eMMC_RSTPIN_EN);	REG_FCIE_CLRBIT(reg_chiptop_0x43, BIT_eMMC_RSTPIN_VAL);}
...
#define FCIE_SLOW_CLK              BIT_FCIE_CLK_XTAL
