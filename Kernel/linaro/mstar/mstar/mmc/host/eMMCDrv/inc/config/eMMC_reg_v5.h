...
#define FCIE_REG16h                     FCIE_MIE_FUNC_CTL
...
#define FCIE_CMDFIFO_BYTE_CNT           0x12
...
#define BIT_ALL_CARD_INT_EVENTS         (BIT_DMA_END|BIT_CMD_END|BIT_ERR_STS|BIT_BUSY_END_INT)
...
#define BIT_FUNC_MASK					(BIT2|BIT1|BIT0)
