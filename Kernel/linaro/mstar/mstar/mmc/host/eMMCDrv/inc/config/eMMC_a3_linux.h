...
#define reg_chiptop_0x02        GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x02)
...
#define BIT_nand_config_MASK    (BIT6|BIT7)

#define reg_chiptop_0x10        GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x10)
#define BIT_force_boot_from_emmc2  BIT1
#define BIT_force_boot_from_emmc1  BIT2

#define reg_chiptop_0x1C        GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x1C)
#define BIT_disable_emmc2_pad   BIT13
#define BIT_sd_config2          BIT12

#define reg_chiptop_0x6E        GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x6E)
#define BIT_emmc_config_MASK    (BIT6|BIT7)
#define BIT_emmc_config_bypass  BIT6
#define BIT_emmc_config_macro   BIT7

#define reg_chiptop_0x5A        GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x5A)
#define BIT_sd_config1          BIT5
...
extern  U32 eMMC_DisableBootMode(void);
...
#define eMMC_HOUSEKEEP_THREAD               1
