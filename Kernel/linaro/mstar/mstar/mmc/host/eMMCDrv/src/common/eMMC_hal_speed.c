...
{
	U32 u32_err;
	U32 u32_ChkSum, u32_eMMCBlkAddr, u32_TryFlag=0, u32_AllTryFlag=0, u32_LogFlag=0;
	...
	#if defined(ENABLE_eMMC_HS400) && ENABLE_eMMC_HS400
	if(0==u32_AllTryFlag)
		u32_AllTryFlag = eMMC_DEVTYPE_HS400_1_8V|eMMC_DEVTYPE_HS200_1_8V|eMMC_DEVTYPE_DDR;
	...
	#if defined(ENABLE_eMMC_HS200) && ENABLE_eMMC_HS200
	if(0==u32_AllTryFlag)
		u32_AllTryFlag = eMMC_DEVTYPE_HS200_1_8V|eMMC_DEVTYPE_DDR;
	...
	if(0==u32_AllTryFlag)
		u32_AllTryFlag = eMMC_DEVTYPE_DDR;
	...
	if(u32_LogFlag)
		eMMC_debug(eMMC_DEBUG_LEVEL,1,"eMMC: Get TT\n");
	return eMMC_ST_SUCCESS;

	LABEL_END_OF_NO_TABLE:
	g_eMMCDrv.TimingTable_t.u8_SetCnt = 0;

	if(u32_AllTryFlag != (u32_TryFlag & u32_AllTryFlag))
	{
		u32_LogFlag = 1;
...
U32 eMMC_CMD21_MIU(void)
{
	...
	u32_DataMapAddr = eMMC_DMA_MAP_address((U32)gau8_eMMC_SectorBuf,eMMC_SECTOR_512BYTE,1);
