...
#ifndef _XHCI_MSTAR_318XX_H
#define _XHCI_MSTAR_318XX_H

#include <ehci-mstar-318xx.h>
...
#define _MSTAR_XHCI_BASE       (_MSTAR_USB_BASEADR+(0xC0000*2))
#define _MSTAR_U3BC_BASE       0
#endif
