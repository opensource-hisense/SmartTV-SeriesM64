...
#if defined(CONFIG_MSTAR_AMETHYST) || defined(CONFIG_MSTAR_EAGLE) || defined(CONFIG_MSTAR_EMERALD) || defined(CONFIG_MSTAR_KAISERIN) || defined(CONFIG_MSTAR_KRONUS) || defined(CONFIG_MSTAR_KERES)
...
//---- 10.1 Clock phase adjustment software Patch
#if defined(CONFIG_MSTAR_KERES)
        #define _USB_CLOCK_PHASE_ADJ_PATCH    1
        /* U01 chip should do UTMI_240_AS_120_PHASE_ECO_INV */
	#define MSTAR_PM_TOP_BASE	(0xbf000000+(0x1E00*2))
#else
...
//------ UTMI eye diagram parameters ---------------------------------
	...
	defined(CONFIG_MSTAR_KIRIN) || \
	defined(CONFIG_MSTAR_KRIS)
	// for 40nm after Agate, use 55nm setting1, the STB default
	#define UTMI_EYE_SETTING_2C	(0x10)
	#define UTMI_EYE_SETTING_2D	(0x02)
	#define UTMI_EYE_SETTING_2E	(0x00)
	#define UTMI_EYE_SETTING_2F	(0x01)
