...
#define GMAC_RAM_VA_BASE                         0xA0000000
#define GMAC_RAM_PA_BASE                         0x00000000
#define GMAC_RAM_VA_PA_OFFSET                    0x00000000
#define GMAC_RX_BUFFER_BASE                      0x00000000         // ==0xA0000000 ~~ 0xA0004000 (Max: 16 KB)
...
#define GMAC_TX_SKB_BASE                         GMAC_TX_BUFFER_BASE+0x100//0x00006100
#define GMAC_RX_FRAME_ADDR                       GMAC_TX_SKB_BASE+0x600//0x00007000         // Software COPY&STORE one RX frame. Size is not defined.
...
#define GMAC_ETHERNET_TEST_NO_LINK               0x00000000
#define GMAC_ETHERNET_TEST_AUTO_NEGOTIATION      0x00000001
#define GMAC_ETHERNET_TEST_LINK_SUCCESS          0x00000002
#define GMAC_ETHERNET_TEST_RESET_STATE           0x00000003
#define GMAC_ETHERNET_TEST_SPEED_100M            0x00000004
#define GMAC_ETHERNET_TEST_DUPLEX_FULL           0x00000008
#define GMAC_ETHERNET_TEST_INIT_FAIL             0x00000010
...
#define GMAC_EP_FLAG_OPEND   0X00000001
#define GMAC_EP_FLAG_SUSPENDING   0X00000002
