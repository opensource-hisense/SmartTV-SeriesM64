...
#define E_IRQEXPH_SECEMAC E_IRQEXPL_SECEMAC //aliasing for interrupt enum 

#ifdef TX_QUEUE_4
#define GMAC_INT_MASK (0xedff)
#else
...
#define GMAC_INTERNEL_PHY_REG_BASE          0xFD245000
#define GMAC_RIU_REG_BASE                   0xFD000000
...
#define GMAC_REG_ADDR_BASE                       0xFD2C0800      // The register address base. Depends on system define.
#define GMAC_RBQP_LENG                           0x30  //0x0100  0x40//                // ==?descriptors
