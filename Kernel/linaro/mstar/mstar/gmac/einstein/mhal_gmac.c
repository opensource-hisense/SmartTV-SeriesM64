...
void MHal_GMAC_update_speed_duplex( u32 uspeed, u32 uduplex )
{
    ...
    if(uspeed == SPEED_1000)
    {
        ...
        uRegVal = MHal_GMAC_ReadReg8(0x1608, 0x22);
        uRegVal &= 0xef;
        MHal_GMAC_WritReg8(0x000e, 0xd6, uRegVal);

        /* Set reg_xmii_type as 1G */
        uRegVal = MHal_GMAC_ReadReg8(0x1608, 0x60);
        uRegVal &= 0xfc;
        MHal_GMAC_WritReg8(0x1608, 0x60, uRegVal);
    ...
    else if ( uspeed == SPEED_100 )
    {
        ...
        uRegVal = MHal_GMAC_ReadReg8(0x1608, 0x22);
        uRegVal |= 0x10;
        MHal_GMAC_WritReg8(0x1608, 0x22, uRegVal);
...
void MHal_GMAC_Power_On_Clk( void )
{
    ...
    /* Enable TX delay */
    MHal_GMAC_WritReg8(0x1608, 0x26, 0x0e);

    /* Set gmac ahb clock to 216MHZ */
    MHal_GMAC_WritReg8(0x100a, 0x11, 0x00);

    /* Enable gmac tx clock */
    uRegVal = MHal_GMAC_ReadReg8(0x100a, 0x10);
    uRegVal &= 0xfe;
    MHal_GMAC_WritReg8(0x100a, 0x10, uRegVal);

    uRegVal = MHal_GMAC_ReadReg8(0x1608, 0x23);
    uRegVal &= 0xfe;
    MHal_GMAC_WritReg8(0x1608, 0x23, uRegVal);
    ...
    MHal_GMAC_WritReg8(0x1608, 0x24, 0x00);
    MHal_GMAC_WritReg8(0x1608, 0x25, 0x00);

    /* Digital synthesizer */
    MHal_GMAC_WritReg8(0x110c, 0xe8, 0x08);
    MHal_GMAC_WritReg8(0x110c, 0xe9, 0x80);
    MHal_GMAC_WritReg8(0x110c, 0xea, 0x83);
    MHal_GMAC_WritReg8(0x110c, 0xeb, 0x06);
    MHal_GMAC_WritReg8(0x110c, 0xf0, 0x6a);
    MHal_GMAC_WritReg8(0x110c, 0xf1, 0xbc);
    MHal_GMAC_WritReg8(0x110c, 0xf2, 0x14);
    MHal_GMAC_WritReg8(0x110c, 0xf3, 0x00);

    /* Aupll */
    MHal_GMAC_WritReg8(0x110c, 0xe6, 0x7f);
    MHal_GMAC_WritReg8(0x110c, 0xe7, 0x00);
    MHal_GMAC_WritReg8(0x110c, 0xe2, 0xc8);
    MHal_GMAC_WritReg8(0x110c, 0xe3, 0x00);
    MHal_GMAC_WritReg8(0x110c, 0xf4, 0x04);
    MHal_GMAC_WritReg8(0x110c, 0xf5, 0x03);
    ...
    /*Enable patch*/
    uRegVal = MHal_GMAC_ReadReg8(0x1605, 0x38);
    uRegVal |= 0xc6;
    MHal_GMAC_WritReg8(0x1605, 0x38, uRegVal);

    MHal_GMAC_write_phy( 0x01, 0x1f, 0x0007);
    MHal_GMAC_write_phy( 0x01, 0x1e, 0x00a4);
    MHal_GMAC_write_phy( 0x01, 0x1c, 0xad91);
    MHal_GMAC_write_phy( 0x01, 0x1f, 0x0000);
#endif
}
