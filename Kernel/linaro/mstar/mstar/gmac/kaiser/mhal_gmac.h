...
#define GMAC_K3_SW_PATCH
#define _OFFSET_CONDITION(_size) ((_size>=479)&&(_size<=511))||((_size>=991)&&(_size<=1023))||((_size>=1503)&&(_size<=1535))
...
#define GMAC_REG_ADDR_BASE                       0xFD243600      // The register address base. Depends on system define.
