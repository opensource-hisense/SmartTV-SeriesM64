...
#if defined(CONFIG_MSTAR_KENYA) || defined(CONFIG_MSTAR_AMBER1) || defined(CONFIG_MSTAR_KERES) || defined(CONFIG_MSTAR_KIRIN) || defined(CONFIG_MSTAR_NUGGET) || defined(CONFIG_MSTAR_KRATOS)
...
//    	#define REG_CHIP_NAND_MODE_PCMD				0x0100
    ...
    #define REG_CHIP_NAND_MODE						0x1E3A
    	#define REG_CHIP_NAND_MODE_MASK				0x8000

    #define REG_CHIP_PCM_D_PE                       0x1E0E
        #define REG_CHIP_PCM_D_PE_MASK              0xFC00 // PCM_D
    #define REG_CHIP_PCM_D_PE1                      0x1E10
        #define REG_CHIP_PCM_D_PE1_MASK             0x0003
        
//        #define REG_CHIP_PCM_CTL_MASK               0xFF00 // PCM_CTRL (except PCM_CD, PCM_RESET)
    #define REG_CHIP_PCM_A_PE                        0x1E0C
        #define REG_CHIP_PCM_A_PE_MASK               0x00FF // PCM_A
...
//    	#define REG_CHIP_NAND_MODE_PCMD				0x0100
    ...
    #define REG_SD_CONFIG2                          0x1EAE
        #define REG_SD_CONFIG2_MASK                 0x0F00 //reg_sd_config & reg_sd_config2
    #define REG_EMMC_CONFIG                         0x1EDC
        #define REG_EMMC_CONFIG_MASK                0x0040
    #define REG_CHIP_PCM_PE                         0x1E16
        #define REG_CHIP_PCM_PE_MASK                0x00FF // PCM_D
        #define REG_CHIP_PCM_CTL_MASK               0xFF00 // PCM_CTRL (except PCM_CD, PCM_RESET)
    #define REG_CHIP_PCM_PE1                        0x1E18
...
#elif defined(CONFIG_MSTAR_KAISERIN) || defined(CONFIG_MSTAR_KAPPA) || defined(CONFIG_MSTAR_KELTIC)|| defined(CONFIG_MSTAR_KRITI)
//Fix me!!Needs to be reivewed!!
#define REG_ADDR(addr)                          (*((volatile U16*)(0xBF200000 + (addr << 1))))
#define REG_CKG_AEONTS0                         0x0B24
#define AEON_CLK_ENABLE                         0x0084 //CLK 172.8MHz
...
#if defined(CONFIG_MSTAR_KAISERIN) || defined(CONFIG_MSTAR_KAPPA) || defined(CONFIG_MSTAR_KELTIC)|| defined(CONFIG_MSTAR_KRITI)
   #include <include/mstar/mstar_chip.h>
...
#if defined(CONFIG_MSTAR_KENYA) || defined(CONFIG_MSTAR_AMBER1) || defined(CONFIG_MSTAR_KERES) || defined(CONFIG_MSTAR_KIRIN) || defined(CONFIG_MSTAR_NUGGET)
// in <include/mstar/mstar_chip.h>
#else
#if defined(CONFIG_ARM) || defined(CONFIG_ARM64)
#ifndef ARM_MIU0_BUS_BASE
#define ARM_MIU0_BUS_BASE	(~0UL)
#endif
#ifndef ARM_MIU1_BUS_BASE
#define ARM_MIU1_BUS_BASE	(~0UL)
#endif
#ifndef ARM_MIU2_BUS_BASE
#define ARM_MIU2_BUS_BASE	(~0UL)
#endif
#ifndef ARM_MIU3_BUS_BASE
#define ARM_MIU3_BUS_BASE	(~0UL)
#endif
#elif defined(CONFIG_MIPS)
#ifndef MIPS_MIU0_BUS_BASE
#define MIPS_MIU0_BUS_BASE	(~0UL)
#endif
#ifndef MIPS_MIU1_BUS_BASE
#define MIPS_MIU1_BUS_BASE	(~0UL)
#endif
#ifndef MIPS_MIU2_BUS_BASE
#define MIPS_MIU2_BUS_BASE	(~0UL)
#endif
#ifndef MIPS_MIU3_BUS_BASE
#define MIPS_MIU3_BUS_BASE	(~0UL)
#endif
#else
#error "Error, can not decide the MIU_BASE by the selected processor"
#endif
#endif
...
// in <include/mstar/mstar_chip.h>
#else
/* add this defined for specified ARM/MIPS BUS_BASE */
#if defined(CONFIG_ARM) || defined(CONFIG_ARM64)
#define MIU0_BUS_BASE ARM_MIU0_BUS_BASE
#define MIU1_BUS_BASE ARM_MIU1_BUS_BASE
#define MIU2_BUS_BASE ARM_MIU2_BUS_BASE
#define MIU3_BUS_BASE ARM_MIU3_BUS_BASE
#elif defined(CONFIG_MIPS)
...
//int MDrv_SYS_PCMCIA_WRITE_DATA(U32 arg, BOOL bFromUser);
