...
#define MDRV_GFLIP_IOC_GETVSYNC_NR  (MDRV_GFLIP_IOC_SETMULTIFLIPINFO_NR+1)       //19
#define MDRV_GFLIP_IOC_SETDLCINITINFO_NR  (MDRV_GFLIP_IOC_GETVSYNC_NR+1)       //29

#define MDRV_GFLIP_IOC_MAX_NR              (MDRV_GFLIP_IOC_SETDLCINITINFO_NR+1)
