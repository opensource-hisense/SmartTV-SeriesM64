...
static hal_SERFLASH_t _hal_SERFLASH_table[] =   // Need to Add more sample for robust
{
    ...
    { FLASH_IC_MX25L1655D,  MID_MXIC,   0x26,   0x15,   NULL,                               NULL,                       0x200000,   32,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE },
	...
	{ FLASH_IC_MX25L3255D,  MID_MXIC,   0x9E,   0x16,   NULL,                               NULL,                       0x400000,   64,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE },
    ...
    { FLASH_IC_MX25L12805D, MID_MXIC,   0x20,   0x18,   _pstWriteProtectTable_MX25L12805D,  NULL,                       0x1000000,  256,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE},
    { FLASH_IC_MX25L6455E,  MID_MXIC,   0x26,   0x17,   _pstWriteProtectTable_MX25L6455E,  NULL,                        0x800000,   128,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE},
	{ FLASH_IC_MX25L12855E, MID_MXIC,   0x26,   0x18,   _pstWriteProtectTable_MX25L12845E,  NULL,                       0x1000000,  256,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE},
    { FLASH_IC_MX25L4006E,  MID_MXIC,   0x20,   0x13,   _pstWriteProtectTable_MX25L4006E,   NULL,                       0x80000,     8,     SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
	{ FLASH_IC_MX25L8006E,  MID_MXIC,   0x20,   0x14,   NULL,                               NULL,                       0x100000,   16,     SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, TRUE},
    ...
    { FLASH_IC_W25Q80,		MID_WB, 	0x40,	0x14,	_pstWriteProtectTable_W25Q80,       NULL  ,						0x100000,	16, 	SIZE_64KB,	256,	50, 	BITS(5:2, 0x0F),	ISP_DEV_ST,		ISP_SPI_ENDIAN_LITTLE, FALSE},
    ...
    { FLASH_IC_W25X40,      MID_WB,     0x30,   0x13,   _pstWriteProtectTable_W25X40,       NULL,                       0x80000,    8,      SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
    ...
    { FLASH_IC_S25FL032,    MID_SPAN,   0x02,   0x15,   _pstWriteProtectTable_S25FL032,     NULL,                       0x400000,   64,    SIZE_64KB,  256,     50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
    { FLASH_IC_S25FL064,    MID_SPAN,   0x02,   0x16,   _pstWriteProtectTable_S25FL064,     NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
    ...
    { FLASH_IC_EN25Q32A,    MID_EON,    0x30,   0x16,    _pstWriteProtectTable_EN25Q32A,     NULL,                      0x400000,   64 ,    SIZE_64KB,  256,    384,    BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
    { FLASH_IC_EN25Q64,     MID_EON,    0x30,   0x17,    _pstWriteProtectTable_EN25Q64,     NULL,                       0x800000,   128,    SIZE_64KB,  256,    384,    BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
    { FLASH_IC_EN25Q128,    MID_EON,    0x30,   0x18,    _pstWriteProtectTable_EN25Q128,    NULL,                       0x1000000,   256,   SIZE_64KB,  256,    384,    BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
    { FLASH_IC_EN25F40,     MID_EON,    0x31,   0x13,   _pstWriteProtectTable_EN25F40,      NULL,                       0x80000,      8,    SIZE_64KB,  256,    384,    BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
    ...
    { FLASH_IC_S25FL128P,   MID_SPAN,   0x20,   0x18,   _pstWriteProtectTable_S25FL128P,    NULL,                       0x1000000,  256,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
	{ FLASH_IC_NUMONYX_M25PX16,   MID_NUMONYX,0x73,   0x15,   _pstWriteProtectTable_M25PX16,                         NULL,                       0x200000,    32,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
	{ FLASH_IC_NUMONYX_N25Q32,   MID_NUMONYX, 0xBA,   0x16,   _pstWriteProtectTable_N25Q32,                             NULL,                   0x400000,    64,     SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
	{ FLASH_IC_NUMONYX_N25Q64,   MID_NUMONYX, 0xBA,   0x17,   _pstWriteProtectTable_N25Q64,                             NULL,                   0x800000,    128,     SIZE_64KB,  256,    50,     BITS(4:2, 0x07),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
    { FLASH_IC_PM25LQ032C,  MID_PMC,    0x9D,   0x46,   _pstWriteProtectTable_PM25Q032C,    NULL,                       0x400000,    64,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,    ISP_SPI_ENDIAN_LITTLE, FALSE},
    { FLASH_IC_GD25S80,     MID_GD,     0x40,   0x14,   NULL,    NULL,                                                  0x100000,    16,   SIZE_64KB,   256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,    ISP_SPI_ENDIAN_LITTLE, FALSE},
    ...
    { FLASH_IC_GD25Q32,      MID_GD,    0x40,   0x16,   NULL,    NULL,                                                       0x400000,    64,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, FALSE},
    { FLASH_IC_GD25Q64,      MID_GD,    0x40,   0x17,   NULL,    NULL,                                                       0x800000,    128,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,    ISP_SPI_ENDIAN_LITTLE, FALSE},
    { FLASH_IC_A25LM032,     MID_AM,    0x30,   0x16,   NULL,    NULL,                                                       0x400000,    64,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_PMC,    ISP_SPI_ENDIAN_LITTLE, FALSE},
};
