...
#define BASEADDR_RIU                0xFD000000  // TODO: <-@@@ CHIP SPECIFIC
#define BASEADDR_XIU                0xFE000000  // FLASH0 // TODO: <-@@@ CHIP SPECIFIC
...
// PM_SLEEP CMD.
#define REG_PM_SPI_GPIO             0x10
    #define PM_SPI_WP_DISABLE               BITS(0:0,1)
#define REG_PM_SPI_OEN              0x0F
    #define PM_SPI_GPIO0_OUT                BITS(0:0,1)
#define REG_PM_CKG_SPI              0x20 // Ref spec. before using these setting.
    ...
    #define PM_SPI_CLK_24MHZ                NULL
    #define PM_SPI_CLK_27MHZ                NULL
    #define PM_SPI_CLK_36MHZ                NULL
    #define PM_SPI_CLK_43MHZ                NULL 
    #define PM_SPI_CLK_54MHZ                BITS(13:10, 1)
    #define PM_SPI_CLK_86MHZ                BITS(13:10, 2)
    #define PM_SPI_CLK_72MHZ                NULL
...
#define REG_PM_EXTRA_GPIO_OUT		    0x1D
	#define PM_EXTRA_GPIO_OUT_MASK      BMASK(7:4)
    #define PM_EXTRA_CSZ0_GPIO_OUT_MASK      BMASK(4:4)
    #define	PM_EXTRA_CSZ0_GPIO_OUT(bit)	    BITS(4:4,(bit))
...
#define REG_PM_EXTRA_GPIO_OEN		    0x1E
    ...
    #define PM_EXTRA_CSZ0_GPIO_MASK			BMASK(4:4)
    #define	PM_EXTRA_CSZ0_GPIO_OEN(bit)	    BITS(4:4,(bit))
...
#define REG_PM_SPI_IS_GPIO			0x35
    ...
    #define PM_SPI_CSZ0_GPIO_MASK			BMASK(1:1)
    #define PM_SPI_CSZ0_IS_GPIO(bit)      BITS(1:1,(bit))
...
#define REG_CLK0_CKG_SPI            0x16
    ...
    #define CLK0_CKG_SPI_27MHZ              NULL
    #define CLK0_CKG_SPI_36MHZ              NULL
    #define CLK0_CKG_SPI_43MHZ              NULL
    #define CLK0_CKG_SPI_54MHZ              BITS(3:2, 1)
    #define CLK0_CKG_SPI_72MHZ              NULL
