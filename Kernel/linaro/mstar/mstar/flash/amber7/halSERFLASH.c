...
static hal_SERFLASH_t _hal_SERFLASH_table[] =   // Need to Add more sample for robust
{
    ...
    { FLASH_IC_W25Q80,		MID_WB, 	0x40,	0x14,	_pstWriteProtectTable_W25Q80,       NULL  ,						0x100000,	16, 	SIZE_64KB,	256,	50, 	BITS(5:2, 0x0F),	ISP_DEV_PMC,	ISP_SPI_ENDIAN_LITTLE, FALSE},
    ...
    { FLASH_IC_GD25Q16, 	MID_GD, 	0x40,	0x15,	_pstWriteProtectTable_GD25Q16_CMP0, NULL,						0x200000,	32, 	SIZE_64KB,	256,	50, 	BITS(6:2, 0x1F),	ISP_DEV_PMC,	ISP_SPI_ENDIAN_LITTLE, TRUE },
