#ifndef __UNFD_NUGGET_LINUX_H__
#define __UNFD_NUGGET_LINUX_H__
...
#define NAND_MODE4                          (BIT9) //NAND_AD_DQS
...
#define REG_NAND_DQS_UL                     GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x08)
#define BIT_DQS_PULL_H                      BIT4
...
#define reg_ckg_fcie                        GET_REG_ADDR(MPLL_CLK_REG_BASE_ADDR, 0x65)
