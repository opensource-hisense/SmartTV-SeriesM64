#ifndef __UNFD_J1_LINUX_H__
#define __UNFD_J1_LINUX_H__
...
#define RIU_PM_BASE							0xA0000000
#define RIU_BASE							0xA0200000
...
#define reg_nf_en							GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x20)
...
#else
#define FCIE_DEFAULT_CLK					NFIE_CLK_32M
