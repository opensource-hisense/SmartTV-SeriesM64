...
extern U32 nand_DMA_MAP_address(U32 u32_Buffer, U32 u32_ByteCnt, int mode);
extern void nand_DMA_UNMAP_address(U32 u32_DMAAddr, U32 u32_ByteCnt, int mode);
