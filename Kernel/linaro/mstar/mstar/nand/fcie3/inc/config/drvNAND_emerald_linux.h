#ifndef __UNFD_EMERALD_LINUX_H__
#define __UNFD_EMERALD_LINUX_H__
...
#define REG_BANK_PMSLEEP                    (0x0700)
...
#define PMSLEEP_REG_BASE_ADDR               GET_REG_ADDR(RIU_PM_BASE, REG_BANK_PMSLEEP)
...
#define reg_chip_config                     GET_REG_ADDR(PMSLEEP_REG_BASE_ADDR, 0x1F)
