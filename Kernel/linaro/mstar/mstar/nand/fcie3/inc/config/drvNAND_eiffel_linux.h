#ifndef __UNFD_EIFFEL_LINUX_H__
#define __UNFD_EIFFEL_LINUX_H__
...
#define ANA_MISC							GET_REG_ADDR(RIU_PM_BASE+0x221800, 0x39)
...
#define REG_NAND_DQS_UL                     GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x0E)
...
#define BIT_VPLUG_IN_PWRGD                  BIT14
...
#define NFIE_CLK_TABLE                      { NFIE_CLK_300K, NFIE_CLK_6M, NFIE_CLK_XTAL, NFIE_CLK_20M,  \
                                              NFIE_CLK_27M, NFIE_CLK_32M, NFIE_CLK_36M, NFIE_CLK_40M,   \
                                              NFIE_CLK_43_2M, NFIE_CLK_48M, NFIE_CLK_54M, NFIE_CLK_60M, \
                                              NFIE_CLK_75M, NFIE_CLK_80M, NFIE_CLK_86M }

#define NFIE_CLK_TABLE_STR                  { "300K", "6M", "XTAL", "20M",  \
                                              "27M", "32", "36M", "40M",    \
                                              "43.2M", "48M", "54M", "60M", \
                                              "75M", "80M", "86M"	}

#define NFIE_300K_VALUE                     300000
#define NFIE_6M_VALUE                       6000000
...
#define NFIE_75M_VALUE                      75000000
#define NFIE_80M_VALUE                      80000000
#define NFIE_86M_VALUE                      86000000


#define NFIE_CLK_VALUE_TABLE                { NFIE_300K_VALUE, NFIE_6M_VALUE, NFIE_XTAL_VALUE, NFIE_20M_VALUE,  \
                                              NFIE_27M_VALUE, NFIE_32M_VALUE, NFIE_36M_VALUE, NFIE_40M_VALUE,   \
                                              NFIE_43_2M_VALUE, NFIE_48M_VALUE, NFIE_54M_VALUE, NFIE_60M_VALUE, \
                                              NFIE_75M_VALUE, NFIE_80M_VALUE, NFIE_86M_VALUE }


/*Define 1 cycle Time for each clock note: define value must be the (real value -1)*/
#define NFIE_1T_300K                        332
#define NFIE_1T_6M                          166
...
#define NFIE_1T_75M                         13
#define NFIE_1T_80M                         12
#define NFIE_1T_86M                         11

#define NFIE_1T_TABLE                       { NFIE_1T_300K, NFIE_1T_6M, NFIE_1T_XTAL, NFIE_1T_20M,  \
                                              NFIE_1T_27M, NFIE_1T_32M, NFIE_1T_36M, NFIE_1T_40M,   \
                                              NFIE_1T_43_2M, NFIE_1T_48M, NFIE_1T_54M, NFIE_1T_60M, \
                                              NFIE_1T_75M, NFIE_1T_80M, NFIE_1T_86M }
