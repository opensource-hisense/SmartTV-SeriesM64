...
// MStar Patch Begin
#define MALI_OFFSET_GP                    mstar_riu_offset(0x00000)
#define MALI_OFFSET_GP_MMU                mstar_riu_offset(0x03000)
                                                                  
#define MALI_OFFSET_PP0                   mstar_riu_offset(0x08000)
#define MALI_OFFSET_PP0_MMU               mstar_riu_offset(0x04000)
#define MALI_OFFSET_PP1                   mstar_riu_offset(0x0A000)
#define MALI_OFFSET_PP1_MMU               mstar_riu_offset(0x05000)
#define MALI_OFFSET_PP2                   mstar_riu_offset(0x0C000)
#define MALI_OFFSET_PP2_MMU               mstar_riu_offset(0x06000)
#define MALI_OFFSET_PP3                   mstar_riu_offset(0x0E000)
#define MALI_OFFSET_PP3_MMU               mstar_riu_offset(0x07000)
                                                                  
#define MALI_OFFSET_PP4                   mstar_riu_offset(0x28000)
#define MALI_OFFSET_PP4_MMU               mstar_riu_offset(0x1C000)
#define MALI_OFFSET_PP5                   mstar_riu_offset(0x2A000)
#define MALI_OFFSET_PP5_MMU               mstar_riu_offset(0x1D000)
#define MALI_OFFSET_PP6                   mstar_riu_offset(0x2C000)
#define MALI_OFFSET_PP6_MMU               mstar_riu_offset(0x1E000)
#define MALI_OFFSET_PP7                   mstar_riu_offset(0x2E000)
#define MALI_OFFSET_PP7_MMU               mstar_riu_offset(0x1F000)
                                                                  
#define MALI_OFFSET_L2_RESOURCE0          mstar_riu_offset(0x01000)
#define MALI_OFFSET_L2_RESOURCE1          mstar_riu_offset(0x10000)
#define MALI_OFFSET_L2_RESOURCE2          mstar_riu_offset(0x11000)
...
#define MALI_OFFSET_BCAST                 mstar_riu_offset(0x13000)
#define MALI_OFFSET_DLBU                  mstar_riu_offset(0x14000)

#define MALI_OFFSET_PP_BCAST              mstar_riu_offset(0x16000)
#define MALI_OFFSET_PP_BCAST_MMU          mstar_riu_offset(0x15000)

#define MALI_OFFSET_PMU                   mstar_riu_offset(0x02000)
#define MALI_OFFSET_DMA                   mstar_riu_offset(0x12000)
// MStar Patch End
