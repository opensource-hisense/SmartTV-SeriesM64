...
#ifdef MSTAR
	mali_mem_usage_max = _mali_ukk_report_memory_usage_maximum();
	_mali_osk_ctxprintf(print_ctx, "Mali mem usage: %u\nMali max mem usage: %u\nMali mem limit: %u\n", mali_mem_usage, mali_mem_usage_max, total_mali_mem_size);
#else
