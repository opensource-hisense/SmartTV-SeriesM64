...
#ifdef MSTAR
/** @brief Platform dvfs suspend
 *
 */
void mali_dvfs_suspend(void);

/** @brief Platform dvfs resume
 *
 *
 */
void mali_dvfs_resume(void);

#if MSTAR_ADJUST_GPU_CLOCK
/** @brief Platform adjust GPU clock
 *
 *
 */
void mali_dvfs_adjust_gpu_clock(void);
#endif
#endif
 ...
 * periodically called.
 *
 * @param data The workload utilization data of the Mali GPU.
 */
