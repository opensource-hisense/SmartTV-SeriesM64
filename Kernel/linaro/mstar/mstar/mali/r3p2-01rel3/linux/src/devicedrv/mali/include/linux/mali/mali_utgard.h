...
#if MSTAR_RIU_ADDRESS_TYPE == 16
#define mstar_riu_offset(offset) ((offset)<<1)
#elif MSTAR_RIU_ADDRESS_TYPE == 32
#define mstar_riu_offset(offset) ((((offset) & 0xFFFF0000)<<1) | ((offset) & 0x0000FFFF))
#else
#error unsupported MSTAR_RIU_ADDRESS_TYPE
#endif
#else
#define mstar_riu_offset(offset) (offset)
#endif /* MSTAR_RIU_ENABLED */

/* Mali-200 */

#define MALI_GPU_RESOURCES_MALI200(base_addr, gp_irq, pp_irq, mmu_irq) \
	MALI_GPU_RESOURCE_PP(base_addr + mstar_riu_offset(0x0000), pp_irq) \
	MALI_GPU_RESOURCE_GP(base_addr + mstar_riu_offset(0x2000), gp_irq) \
	MALI_GPU_RESOURCE_MMU(base_addr + mstar_riu_offset(0x3000), mmu_irq)
...
#define MALI_GPU_RESOURCES_MALI400_MP1(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq) \
	MALI_GPU_RESOURCE_L2(base_addr + mstar_riu_offset(0x1000)) \
	MALI_GPU_RESOURCE_GP_WITH_MMU(base_addr + mstar_riu_offset(0x0000), gp_irq, base_addr + mstar_riu_offset(0x3000), gp_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(0, base_addr + mstar_riu_offset(0x8000), pp0_irq, base_addr + mstar_riu_offset(0x4000), pp0_mmu_irq)
...
#define MALI_GPU_RESOURCES_MALI400_MP1_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq) \
	...
	MALI_GPU_RESOURCE_PMU(base_addr + mstar_riu_offset(0x2000))

#define MALI_GPU_RESOURCES_MALI400_MP2(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq) \
	MALI_GPU_RESOURCE_L2(base_addr + mstar_riu_offset(0x1000)) \
	MALI_GPU_RESOURCE_GP_WITH_MMU(base_addr + mstar_riu_offset(0x0000), gp_irq, base_addr + mstar_riu_offset(0x3000), gp_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(0, base_addr + mstar_riu_offset(0x8000), pp0_irq, base_addr + mstar_riu_offset(0x4000), pp0_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(1, base_addr + mstar_riu_offset(0xA000), pp1_irq, base_addr + mstar_riu_offset(0x5000), pp1_mmu_irq)
...
#define MALI_GPU_RESOURCES_MALI400_MP3(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, pp2_mmu_irq) \
	...
	MALI_GPU_RESOURCE_PP_WITH_MMU(0, base_addr + mstar_riu_offset(0x8000), pp0_irq, base_addr + mstar_riu_offset(0x4000), pp0_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(1, base_addr + mstar_riu_offset(0xA000), pp1_irq, base_addr + mstar_riu_offset(0x5000), pp1_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(2, base_addr + mstar_riu_offset(0xC000), pp2_irq, base_addr + mstar_riu_offset(0x6000), pp2_mmu_irq)
...
#define MALI_GPU_RESOURCES_MALI400_MP4(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq) \
	...
	MALI_GPU_RESOURCE_PP_WITH_MMU(1, base_addr + mstar_riu_offset(0xA000), pp1_irq, base_addr + mstar_riu_offset(0x5000), pp1_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(2, base_addr + mstar_riu_offset(0xC000), pp2_irq, base_addr + mstar_riu_offset(0x6000), pp2_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(3, base_addr + mstar_riu_offset(0xE000), pp3_irq, base_addr + mstar_riu_offset(0x7000), pp3_mmu_irq)
...
/* Mali-450 */
#ifdef MSTAR
#define MALI_GPU_RESOURCES_MALI450_MP1(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp_bcast_irq) \
	MALI_GPU_RESOURCE_L2(base_addr + mstar_riu_offset(0x10000)) \
	MALI_GPU_RESOURCE_GP_WITH_MMU(base_addr + mstar_riu_offset(0x00000), gp_irq, base_addr + mstar_riu_offset(0x03000), gp_mmu_irq) \
	MALI_GPU_RESOURCE_L2(base_addr + mstar_riu_offset(0x01000)) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(0, base_addr + mstar_riu_offset(0x08000), pp0_irq, base_addr + mstar_riu_offset(0x04000), pp0_mmu_irq) \
	MALI_GPU_RESOURCE_BCAST(base_addr + mstar_riu_offset(0x13000)) \
	MALI_GPU_RESOURCE_DLBU(base_addr + mstar_riu_offset(0x14000)) \
	MALI_GPU_RESOURCE_PP_BCAST(base_addr + mstar_riu_offset(0x16000), pp_bcast_irq) \
	MALI_GPU_RESOURCE_PP_MMU_BCAST(base_addr + mstar_riu_offset(0x15000))

#define MALI_GPU_RESOURCES_MALI450_MP1_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp_bcast_irq) \
	MALI_GPU_RESOURCES_MALI450_MP1(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp_bcast_irq) \
	MALI_GPU_RESOURCE_PMU(base_addr + mstar_riu_offset(0x2000))
#endif
...
#define MALI_GPU_RESOURCES_MALI450_MP2(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp_bcast_irq) \
	...
	MALI_GPU_RESOURCE_L2(base_addr + mstar_riu_offset(0x01000)) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(0, base_addr + mstar_riu_offset(0x08000), pp0_irq, base_addr + mstar_riu_offset(0x04000), pp0_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(1, base_addr + mstar_riu_offset(0x0A000), pp1_irq, base_addr + mstar_riu_offset(0x05000), pp1_mmu_irq) \
	MALI_GPU_RESOURCE_BCAST(base_addr + mstar_riu_offset(0x13000)) \
	MALI_GPU_RESOURCE_DLBU(base_addr + mstar_riu_offset(0x14000)) \
	MALI_GPU_RESOURCE_PP_BCAST(base_addr + mstar_riu_offset(0x16000), pp_bcast_irq) \
	MALI_GPU_RESOURCE_PP_MMU_BCAST(base_addr + mstar_riu_offset(0x15000))
...
#define MALI_GPU_RESOURCES_MALI450_MP3(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, pp2_mmu_irq, pp_bcast_irq) \
	...
	MALI_GPU_RESOURCE_PP_WITH_MMU(0, base_addr + mstar_riu_offset(0x08000), pp0_irq, base_addr + mstar_riu_offset(0x04000), pp0_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(1, base_addr + mstar_riu_offset(0x0A000), pp1_irq, base_addr + mstar_riu_offset(0x05000), pp1_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(2, base_addr + mstar_riu_offset(0x0C000), pp2_irq, base_addr + mstar_riu_offset(0x06000), pp2_mmu_irq) \
	MALI_GPU_RESOURCE_BCAST(base_addr + mstar_riu_offset(0x13000)) \
	MALI_GPU_RESOURCE_DLBU(base_addr + mstar_riu_offset(0x14000)) \
	MALI_GPU_RESOURCE_PP_BCAST(base_addr + mstar_riu_offset(0x16000), pp_bcast_irq) \
	MALI_GPU_RESOURCE_PP_MMU_BCAST(base_addr + mstar_riu_offset(0x15000))
...
#define MALI_GPU_RESOURCES_MALI450_MP4(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp_bcast_irq) \
	...
	MALI_GPU_RESOURCE_PP_WITH_MMU(1, base_addr + mstar_riu_offset(0x0A000), pp1_irq, base_addr + mstar_riu_offset(0x05000), pp1_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(2, base_addr + mstar_riu_offset(0x0C000), pp2_irq, base_addr + mstar_riu_offset(0x06000), pp2_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(3, base_addr + mstar_riu_offset(0x0E000), pp3_irq, base_addr + mstar_riu_offset(0x07000), pp3_mmu_irq) \
	MALI_GPU_RESOURCE_BCAST(base_addr + mstar_riu_offset(0x13000)) \
	MALI_GPU_RESOURCE_DLBU(base_addr + mstar_riu_offset(0x14000)) \
	MALI_GPU_RESOURCE_PP_BCAST(base_addr + mstar_riu_offset(0x16000), pp_bcast_irq) \
	MALI_GPU_RESOURCE_PP_MMU_BCAST(base_addr + mstar_riu_offset(0x15000))
...
#define MALI_GPU_RESOURCES_MALI450_MP6(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp4_irq, pp4_mmu_irq, pp5_irq, pp5_mmu_irq, pp_bcast_irq) \
	...
	MALI_GPU_RESOURCE_PP_WITH_MMU(1, base_addr + mstar_riu_offset(0x0A000), pp1_irq, base_addr + mstar_riu_offset(0x05000), pp1_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(2, base_addr + mstar_riu_offset(0x0C000), pp2_irq, base_addr + mstar_riu_offset(0x06000), pp2_mmu_irq) \
	MALI_GPU_RESOURCE_L2(base_addr + mstar_riu_offset(0x11000)) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(3, base_addr + mstar_riu_offset(0x28000), pp3_irq, base_addr + mstar_riu_offset(0x1C000), pp3_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(4, base_addr + mstar_riu_offset(0x2A000), pp4_irq, base_addr + mstar_riu_offset(0x1D000), pp4_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(5, base_addr + mstar_riu_offset(0x2C000), pp5_irq, base_addr + mstar_riu_offset(0x1E000), pp5_mmu_irq) \
	MALI_GPU_RESOURCE_BCAST(base_addr + mstar_riu_offset(0x13000)) \
	MALI_GPU_RESOURCE_DLBU(base_addr + mstar_riu_offset(0x14000)) \
	MALI_GPU_RESOURCE_PP_BCAST(base_addr + mstar_riu_offset(0x16000), pp_bcast_irq) \
	MALI_GPU_RESOURCE_PP_MMU_BCAST(base_addr + mstar_riu_offset(0x15000))
...
#define MALI_GPU_RESOURCES_MALI450_MP8(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp4_irq, pp4_mmu_irq, pp5_irq, pp5_mmu_irq, pp6_irq, pp6_mmu_irq, pp7_irq, pp7_mmu_irq, pp_bcast_irq) \
	...
	MALI_GPU_RESOURCE_PP_WITH_MMU(3, base_addr + mstar_riu_offset(0x0E000), pp3_irq, base_addr + mstar_riu_offset(0x07000), pp3_mmu_irq) \
	MALI_GPU_RESOURCE_L2(base_addr + mstar_riu_offset(0x11000)) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(4, base_addr + mstar_riu_offset(0x28000), pp4_irq, base_addr + mstar_riu_offset(0x1C000), pp4_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(5, base_addr + mstar_riu_offset(0x2A000), pp5_irq, base_addr + mstar_riu_offset(0x1D000), pp5_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(6, base_addr + mstar_riu_offset(0x2C000), pp6_irq, base_addr + mstar_riu_offset(0x1E000), pp6_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(7, base_addr + mstar_riu_offset(0x2E000), pp7_irq, base_addr + mstar_riu_offset(0x1F000), pp7_mmu_irq) \
	MALI_GPU_RESOURCE_BCAST(base_addr + mstar_riu_offset(0x13000)) \
	MALI_GPU_RESOURCE_DLBU(base_addr + mstar_riu_offset(0x14000)) \
	MALI_GPU_RESOURCE_PP_BCAST(base_addr + mstar_riu_offset(0x16000), pp_bcast_irq) \
	MALI_GPU_RESOURCE_PP_MMU_BCAST(base_addr + mstar_riu_offset(0x15000))
