...
#ifdef MSTAR
	_MALI_UK_GET_CPU_USAGE_ADJUST,           /**< _mali_uku_get_cpu_usage_adjust() */
	_MALI_UK_GET_MIU1_BASE,                  /**< _mali_uku_get_miu1_base() */
#endif
#ifdef MSTAR_DUMP_MEMORY_USAGE
	_MALI_UK_SET_MEMORY_DUMP_NOTIFICATION,   /**< _mali_uku_set_memory_dump_notification */
#endif
...
#ifdef MSTAR_DUMP_MEMORY_USAGE
	_MALI_NOTIFCATION_MEMORY_USAGE_DUMPED =         (_MALI_UK_MEMORY_SUBSYSTEM << 16) | 0x80,
#endif
...
#ifdef MSTAR_DUMP_MEMORY_USAGE
/** @brief struct to hold the value to the memory usage dumped
 */
typedef struct {
	u32 pid;
	u32 flags;
} _mali_uk_memory_usage_dumped_s;
#endif
...
#ifdef MSTAR_DUMP_MEMORY_USAGE
		_mali_uk_memory_usage_dumped_s memory_usage_dumped; /**< [out] Notification data for _MALI_NOTIFCATION_MEMORY_USAGE_DUMPED notification type */
#endif
	} data;
...
#ifdef MSTAR
/** @brief Arguments to _mali_ukk_mem_get_cpu_usage_adjust()
 */
typedef struct {
	void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 value;                      /**< [out] value of cpu usage adjust */
} _mali_uk_get_cpu_usage_adjust;

/** @brief Arguments to _mali_ukk_mem_get_miu1_base()
 */
typedef struct {
	void *ctx;                      /**< [in,out] user-kernel context (trashed on output) */
	u32 addr;                       /**< [out] value of miu1 physical base address */
} _mali_uk_get_miu1_base;
#endif
