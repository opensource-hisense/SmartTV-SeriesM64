...
void MHal_EMAC_trim_phy( void )
{
	...
	*( ( u32 * ) ( ( char * ) 0xBF004000 +  0x06*2) ) = 0x0200;

	//efuse 13~0
	uEfuVal0 = (*( ( u32 * ) ( ( char * ) 0xBF004000 +  0x2c*2) ) & 0x03FF);
	uEfuVal1 = (*( ( u32 * ) ( ( char * ) 0xBF004000 +  0x2e*2) ) & 0x03FF);//ignore
	uEfuVal2 = (*( ( u32 * ) ( ( char * ) 0xBF004000 +  0x12*2) ) & 0x00FF);
	uEfuVal0 = (((uEfuVal2 & 0x000F) << 10)  | uEfuVal0);
	uEfuVal1 = (((uEfuVal2 & 0x00F0) << 6)  | uEfuVal1);
	uEfuVal0 = uEfuVal0 & (~uEfuVal1);

	*( ( u32 * ) ( ( char * ) 0xBF243400 + 0x68*2) ) = (uEfuVal0 | 0x8000);

	//efuse 17~14
	uEfuVal0 = (*( ( u32 * ) ( ( char * ) 0xBF004000 +  0x12*2) ) & 0x0F00) >> 8;
	uEfuVal1 = (*( ( u32 * ) ( ( char * ) 0xBF004000 +  0x12*2) ) & 0xF000) >> 12;//ignore
	EfuVal0 = uEfuVal0 & (~uEfuVal1);

	*( ( u32 * ) ( ( char * ) 0xBF243400 + 0x60*2) ) = ((uEfuVal0 << 8) | 0x0004);
}
...
void MHal_EMAC_Power_On_Clk( void )
{
    ...
    *( ( u32 * ) ( ( char * ) 0xBF001C00 + 0x30*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF001C00 +  0x30*4) ) & 0xFF00) | 0x0020 ); // wriu      0x000e60  0x20     // PD_ETH33
    ...
    *( ( u32 * ) ( ( char * ) 0xBF243000 +  0x55*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243000 +  0x55*4) ) & 0x00FF) | 0x2800 ); // wriu      0x1218ab  0x28       //
    ...
    //disable EEE
    *( ( u32 * ) ( ( char * ) 0xBF243000 +  0x16*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243000 +  0x16*4) ) & 0xFFFF) | 0x4000 );
#else
...
#ifdef CONFIG_ETHERNET_ALBANY
    //chiptop pad_top [9:8]
    //*( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x6F*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x6F*4) ) & 0xFF00) | 0x10 );
    *( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x20*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x20*4) ) & 0xFFFC));
#else
