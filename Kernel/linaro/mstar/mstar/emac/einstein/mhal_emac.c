...
void MHal_EMAC_Enable_EEE(unsigned int delayms)
{
    ...
    if(uRegVal & 0x02 )
    {
        ...
        uRegVal = MHal_EMAC_ReadReg8(0x1021, 0x42);
        uRegVal |= 0x01;
        MHal_EMAC_WritReg8(0x1021, 0x42, uRegVal);
    }
    else
    {
        uRegVal = MHal_EMAC_ReadReg8(0x1021, 0x42);
...
void MHal_EMAC_trim_phy( void )
{
    ...
    //efuse read
    MHal_EMAC_WritReg8(0x0020, 0x4e, 0x25);
    MHal_EMAC_WritReg8(0x0020, 0x4f, 0x00);
    MHal_EMAC_WritReg8(0x0020, 0x4c, 0x01);
...
void MHal_EMAC_Power_On_Clk( void )
{
    ...
    //efuse read
    MHal_EMAC_WritReg8(0x0020, 0x4e, 0x26);
    MHal_EMAC_WritReg8(0x0020, 0x4f, 0x00);
    MHal_EMAC_WritReg8(0x0020, 0x4c, 0x01);
    ...
    uEfuVal0 = MHal_EMAC_ReadReg8(0x0020, 0x82);
    uSadcMode = (uEfuVal0 & 0x04) >> 2 ;
    ...
    if(1)
    {
        ...
        //PD_SADC, EN_SAR_LOGIC**
        MHal_EMAC_WritReg8(0x0034, 0xa1, 0xd0);
    ...
    MHal_EMAC_WritReg8(0x0033, 0xbb, 0x45);
    ...
    //100T TX
    MHal_EMAC_WritReg8(0x0033, 0xc2, 0x00);
    MHal_EMAC_WritReg8(0x0033, 0xc3, 0x70);
    ...
    MHal_EMAC_WritReg8(0x0034, 0x4d, 0x00);
    ...
    *( ( u32 * ) ( ( char * ) 0xFD201600 +  0x62*4) ) = 0x0000; //Enable RX clk from exterenel crystal
#endif
