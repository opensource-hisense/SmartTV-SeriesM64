...
#define RIU16    ((u16  volatile *) RIU_MAP)
#define RIU8    ((unsigned char  volatile *) RIU_MAP)
#define MST_MACRO_START     do {
#define MST_MACRO_END       } while (0)
#define MDrv_Read2Byte( u32Reg )    RIU16[u32Reg]
#define MHal_EMAC_WriteByteMask( u32Reg, u8Val, u8Msk )                                 \
    MST_MACRO_START                                                                     \
...
#define INTERNEL_PHY_REG_BASE               0xFD006200
