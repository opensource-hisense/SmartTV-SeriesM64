...
#ifndef __DRV_EMAC__
#define __DRV_EMAC__
#define EMAC_DBG(fmt, args...)              {printk("%04d %s " fmt, __LINE__, __FUNCTION__,  ##args);}
//-------------------------------------------------------------------------------------------------
...
#ifdef SECEMAC
#define REG_ADDR_BASE                           0xBF240800      // The register address base. Depends on system define.
#else
...
#define EMAC_DESC_TCP_UDP_CSUM         (0x1 << 20)
#define EMAC_DESC_IP_CSUM               (0x1 << 21)
#define EMAC_DESC_TAG_MATCH                  (0x1 << 22)
#define EMAC_DESC_CAM_MATCH                  (0x1 << 28)
