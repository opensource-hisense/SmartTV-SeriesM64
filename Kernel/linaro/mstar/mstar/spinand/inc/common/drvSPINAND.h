...
extern void MDrv_SPINAND_Device(struct device *dev);
extern U32 MDrv_SPINAND_WriteProtect(BOOL bEnable);
extern BOOL MDrv_SPINAND_IsActive(void);
...
extern BOOL HAL_SPINAND_IsActive(void);
