...
#define IR_HEADER_CODE0         0x18//0x80    // Custom 0
#define IR_HEADER_CODE1         0x18//0x7F    // Custom 1

#define IR_HEADER_CODE3         0x07//0x80    // Custom 0
#define IR_HEADER_CODE4         0x07//0x7F    // Custom 1

//TPV key 
#define IR_FHEADER_CODE0            0x20//0x80    // Custom 0
#define IR_FHEADER_CODE1            0x08//0x7F    // Custom 1
