...
static void _NecRAW2Format(U32 u32RawData, U32 *pu32CustCode, U16 *pu16KeyCode, U8 *pu8State, U8 *pu8Reserved)
{
    ...
    *pu32CustCode = _MulProtCommon_LSB2MSB((u32RawData>>24)&0xFF)<<8 | _MulProtCommon_LSB2MSB((u32RawData>>16)&0xFF);
    *pu16KeyCode = _MulProtCommon_LSB2MSB((u32RawData>>8)&0xFF);
    return;
}
