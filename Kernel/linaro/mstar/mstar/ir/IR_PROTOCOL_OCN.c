...
static void _OcnRAW2Format(unsigned long long u64RawData, U32 *pu32CustCode, U16 *pu16KeyCode, U8 *pu8State, U8 *pu8Reserved)
{
    ...
    *pu32CustCode = (_MulProtCommon_LSB2MSB((u64RawData>>32)&0xFF))<<16 | (_MulProtCommon_LSB2MSB((u64RawData>>24)&0xFF))<<8 |_MulProtCommon_LSB2MSB((u64RawData>>16)&0xFF);//24 bits custom code, must be 'O','C','N'
    *pu16KeyCode = (_MulProtCommon_LSB2MSB((u64RawData>>8)&0xFF))<<8 | _MulProtCommon_LSB2MSB(u64RawData&0xFF);
