...
#define IR_HEADER_CODE3         0x80    // Custom 0
#define IR_HEADER_CODE4         0x61    // Custom 1

#define IR_PHEADER_CODE0        0x80    // Custom 0//Third  IR PC
#define IR_PHEADER_CODE1        0x61    // Custom 1
