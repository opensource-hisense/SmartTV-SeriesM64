...
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_Init);
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_SetFlipInfo);
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_SetInputSigStatus);    
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_SetPixelIDAddr);
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_SetGPIO3DPin);
EXPORT_SYMBOL(_MDrv_GFLIP_RegisterInterrupt);
EXPORT_SYMBOL(_MDrv_GFLIP_DeRegisterInterrupt);
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_Set3DFlipInfo);
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_SetGwinInfo);
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_GetDWinIntInfo2);
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_ClearFlipQueue);
...
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_EnableVECapture);
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_GetVECaptureState);
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_VECaptureWaitOnFrame);
#endif

#ifdef	GFLIP_MULTI_FLIP
int _MDrv_GFLIPIO_IOC_SetMultiFlipInfo(struct file *filp, unsigned long arg);
EXPORT_SYMBOL(_MDrv_GFLIPIO_IOC_SetMultiFlipInfo);
#endif
...
int _MDrv_GFLIPIO_IOC_SetMultiFlipInfo(struct file *filp, unsigned long arg)
{
    ...
    if (MDrv_GFLIP_SetMultiFlipInfo(&stMultiFlipInfo))
    {
...
int _MDrv_GFLIPIO_IOC_GetVsync(struct file *filp, unsigned long arg)
{
    ...
    {
        printk("GFLIPIO_IOC_GetVsync GOP = %ld is out of range ",u32GopIdx);
        return EFAULT;
    }
