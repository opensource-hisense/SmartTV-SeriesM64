...
{
    UNUSED(u32GopIdx);
    printf("---Fatal Error: %s not implement.\n",__FUNCTION__);
    return FALSE;
}
...
{
    MS_U16 u16FWR = GOP_REG(REG_GOP_BANK_SEL) & GOP_FWR;

    UNUSED(bForceWriteIn);//Old IC, do not enable new flip function
