...
MS_U16 MHal_GFLIP_GetGopDst(MS_U32 u32GopIdx)
{
    ...
    //check VOP First:
    MHal_GFLIP_ReadGopReg(u32GopIdx, GFLIP_GOP_BANK_IDX_0, REG_GOP_CTRL0, &u16RegVal);
    if(u16RegVal & GOP_DST_B2)
    {
        return GFLIP_GOP_DST_VOP;
    }

    //Not VOP, Handle Others:
...
/*        case GFLIP_GOP_DST_IPSUB:
        ...
        case GFLIP_GOP_DST_VOP:
            ...
            break;
        case GFLIP_GOP_DST_MIXER2VE:
            switch(u32GopIdx)
            {
                case GFLIP_GOP_IDX_2G:
                    u16RegVal = CKG_GOPG1_MIXERCLK;
                    u16RegMask = CKG_GOPG1_MASK;
                    break;
                case GFLIP_GOP_IDX_1G:
                    u16RegVal = CKG_GOPG2_MIXERCLK;
                    u16RegMask = CKG_GOPG2_MASK;
                    break;
                case GFLIP_GOP_IDX_4G:
                    u16RegVal = CKG_GOPG0_MIXERCLK;
                    u16RegMask = CKG_GOPG0_MASK;
                    break;
                default:
                    return FALSE;
...
MS_U32 MHal_GFLIP_GetIntGopIdx(void)
{
    ...
    u16RegVal = GOP_REG(REG_GOP_BANK_SEL, 0);
