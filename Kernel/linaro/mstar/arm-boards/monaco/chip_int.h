...
//  E_FIQ_RESERVED                      = E_FIQH_START + 10,
   ...
   // E_IRQEXPL_MIU_SECURITY              = E_IRQEXPL_START + 4,
   ...
   // E_IRQEXPL_EVD                       = E_IRQEXPL_START + 12,
    ...
    //E_FIQ_RESERVED                                   = E_FIQEXPL_START + 9,
...
//  E_FIQEXPH_RESERVED                  = E_FIQEXPH_START + 0,
    E_FIQEXPL_SECURE_R2_TO_ARM_C1       = E_FIQEXPH_START + 1,
    E_FIQEXPL_SECURE_R2_TO_ARM          = E_FIQEXPH_START + 2,
    E_FIQEXPL_SECURE_R2_TO_8051         = E_FIQEXPH_START + 3,
