...
inline void _chip_flush_miu_pipe(void)
{
    ...
    *(volatile unsigned short *)(0xfd203114) |= 0x0001;
    ...
    do
    {
        ...
        dwReadData &= (_BIT(12) | _BIT(13));  //Check Status of Flush Pipe Finish

    } while(dwReadData != (_BIT(12) | _BIT(13)));
