...
#define IOCTL_SYS_SPI_ERASE_SECTOR     _IOWR (SYS_IOCTL_MAGIC, 0x7C, int)
#endif
#define IOCTL_SYS_FORCE_ENV_UPGRADE_FROM_DRAM _IOWR (SYS_IOCTL_MAGIC,0x97, int)
#define IOCTL_SYS_FORCE_OAD_UPGRADE_FROM_DRAM _IOWR (SYS_IOCTL_MAGIC,0x98, int)
...
#define IOCTL_SYS_GET_POWER_STATES   _IOWR (SYS_IOCTL_MAGIC, 0x9B, int)
#if (MP_RCU_DETECT_PROLONG == 1)
#define IOCTL_SYS_FORCE_STOP_USER           _IOWR (SYS_IOCTL_MAGIC, 0x9C, char*)
#endif
