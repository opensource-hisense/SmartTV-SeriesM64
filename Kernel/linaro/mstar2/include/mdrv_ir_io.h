...
#define MDRV_IR_SET_MULTLICUSTOMER       _IOW(IR_IOC_MAGIC, 17, MS_IR_MutliCustomerCode)
#define MDRV_IR_GET_POWERKEY        _IOW(IR_IOC_MAGIC, 18, int)
...
//-------------------------------------------------------------------------------------------------
//----------------------------CVTE ADD FEATURE CONFIG----------------------------------------------
#define LED_BLINK  						1 //CVTE add blink led
//#define CVT_SUPPORT_THTF_THIRD_IR		0 //CVTE add for THTF
#define CVT_SUPPORT_THIRD_IR		    1
#define CVT_SUPPORT_RC6_AND_NEC_IR      0
//-------------------------------------------------------------------------------------------------
#if LED_BLINK
