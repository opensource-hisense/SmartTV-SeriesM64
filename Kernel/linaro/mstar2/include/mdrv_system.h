...
#if defined(CONFIG_MSTAR_KENYA) || defined(CONFIG_MSTAR_AMBER1) || defined(CONFIG_MSTAR_KERES) || defined(CONFIG_MSTAR_KIRIN) || defined(CONFIG_MSTAR_KRIS) || defined(CONFIG_MSTAR_NUGGET) || defined(CONFIG_MSTAR_KIWI) \
                                || defined(CONFIG_MSTAR_KAYLA) || defined(CONFIG_MSTAR_KRATOS) || defined(CONFIG_MSTAR_KENTUCKY)
...
#elif defined(CONFIG_MSTAR_EINSTEIN) || defined(CONFIG_MSTAR_NAPOLI) || defined(CONFIG_MSTAR_MUNICH) || defined(CONFIG_MSTAR_MUSTANG)
//Fix me!!Needs to be reivewed!!
#define REG_ADDR(addr)                         (*((volatile U16*)(0xFD200000 + (addr << 1))))
#define REG_CKG_AEONTS0                         0x3360
#define AEON_CLK_ENABLE                         0x0000 //CLK 216MHz
