...
#if 0//PIU Timer solution
#define REG_TIMER_MAX1      (0x1E50UL<<2)
#define REG_TIMER_CNT1      (0x1E52UL<<2)
#define REG_TIMER_CTL10     (0x1E54UL<<2)     //[0]: capture, [1]: clear
#define REG_TIMER_CTL11     ((0x1E54UL<<2)+1) //[1:0]=2'b11: Enable, [1:0]=2'b00: Disable
...
B16 MDrv_SW_IIC_AccessStart(U8 u8ChIIC, U8 u8SlaveAdr, U8 u8Trans)
{
    ...
    {
        u8SlaveAdr = u8SlaveAdr | 0x01UL; // read
    }
    else
    {
        u8SlaveAdr = u8SlaveAdr & 0xfeUL; // write
    }
...
void MDrv_IIC_Init(void)
{
    ...
    #if 1
    {
        ...
        {
            g_I2CBusCfg[u8ChIIC].u8ChIdx = 0xFFUL;
            g_I2CBusCfg[u8ChIIC].u16SpeedKHz = 100; //KHz
