...
// HAL APIs
//========================================================
U32 eMMC_FCIE_WaitEvents(uintptr_t u32_RegAddr, U16 u16_Events, U32 u32_MicroSec)
{
	return (*sgpFn_eMMC_FCIE_WaitEvents_Ex)(u32_RegAddr, u16_Events, u32_MicroSec);
}


U32 eMMC_FCIE_PollingEvents(uintptr_t u32_RegAddr, U16 u16_Events, U32 u32_MicroSec)
{
