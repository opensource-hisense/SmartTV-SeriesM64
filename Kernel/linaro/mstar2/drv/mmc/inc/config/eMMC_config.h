...
#if defined(CONFIG_MSTAR_MUNICH)
#define eMMC_DRV_MUNICH_LINUX        1
#endif
...
#define eMMC_DRV_KAYLA_LINUX		1
#endif

#if defined(CONFIG_MSTAR_MUSTANG)
#define eMMC_DRV_MUSTANG_LINUX		1
#endif
...
#elif defined(eMMC_DRV_MUNICH_LINUX) && eMMC_DRV_MUNICH_LINUX
	#include "eMMC_munich_linux.h"
#elif defined(eMMC_DRV_KAYLA_LINUX) && eMMC_DRV_KAYLA_LINUX
	#include "eMMC_kayla_linux.h"
#elif defined(eMMC_DRV_MUSTANG_LINUX) && eMMC_DRV_MUSTANG_LINUX
	#include "eMMC_mustang_linux.h"
#else
