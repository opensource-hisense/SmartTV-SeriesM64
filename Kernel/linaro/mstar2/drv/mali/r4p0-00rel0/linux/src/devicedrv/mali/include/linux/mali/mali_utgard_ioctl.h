...
#ifdef MSTAR
#define MALI_IOC_MEM_GET_CPU_USAGE_ADJUST   _IOR(MALI_IOC_MEMORY_BASE, _MALI_UK_GET_CPU_USAGE_ADJUST, _mali_uk_get_cpu_usage_adjust *)
#define MALI_IOC_MEM_GET_MIU1_BASE          _IOR(MALI_IOC_MEMORY_BASE, _MALI_UK_GET_MIU1_BASE, _mali_uk_get_miu1_base *)
#endif
#ifdef MSTAR_DUMP_MEMORY_USAGE
#define MALI_IOC_MEM_SET_DUMP_NOTIFICATION  _IOWR(MALI_IOC_MEMORY_BASE, _MALI_UK_SET_MEMORY_DUMP_NOTIFICATION, _mali_uk_memory_usage_dumped_s *)
#endif
