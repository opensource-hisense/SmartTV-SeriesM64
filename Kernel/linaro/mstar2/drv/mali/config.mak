...
$(shell rm -f $(src)/$(MALI_VERSION)/linux/src/devicedrv/build_system)
$(shell ln -s ../../../../../../hal/$(MALI_CHIP_NAME)/mali/$(MALI_VERSION)/linux/src/devicedrv/build_system $(src)/$(MALI_VERSION)/linux/src/devicedrv/build_system)

$(shell rm -f $(src)/$(MALI_VERSION)/linux/src/devicedrv/mali/platform)
$(shell ln -s ../../../../../../../hal/$(MALI_CHIP_NAME)/mali/$(MALI_VERSION)/linux/src/devicedrv/mali/platform $(src)/$(MALI_VERSION)/linux/src/devicedrv/mali/platform)

ifneq ($(CONFIG_UMP),)
$(shell rm -f $(src)/$(MALI_VERSION)/linux/src/devicedrv/ump/$(MALI_CONFIG))
$(shell ln -s ../../../../../../../hal/$(MALI_CHIP_NAME)/mali/$(MALI_VERSION)/linux/src/devicedrv/ump/arch-$(MALI_CONFIG) $(src)/$(MALI_VERSION)/linux/src/devicedrv/ump/arch-$(MALI_CONFIG))
endif
