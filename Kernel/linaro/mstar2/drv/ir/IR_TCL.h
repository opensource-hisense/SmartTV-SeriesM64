...
#define IR_HEADER_CODE0         0x00UL    // Custom 0
#define IR_HEADER_CODE1         0x0FUL    // Custom 1

#define BIKE_HEADER_CODE0     0x05UL
#define BIKE_HEADER_CODE1     0x0AUL
