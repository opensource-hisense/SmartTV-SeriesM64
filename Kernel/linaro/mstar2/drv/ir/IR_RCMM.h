...
//////////////////////////////////////////////////////////////////
#define RC_MODE 0x01UL
#define MOUSE_MODE 0x02UL
#define KEYBOARD_MODE 0x04UL
#define JOYSTICK_MODE 0x08UL
#define RC6_MODE_0 0x00UL
#define RC6_MODE_1A 0x01UL
#define RC6_MODE_2A 0x02UL
#define RC6_MODE_6ALOWPOWER 0x03UL
#define RC6_MODE_6AOEMCMD 0x04UL
#define RC6_MODE_6AOEMSTR 0x05UL
#define RC6_MODE_6B 0x06UL
#define RCMMBASIC_MODE 0x10UL
#define RCMMOEM_SHORTID_MODE 0x20UL
#define RCMMOEM_LONGID_MODE 0x40UL
#define RC6_MODE_FLAG 0x80UL //short OEM command mode RC, and RC6+ Keyboard, mouse mode
