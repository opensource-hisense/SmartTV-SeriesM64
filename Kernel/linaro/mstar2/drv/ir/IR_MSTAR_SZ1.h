...
{
    IRKEY_TV_RADIO          = IRKEY_DUMY-1,
    IRKEY_CHANNEL_LIST      = 0x16,
    IRKEY_CHANNEL_FAV_LIST  = IRKEY_DUMY-2,
    IRKEY_CHANNEL_RETURN    = 0x5A,
    IRKEY_CHANNEL_PLUS      = 0x5C,
    IRKEY_CHANNEL_MINUS     = 0x48,
    
    IRKEY_AUDIO             = 0x5E,
    IRKEY_VOLUME_PLUS       = 0x40,
    IRKEY_VOLUME_MINUS      = 0x44,
    ...
    IRKEY_TTX               = 0x0F,
    IRKEY_CC                = 0x17,
    IRKEY_INPUT_SOURCE      = 0x1E,
    IRKEY_CRADRD            = IRKEY_DUMY-4,
    IRKEY_PICTURE           = 0x4A,
    IRKEY_ZOOM              = 0x46,
    IRKEY_DASH              = IRKEY_DUMY-5,
    IRKEY_SLEEP             = 0x5F,
    IRKEY_EPG               = 0x01,
