...
#define IR_HEADER_CODE0         0x86UL    // Custom 0
#define IR_HEADER_CODE1         0x05UL    // Custom 1
...
typedef enum _IrCommandType
{
    ...
    IRKEY_CHANNEL_LIST      = 0x4C,
    IRKEY_CHANNEL_FAV_LIST  = 0x4B,
    IRKEY_CHANNEL_RETURN    = 0x10,
    IRKEY_CHANNEL_PLUS      = 0x0A,
    IRKEY_CHANNEL_MINUS     = 0x0B,

    IRKEY_AUDIO             = 0x48,
    IRKEY_VOLUME_PLUS       = 0x0C,
    IRKEY_VOLUME_MINUS      = 0x0D,
    ...
    IRKEY_TTX               = 0x1C,
    IRKEY_CC                = 0x1C,
    IRKEY_INPUT_SOURCE      = 0x1D,
    IRKEY_CRADRD            = IRKEY_DUMY-10,
//    IRKEY_PICTURE           = 0x49,
    IRKEY_ZOOM              = 0x44,
    IRKEY_DASH              = 0x41,
    IRKEY_SLEEP             = 0x13,
    ...
    IRKEY_PIP               = 0x49,
  	...
  	IRKEY_MIX               = IRKEY_DUMY-11,
  	IRKEY_INDEX             = IRKEY_DUMY-12,
    IRKEY_HOLD              = IRKEY_DUMY-13,
    IRKEY_PREVIOUS          = IRKEY_DUMY-14,
    IRKEY_NEXT              = IRKEY_DUMY-15,
    IRKEY_BACKWARD          = IRKEY_DUMY-16,
    IRKEY_FORWARD           = IRKEY_DUMY-17,
    IRKEY_PLAY              = IRKEY_DUMY-18,
    IRKEY_RECORD            = IRKEY_DUMY-19,
    IRKEY_STOP              = IRKEY_DUMY-20,
    IRKEY_PAUSE             = IRKEY_DUMY-21,

    IRKEY_SIZE              = IRKEY_DUMY-22,
    IRKEY_REVEAL            = IRKEY_DUMY-23,
