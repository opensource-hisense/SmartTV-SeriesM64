...
#define IR_HEADER_CODE3         0xAAUL          // Custom 3
#define IR_HEADER_CODE4         0x55UL          // Custom 4
// for pioneer double code
#define IR_HEADER_CODE5         0xAFUL          // Custom 5
#define IR_HEADER_CODE6         0x50UL          // Custom 6
#else
...
#if ENABLE_PIONEER_IR
#define IR_HEADER_CODE_TIME2     8530    // us
#define IR_OFF_CODE_TIME2        4270    // us
#define IR_OFF_CODE_RP_TIME2     2460    // us
#define IR_LOGI_01H_TIME2        530     // us
#define IR_LOGI_0_TIME2          1070    // us
#define IR_LOGI_1_TIME2          2180    // us
#define IR_TIMEOUT_CYC2          120000  // us
#else
...
#if ENABLE_PIONEER_IR
#define IRKEY_NULL              0x00UL

typedef struct {
    U8   u8IRKey;      //Skyworth IR key code
    U16 u16IRRawDate;  //Pioneer IR key code
} IR_PIONEER_MAP_TYPE;

IR_PIONEER_MAP_TYPE stPioneerIRMap[] =
{
    {0x5B,   0x5B22},        //Exit
    {0x11,   0x5B20},        //Menu
    {0x62,   0x5B2C},        //Red
