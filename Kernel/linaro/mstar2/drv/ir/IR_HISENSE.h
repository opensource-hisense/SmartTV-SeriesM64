...
//-------------------------------------------------------------------------------------------
#define IR_MODE_SEL             IR_TYPE_SWDECODE_MODE//Hisense 6I78 need support 2header code: one for user one for factory
// IR Header code define
#define IR_HEADER_CODE0         	0x00UL//0x80    // Custom 0
#define IR_HEADER_CODE1         	0xBFUL//0x7F    // Custom 1

#define IR_FHEADER_CODE0         	0x00UL//0x80    // Custom 0
#define IR_FHEADER_CODE1         	0xFCUL//0x7F    // Custom 1

#define IR_PHEADER_CODE0         	0x00UL//0x80    // Custom 0//Third  IR PC
#define IR_PHEADER_CODE1         	0x0FUL//0x7F    // Custom 1

#define FCTORY_HEADER_RECEIVE       0x40UL
#define PCCOMMAND_HEADER_RECEIVE    0x80UL
