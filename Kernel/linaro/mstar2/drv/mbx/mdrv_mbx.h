...
INTERFACE MBX_Result  MDrv_MBX_SendMsg(MS_U32 u32AsyncID, MBX_Msg *pMsg, MS_U8 u8Trigger);
INTERFACE MBX_Result  MDrv_MBX_SendMsgLoopback(MS_U32 u32AsyncID, MBX_Msg *pMsg, MBX_ROLE_ID eSrcRoleId);
INTERFACE MBX_Result  MDrv_MBX_RecvMsg(MS_U32 u32AsyncID, MBX_Class eTargetClass, MBX_Msg *pMsg, MS_U32 u32WaitMillSecs, MS_U32 u32Flag ,MS_U8 u8Trigger);
