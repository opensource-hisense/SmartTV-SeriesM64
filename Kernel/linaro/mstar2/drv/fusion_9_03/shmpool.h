...
#ifdef __mips__
#ifdef CONFIG_MP_FUSION_SIZE_ADDRESS_REFINE
#define FUSION_SHM_BASE_32	0x78000000	/* virtual base address */
#else
...
#ifdef CONFIG_MP_FUSION_SIZE_ADDRESS_REFINE
#define FUSION_SHM_SIZE_32	0x07F00000 	/* size of virtual address space */
#else
