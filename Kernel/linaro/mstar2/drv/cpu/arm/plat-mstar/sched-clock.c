...
#if defined(CONFIG_MSTAR_CLIPPERS) || defined(CONFIG_MSTAR_MONACO) || defined(CONFIG_MSTAR_MUNICH) || defined(CONFIG_MSTAR_MUSTANG)
...
#endif // CONFIG_MSTAR_CLIPPERS || CONFIG_MSTAR_MONACO || defined(CONFIG_MSTAR_MUNICH)
...
#if defined(CONFIG_MSTAR_CLIPPERS) || defined(CONFIG_MSTAR_MONACO) || defined(CONFIG_MSTAR_MUNICH)
