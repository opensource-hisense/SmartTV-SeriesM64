...
static unsigned int __init estimate_cpu_frequency(void)
{
...
#if defined(CONFIG_MSTAR_KAPPA) || defined(CONFIG_MSTAR_KENYA)  || defined(CONFIG_MSTAR_KERES) || defined(CONFIG_MSTAR_KRITI) || defined(CONFIG_MSTAR_KIRIN) || defined(CONFIG_MSTAR_KRIS) \
                                || defined(CONFIG_MSTAR_KIWI)   || defined(CONFIG_MSTAR_KENTUCKY) \
								|| defined(CONFIG_MSTAR_KRATOS) || defined(CONFIG_MSTAR_KAYLA)
    ...
    count = count >> 1;
#else
    count = 792000000 >> 1; //count = 216000000 >> 1;
#endif
    printk("CPU freq count = %d\n", count);
    if (0 == count)
    {
