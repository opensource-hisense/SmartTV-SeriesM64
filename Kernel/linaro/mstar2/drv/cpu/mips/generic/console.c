...
#ifdef CONFIG_MSTAR_KRIS
#include "../../../../drivers/mstar2/hal/kris/cpu/serial_reg.h"
#define UART_REG(addr) *((volatile unsigned int*)(0xBF201300 + ((addr)<< 2)))
#endif

#ifdef CONFIG_MSTAR_KIRIN
#include "../../../../drivers/mstar2/hal/kirin/cpu/serial_reg.h"
#define UART_REG(addr) *((volatile unsigned int*)(0xBF201300 + ((addr)<< 2)))
#endif

#ifdef CONFIG_MSTAR_KIWI
#include "../../../../drivers/mstar2/hal/kiwi/cpu/serial_reg.h"
#define UART_REG(addr) *((volatile unsigned int*)(0xBF201300 + ((addr)<< 2)))
#endif

#ifdef CONFIG_MSTAR_KENTUCKY
#include "../../../../drivers/mstar2/hal/kentucky/cpu/serial_reg.h"
#define UART_REG(addr) *((volatile unsigned int*)(0xBF201300 + ((addr)<< 2)))
#endif

#ifdef CONFIG_MSTAR_KAYLA
#include "../../../../drivers/mstar2/hal/kayla/cpu/serial_reg.h"
#define UART_REG(addr) *((volatile unsigned int*)(0xBF201300 + ((addr)<< 2)))
#endif

#ifdef CONFIG_MSTAR_KRATOS
#include "../../../../drivers/mstar2/hal/kartos/cpu/serial_reg.h"
#define UART_REG(addr) *((volatile unsigned int*)(0xBF201300 + ((addr)<< 2)))
#endif
