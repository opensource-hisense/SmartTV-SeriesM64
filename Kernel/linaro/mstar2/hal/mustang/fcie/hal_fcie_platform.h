...
#define CHIPTOP_4Fh				(RIU_BASE_CHIPTOP+(0x4F << RIU_UNIT_SHIFT))
...
#define CHIPTOP_5Bh				(RIU_BASE_CHIPTOP+(0x5B << RIU_UNIT_SHIFT))
...
// CHIPTOP_5Ah
#define REG_SD_CONFIG_MSK		(BIT08|BIT09|WBIT10|WBIT11)
#define REG_SD_MODE_1			BIT08
#define REG_SD_MODE_2			BIT09
#define REG_SD_MODE_3			(BIT09|BIT08)
#define REG_SD2_MODE_1			WBIT10
#define REG_SD2_MODE_2			WBIT11
...
#define EMMC_PLL_71h					(RIU_BASE_EMMC_PLL+(0x71 << RIU_UNIT_SHIFT))
#define EMMC_PLL_73h					(RIU_BASE_EMMC_PLL+(0x73 << RIU_UNIT_SHIFT))
...
#define ENABLE_FCIE_INTERRUPT_MODE	0
