...
U32 nand_pads_switch(U32 u32EnableFCIE)
{
    ...
    if(NAND_PAD_BYPASS_MODE == u32EnableFCIE)
    {
        ...
        REG_WRITE_UINT16(reg_nand_ps_0_15, 0xFEFB);
        REG_SET_BITS_UINT16(reg_nand_ps_16_17, 0x0003);
        NC_DQS_PULL_H();
    }
    else if(NAND_PAD_TOGGLE_MODE == u32EnableFCIE)
    {
        if(pNandDrv->u8_MacroType == MACRO_TYPE_8BIT)
        {
            ...
            REG_CLR_BITS_UINT16(reg_emmcpll_rx70, BIT8);
            REG_WRITE_UINT16(reg_nand_ps_0_15, 0xFEF3);
            REG_SET_BITS_UINT16(reg_nand_ps_16_17, 0x0003);
    ...
    else if(NAND_PAD_ONFI_SYNC_MODE == u32EnableFCIE)
    {
        ...
        else if(pNandDrv->u8_MacroType == MACRO_TYPE_32BIT)
        {
            ...
            REG_CLR_BITS_UINT16(reg_emmcpll_rx6d, BIT0);
            REG_SET_BITS_UINT16(reg_emmcpll_rx70, BIT8);
            REG_SET_BITS_UINT16(reg_emmcpll_rx1d, BIT9);
    ...
    REG_SET_BITS_UINT16(reg_nand_pe_0_15, 0xFFFF);
    REG_SET_BITS_UINT16(reg_nand_pe_16_17, 0x0003);
...
void nand_DumpPadClk(void)
{
    ...
    nand_debug(0, 1, " reg_pcm_d_pe(0x%08lX): 0x%04lX\n", reg_pcm_d_pe,(uintptr_t) REG(reg_pcm_d_pe));
    nand_debug(0, 1, " reg_pcm_a_pe(0x%08lX): 0x%04lX\n", reg_pcm_a_pe,(uintptr_t) REG(reg_pcm_a_pe));
    nand_debug(0, 1, " reg_nand_pe_0_15(0x%08lX): 0x%04lX\n", reg_nand_pe_0_15,(uintptr_t) REG(reg_nand_pe_0_15));
    nand_debug(0, 1, " reg_nand_pe_16_17(0x%08lX): 0x%04lX\n", reg_nand_pe_16_17,(uintptr_t) REG(reg_nand_pe_16_17));
    nand_debug(0, 1, " reg_nand_ps_0_15(0x%08lX): 0x%04lX\n", reg_nand_ps_0_15,(uintptr_t) REG(reg_nand_ps_0_15));
    nand_debug(0, 1, " reg_nand_ps_16_17(0x%08lX): 0x%04lX\n", reg_nand_ps_16_17,(uintptr_t) REG(reg_nand_ps_16_17));
