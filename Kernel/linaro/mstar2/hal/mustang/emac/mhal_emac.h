...
#else
#define REG_ADDR_BASE                       0xFD3a4200      // The register address base. Depends on system define.
#define REG_ADDR_BASE_EMAC1                 0xFD204000      // The register address base. Depends on system define.
#endif
