...
#define THIRD_UTMI_BASE_ADDRESS_START   (0xFD000000 + (0x103900 << 1))
#define THIRD_UTMI_BASE_ADDRESS_END     (0xFD000000 + (0x10397F << 1))
#define THIRD_USB_HOST20_ADDRESS_START  (0xFD000000 + (0x113900 << 1))
#define THIRD_USB_HOST20_ADDRESS_END    (0xFD000000 + (0x1139FE << 1))

#define FOURTH_UTMI_BASE_ADDRESS_START   (0xFD000000 + (0x122080 << 1))
#define FOURTH_UTMI_BASE_ADDRESS_END     (0xFD000000 + (0x1220FE << 1))
#define FOURTH_USB_HOST20_ADDRESS_START  (0xFD000000 + (0x122600 << 1))
#define FOURTH_USB_HOST20_ADDRESS_END    (0xFD000000 + (0x1226FE << 1))
