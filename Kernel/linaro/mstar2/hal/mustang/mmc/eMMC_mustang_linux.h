#ifndef __eMMC_MUSTANG_LINUX__
#define __eMMC_MUSTANG_LINUX__
...
#define reg_sd_config                   GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x57)
#define BIT_SD_CFG_MASK                 (BIT11|BIT10|BIT9|BIT8)
