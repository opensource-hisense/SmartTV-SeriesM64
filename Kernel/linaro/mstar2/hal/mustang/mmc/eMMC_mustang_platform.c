...
U32 eMMC_pads_switch(U32 u32Mode)
{
    ...
    REG_FCIE_CLRBIT(reg_chiptop_0x50, BIT_NAND_MODE);
    ...
    REG_FCIE_CLRBIT(reg_emmc_test, BIT10|BIT5|BIT4|BIT0);   //0x1a
    ...
    switch(u32Mode)
    {
        ...
        case FCIE_eMMC_SDR:
            ...
            // emmc_pll
            REG_FCIE_SETBIT(reg_emmc_test, BIT4|BIT5|BIT10);
        ...
        case FCIE_eMMC_HS200:
            ...
            REG_FCIE_SETBIT(reg_emmc_test, BIT5|BIT4|BIT0);
        ...
        case FCIE_eMMC_HS400_AIFO_5_1:
            ...
            REG_FCIE_SETBIT(reg_emmcpll_0x1c, BIT8);               //meta issue of clk4x and skew
            REG_FCIE_SETBIT(reg_emmc_test, BIT5|BIT4);
