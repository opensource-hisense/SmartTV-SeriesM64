...
#define GOP_MIU_CLIENT                          (BIT(5)|BIT(6)|BIT(7))
...
#define REG_GOP_BANK_SEL                        0x007f
    ...
    #define GOPD_INT_FLAG_MASK             BMASK(6:6)
    ...
    #define GOP2G_WR_ACK                       BIT(13)
    #define GOPD_WR_ACK                        BIT(14)
    #define GOP1G_WR_ACK                       BIT(15)
