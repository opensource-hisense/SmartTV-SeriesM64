...
void MHal_EMAC_Power_On_Clk( void )
{
    ...
    //gain shift
    MHal_EMAC_WritReg8(0x1219, 0xb4, 0x02);
    ...
    MHal_EMAC_WritReg8(0x1218, 0x72, 0xa0);

    MHal_EMAC_WritReg8(0x1219, 0xfc, 0x00);
    MHal_EMAC_WritReg8(0x1219, 0xfd, 0x00);
    MHal_EMAC_WritReg8(0x1219, 0xb7, 0x17);
    MHal_EMAC_WritReg8(0x1219, 0xcb, 0x11);
    MHal_EMAC_WritReg8(0x1219, 0xcc, 0x20);
    MHal_EMAC_WritReg8(0x1219, 0xcd, 0xd0);
    MHal_EMAC_WritReg8(0x1219, 0xd4, 0x00);
    MHal_EMAC_WritReg8(0x1219, 0xb9, 0x40);
    MHal_EMAC_WritReg8(0x1219, 0xbb, 0x45);
    MHal_EMAC_WritReg8(0x121a, 0x3a, 0x03);
    MHal_EMAC_WritReg8(0x121a, 0x3b, 0x00);
    MHal_EMAC_WritReg8(0x1219, 0x3b, 0x01);
    MHal_EMAC_WritReg8(0x121a, 0xa1, 0xd0);
    MHal_EMAC_WritReg8(0x121a, 0x8a, 0x01);
    MHal_EMAC_WritReg8(0x1219, 0xc4, 0x44);
    MHal_EMAC_WritReg8(0x121a, 0x80, 0x30);
    ...
    MHal_EMAC_WritReg8(0x1219, 0xf5, 0x02);

    //signal_det_k
    MHal_EMAC_WritReg8(0x1219, 0x0f, 0xc9);

    //snr_h
    MHal_EMAC_WritReg8(0x1219, 0x89, 0x50);
    MHal_EMAC_WritReg8(0x1219, 0x8b, 0x80);
    MHal_EMAC_WritReg8(0x1219, 0x8e, 0x0e);
    MHal_EMAC_WritReg8(0x1219, 0x90, 0x04);
