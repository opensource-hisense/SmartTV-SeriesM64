#ifndef __UNFD_MUNICH_LINUX_H__
#define __UNFD_MUNICH_LINUX_H__
...
#define RIU_BASE                            ((uintptr_t)(mstar_pm_base) +200000UL)
...
#define reg_emmc_config2                     GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x1D)
#define reg_nf_en                           GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x50)

#define reg_sd_config                       GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x57)
#define reg_sd_config2                       GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x57)
...
//@FIXME
#define REG_NAND_DQS_UL                     GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x7D)
...
#define BIT_CLK_NFIE_SELECT         BIT7
...
// SAR5
#define reg_vplug_in_pwrgd             		GET_REG_ADDR(PM_SLEEP_REG_BASE_ADDR, 0x62)
