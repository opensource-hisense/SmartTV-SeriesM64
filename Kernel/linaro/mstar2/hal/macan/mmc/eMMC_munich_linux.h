#ifndef __eMMC_MUNICH_LINUX__
#define __eMMC_MUNICH_LINUX__
...
#define BIT_NAND_MODE                  (BIT9|BIT8|BIT7)
...
#define REG_GPIO_0x07                   GET_REG_ADDR(GPIO_BASE, 0x07)
#define REG_GPIO_0x08                   GET_REG_ADDR(GPIO_BASE, 0x08)
...
extern  U32 eMMC_DMA_MAP_address(uintptr_t ulongBuffer, U32 u32_ByteCnt, int mode);
extern void eMMC_DMA_UNMAP_address(uintptr_t ulongDMAAddr, U32 u32_ByteCnt, int mode);
