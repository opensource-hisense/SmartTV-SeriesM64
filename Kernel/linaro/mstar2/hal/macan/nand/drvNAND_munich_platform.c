...
U32 nand_pads_switch(U32 u32EnableFCIE)
{
    ...
    REG_CLR_BITS_UINT16(reg_emmc_config2, BIT8);
...
void nand_DumpPadClk(void)
{
    ...
    nand_debug(0, 1, " reg_sd_config2(0x%08lX): 0x%04lX\n", reg_sd_config2, (uintptr_t) REG(reg_sd_config2));
    nand_debug(0, 1, " reg_emmc_config(0x%08lX): 0x%04lX\n", reg_emmc_config, (uintptr_t) REG(reg_emmc_config));
    nand_debug(0, 1, " reg_emmc_config2(0x%08lX): 0x%04lX\n", reg_emmc_config2, (uintptr_t) REG(reg_emmc_config2));
