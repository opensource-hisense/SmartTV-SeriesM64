...
#define MSTAR_MIU1_BUS_BASE                      (~0UL)  // not used, kentucky has only one MIU
#define MSTAR_MIU2_BUS_BASE                      (~0UL)  // not used, kentucky has only one MIU
#define MSTAR_MIU3_BUS_BASE                      (~0UL)  // not used, kentucky has only one MIU
