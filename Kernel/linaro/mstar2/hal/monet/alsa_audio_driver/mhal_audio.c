 ...
 * ============================================================================
 */
#define _MAD_CHIP_MODEL    "MAD MUJI"
...
static int _mhal_alsa_dma_reader_init(void)
{
	...
	MS_PHY64 audio_pcm_dmaRdr_base_pa = 0; /* DMA Reader Input buffer (DM_Prefetch) */
	MS_PHY64 audio_pcm_dmaRdr_base_ba = 0;
	MS_PHY64 audio_pcm_dmaRdr_base_va = 0;
...
static int _mhal_alsa_pcm_playback2_init(void)
{
	...
	MS_PHY64 audio_pcm_dmaRdr_base_pa = 0;
	MS_PHY64 audio_pcm_dmaRdr_base_ba = 0;
	MS_PHY64 audio_pcm_dmaRdr_base_va = 0;
...
static int _mhal_alsa_pcm_capture1_init(void)
{
	...
	MS_PHY64 audio_pcm_capture_base_pa = 0;
	MS_PHY64 audio_pcm_capture_base_ba = 0;
	MS_PHY64 audio_pcm_capture_base_va = 0;
	unsigned int w_ptr_offset = 0;
