...
#define BASEADDR_RIU                (mstar_pm_base)  // TODO: <-@@@ CHIP SPECIFIC
#define BASEADDR_XIU                0x14000000  // FLASH0 // TODO: <-@@@ CHIP SPECIFIC
#define BASEADDR_NonPMBankRIU       (mstar_pm_base + 0x00200000UL)
#endif
// #define BASEADDR_XIU                0xB8000000  // FLASH1 // TODO: use define instead of hard code e.g. CONFIG_SERFLASH1_SEL
#define BK_ISP                      0x1000UL
#define BK_PIU                      0x7800UL
#define BK_MHEG5                    0x1E00UL
#define BK_PMSLP                    0x1C00UL
#define BK_CLK0                     0x1600UL
...
#define REG_ISP_SPI_MODE            0x72UL
...
#define REG_ISP_SPI_CHIP_SELE       0x7AUL
...
#define REG_ISP_SPI_CHIP_SELE_BUSY  0x7BUL
...
#define REG_PIU_DMA_STATUS          0x10UL // [1]done [2]busy [8:15]state
...
#define REG_PIU_SPI_CLK_SRC         0x26UL // SPI clock source  [0]:gate  [1]:inv  [4:2]:clk_sel  000:Xtal clock 001:27MHz 010:36MHz 011:43.2MHz 100:54MHz 101:72MHz 110:86MHz 111:108MHz  [5]:0:xtal 1:clk_Sel
...
#define REG_PIU_DMA_SPISTART_L      0x70UL // [15:0]
#define REG_PIU_DMA_SPISTART_H      0x71UL // [23:16]
#define REG_PIU_DMA_DRAMSTART_L     0x72UL // [15:0]  in unit of B; must be 8B aligned
#define REG_PIU_DMA_DRAMSTART_H     0x73UL // [23:16]
#define REG_PIU_DMA_SIZE_L          0x74UL // [15:0]  in unit of B; must be 8B aligned
#define REG_PIU_DMA_SIZE_H          0x75UL // [23:16]
#define REG_PIU_DMA_CMD             0x76UL
    #define PIU_DMA_CMD_FIRE            0x0001UL
    #define PIU_DMA_CMD_LE              0x0000UL
    #define PIU_DMA_CMD_BE              0x0020UL
...
// PM_SLEEP CMD.
#define REG_PM_CKG_SPI              0x20UL // Ref spec. before using these setting.
...
#define REG_PM_GPIO_SPICZ_OEN       0x17UL
#define REG_PM_GPIO_SPICK_OEN       0x18UL
#define REG_PM_GPIO_SPIDI_OEN       0x19UL
#define REG_PM_GPIO_SPIDO_OEN       0x1AUL
#define REG_PM_SPI_IS_GPIO          0x35UL
...
//FSP REG
#define FSP_OFFSET          0x60UL
#define REG_FSP_WD0         (FSP_OFFSET+0x00UL)
...
#define REG_FSP_WBF_SIZE        (FSP_OFFSET+0x0AUL)
...
#define REG_FSP_RBF_SIZE        (FSP_OFFSET+0x0BUL)
...
#define REG_FSP_CTRL            (FSP_OFFSET+0x0CUL)
