...
// Defines & Macros
//=============================================================================
#define E_FIQ_INT_AEON_TO_8051    E_FIQEXPL_REG_HST1to0
#define E_FIQ_INT_MIPS_TO_8051    E_FIQEXPL_REG_HST2to0
#define E_FIQ_INT_8051_TO_AEON    E_FIQEXPL_REG_HST0to1
#define E_FIQ_INT_MIPS_TO_AEON    E_FIQEXPL_REG_HST2to1
#define E_FIQ_INT_8051_TO_MIPS    E_FIQEXPL_REG_HST0to2
#define E_FIQ_INT_AEON_TO_MIPS    E_FIQEXPL_REG_MIPS1toMIPS0
