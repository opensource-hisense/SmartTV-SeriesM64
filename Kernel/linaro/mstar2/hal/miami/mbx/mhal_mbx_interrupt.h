...
#define E_FIQ_INT_MIPS_TO_8051   E_FIQ_ARM_TO_8051 //VALID //E_FIQ_INT_ARM_TO_8051
#define E_FIQ_INT_8051_TO_AEON  (0xFF-1)
#define E_FIQ_INT_MIPS_TO_AEON   (0xFF-2)
#define E_FIQ_INT_8051_TO_MIPS   E_FIQ_8051_TO_ARM //VALID //E_FIQ_INT_8051_TO_ARM
#define E_FIQ_INT_AEON_TO_MIPS   (0xFF-3)

#define MBX_INT_AEON2PM     E_FIQ_SECURER2_TO_8051
#define MBX_INT_PM2AEON     E_FIQ_8051_TO_SECURER2
#define MBX_INT_PM2MIPS     (E_FIQ_8051_TO_ARM - E_FIQEXPL_START)
#define MBX_INT_MIPS2PM     (E_FIQ_ARM_TO_8051 - E_FIQEXPL_START)
#define MBX_INT_MIPS2AEON   E_FIQ_ARM_TO_SECURER2
#define MBX_INT_AEON2MIPS   E_FIQ_SECURER2_TO_ARM
