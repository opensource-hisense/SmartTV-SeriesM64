...
#define REG_GOP_INT                   0x0008
    ...
    #define GOP_INTMASK_FLD             BIT(3)
    #define GOP_INT_VS0                  BIT(8)
    #define GOP_INT_VS1                  BIT(9)
    #define GOP_INT_FLD                  BIT(11)
...
#define REG_GOP_BANK_SEL              0x007f
    ...
    #define GOP4G_WR_ACK                       BIT(12)
    #define GOP4GX_WR_ACK                       BIT(13)
...
#define GOP_GOPCLK             0x40
    ...
    #define CKG_GOPG0_VECLK          BITS(4:2, 6)
...
#define GOP_GOP23CLK            0x42
    ...
    #define CKG_GOPG2_VECLK         BITS(4:2, 6)

    #define CKG_GOPG3_DISABLE_CLK   ~(BIT(8))
    #define CKG_GOPG3_MASK          BMASK(12:10)
    #define CKG_GOPG3_ODCLK         BITS(12:10, 0)
    //#define CKG_GOPG3_IDCLK2        BITS(12:10, 1)
    //#define CKG_GOPG3_IDCLK1        BITS(12:10, 3)
    #define CKG_GOPG3_VECLK         BITS(4:2, 6)
