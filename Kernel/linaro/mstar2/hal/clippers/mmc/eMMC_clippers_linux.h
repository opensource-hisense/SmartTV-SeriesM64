#ifndef __eMMC_CLIPPERS_LINUX__
#define __eMMC_CLIPPERS_LINUX__
...
#define reg_nand_pad_driving            GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x14)
...
//--------------------------------GPIO mode--------------------------------------
#define REG_BANK_GPIO	                   0x1580	// (0x102B) x 80h
#define GPIO_MODE_BASE		               GET_REG_ADDR(RIU_BASE, REG_BANK_GPIO)
#define reg_pad_emmc_rst_output            GET_REG_ADDR(GPIO_MODE_BASE, 0x23)
#define reg_pad_emmc_rst_oen               GET_REG_ADDR(GPIO_MODE_BASE, 0x25)
