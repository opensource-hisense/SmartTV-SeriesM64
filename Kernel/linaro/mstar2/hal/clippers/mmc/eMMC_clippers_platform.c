...
U32 eMMC_pads_switch(U32 u32Mode)
{
    ...
    REG_FCIE_CLRBIT(reg_emmcpll_0x1d, BIT8|BIT9|BIT10);     // reg_use_dll_skew4
    ...
    switch(u32Mode)
    {
        case FCIE_eMMC_BYPASS:
            eMMC_debug(eMMC_DEBUG_LEVEL_HIGH, 0, "FCIE_MODE_GPIO_PAD_DEFO_SPEED\n");
            REG_FCIE_SETBIT(FCIE_DDR_MODE,BIT_PAD_IN_SEL_SD|BIT_FALL_LATCH);
            break;

        case FCIE_eMMC_SDR:
            eMMC_debug(eMMC_DEBUG_LEVEL_HIGH, 0, "FCIE_MODE_8BITS_MACRO_HIGH_SPEED\n");
        ...
        case FCIE_eMMC_DDR_8BIT_MACRO:
            eMMC_debug(eMMC_DEBUG_LEVEL_HIGH, 0, "FCIE_MODE_8BITS_MACRO_DDR52\n");
        ...
        case FCIE_eMMC_HS200:
            eMMC_debug(eMMC_DEBUG_LEVEL_HIGH, 0, "FCIE_MODE_32BITS_MACRO_HS200\n");
            // fcie
        ...
        case FCIE_eMMC_HS400_DS:
            eMMC_debug(eMMC_DEBUG_LEVEL_HIGH, 0, "FCIE_MODE_32BITS_MACRO_HS400_DS\n");
            // fcie
