#ifndef __eMMC_MUJI_LINUX__
#define __eMMC_MUJI_LINUX__
...
// ----------------------------------------------
#define eMMC_RST_L()                    {REG_FCIE_SETBIT(FCIE_BOOT_CONFIG, BIT1);\
...
#define eMMC_RST_H()                    {REG_FCIE_SETBIT(FCIE_BOOT_CONFIG, BIT1);\
