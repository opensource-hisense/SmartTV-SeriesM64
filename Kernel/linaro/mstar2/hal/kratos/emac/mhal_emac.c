...
void MHal_EMAC_Power_On_Clk( void )
{
    ...
    MHal_EMAC_WritReg8(0x1219, 0xfc, 0x00);		// Power-on LDO
    MHal_EMAC_WritReg8(0x1219, 0xfd, 0x00);
    MHal_EMAC_WritReg8(0x1219, 0xb7, 0x07);		// Power-on ADC
    MHal_EMAC_WritReg8(0x1219, 0xcb, 0x11);		// Power-on BGAP keep on
    MHal_EMAC_WritReg8(0x1219, 0xc4, 0x00);		// TEST[0] TEST[1] for PD_VBUF
    MHal_EMAC_WritReg8(0x1219, 0xcc, 0x80);
    MHal_EMAC_WritReg8(0x1219, 0xcd, 0xd1);		// Power-on ADCPL	
    MHal_EMAC_WritReg8(0x1219, 0xd4, 0x00);		// Power-on LPF_OP
    MHal_EMAC_WritReg8(0x1219, 0xb9, 0x40);
    MHal_EMAC_WritReg8(0x1219, 0xbb, 0x05);		// Power-on REF keep on
    MHal_EMAC_WritReg8(0x1219, 0xea, 0x46);		// on PORST
    MHal_EMAC_WritReg8(0x121a, 0xa1, 0x00);
    MHal_EMAC_WritReg8(0x121a, 0x3a, 0x03);		// on PD_TX_IDAC, PD_TX_LD = 0
...
{
    MHal_EMAC_WritReg8(0x1219, 0x04, 0x31);

    mdelay(100);

    MHal_EMAC_WritReg8(0x1219, 0xd4, 0x20);     // Power-down LPF_OP
    MHal_EMAC_WritReg8(0x121a, 0x3a, 0xF3);     // down PD_TX_IDAC, PD_TX_LD = 0
    MHal_EMAC_WritReg8(0x121a, 0x3b, 0x03);

    MHal_EMAC_WritReg8(0x1219, 0xcd, 0xd9);     // Power-down ADCPL
    MHal_EMAC_WritReg8(0x1219, 0xea, 0x60);     // down PORST

    MHal_EMAC_WritReg8(0x1219, 0xbb, 0x85);     // Power-down REF
    MHal_EMAC_WritReg8(0x1219, 0xcb, 0x13);     // Power-down BGAP
    MHal_EMAC_WritReg8(0x1219, 0xc4, 0x03);     // TEST[0] TEST[1] for PD_VBUF

    MHal_EMAC_WritReg8(0x1219, 0xfc, 0x02);     // Power-down LDO
    MHal_EMAC_WritReg8(0x1219, 0xfd, 0x01);

    MHal_EMAC_WritReg8(0x1219, 0xb7, 0x17);     // Power-down ADC

    MHal_EMAC_WritReg8(0x121a, 0xc5, 0x40);     // 100gat =1
    MHal_EMAC_WritReg8(0x121a, 0x30, 0x53);     // 200gat =1

    MHal_EMAC_WritReg8(0x1219, 0x04, 0x11);
