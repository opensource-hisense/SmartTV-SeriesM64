...
static U32 _HAL_SPINAND_BDMA_READ(U16 u16Addr, U32 u32DataSize, U8 *u8pData)
{
    ...
    BDMA_WRITE(0x10, 0x0000);
    //printk(KERN_ERR"_HAL_SPINAND_BDMA_READ %lx\r\n",u32DataSize);
    ...
    {
        BDMA_WRITE(0x12, 0x3135);
        u32Addr1 -= MIPS_MIU1_BASE;
    }
    else
    {
        BDMA_WRITE(0x12, 0x3035);
        u32Addr1 = virt_to_phys((U32)u8pData);
    }
    ...
    // Set start address
    BDMA_WRITE(0x14, (u16Addr & 0x0000FFFF));
    BDMA_WRITE(0x15, (u16Addr>>16));

    // Set end address
    BDMA_WRITE(0x16, (u32Addr1 & 0x0000FFFF));
    BDMA_WRITE(0x17, (u32Addr1 >> 16));
    // Set Size

    BDMA_WRITE(0x18, (u32DataSize & 0x0000FFFF));
    BDMA_WRITE(0x19, (u32DataSize >> 16));
...
U32 HAL_SPINAND_Init(void)
{
    ...
    CHIP_WRITE(0x50, 0x000);
    CHIP_WRITE(0x1b, 0x100);
    u16Data = CHIP_READ(0x06);
    u16Data &= 0xFFF0;
    CHIP_WRITE(0x06, u16Data);
