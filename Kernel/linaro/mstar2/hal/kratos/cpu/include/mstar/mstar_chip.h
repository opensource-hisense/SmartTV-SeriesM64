#define MSTAR_MIU0_BUS_BASE                      0x00000000  // current version has HW bug, only one miu with 256MB, and mapped to bus_addr 0x00000000 only!!
															 // kratos only one miu with 512MB, bus_addr from 0x40000000 ~ 0x60000000 ==> need to wait ECO
#define MSTAR_MIU1_BUS_BASE                      (~0UL)      // not used, kratos do not have MIU1
#define MSTAR_MIU2_BUS_BASE                      (~0UL)      // not used, kratos do not have MIU2
#define MSTAR_MIU3_BUS_BASE                      (~0UL)      // not used, kratos do not have MIU3
...
#define MS_MIU_INTERVAL                         0x20000000	// this is miu0 max size, used @ MDrv_SYS_GetMIU0Length() (the value means miu1 base_addr)
...
#define PREFTECH_L2_CONTROL_MODE PREFTECH_L2_CONTROL_MODE34DONE
...
#define L2_OP_MODE L2_OP_MODE_FLUSH_ALL_AND_INVALID_CACHE 
