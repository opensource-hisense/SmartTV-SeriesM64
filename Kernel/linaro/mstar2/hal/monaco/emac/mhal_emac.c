...
void MHal_EMAC_Enable_EEE(unsigned int delayms)
{
    u8 uRegVal0;
    u8 uRegVal1;
           
    //detect if link partner surpport EEE 
    uRegVal0 = MHal_EMAC_ReadReg8(0x0034, 0x78);
    uRegVal0 = uRegVal0 & 0x02;
    uRegVal1 = MHal_EMAC_ReadReg8(0x0034, 0x7a);
    uRegVal1 = uRegVal1 & 0x02;

    if((uRegVal0 == 0x02) && (uRegVal1 == 0x02))
    {
        if(delayms > 0)
        {
            mdelay(delayms);
        ...
        MHal_EMAC_WritReg8(0x1021, 0x42, 0x0b);
        MHal_EMAC_WritReg8(0x1021, 0x43, 0xfd);
    }
    else
    {
        MHal_EMAC_WritReg8(0x1021, 0x42, 0x0a);
        MHal_EMAC_WritReg8(0x1021, 0x43, 0xfd);
    }
}

void MHal_EMAC_Disable_EEE( void )
{
...
void MHal_EMAC_Disable_EEE_TX( void )
{
    MHal_EMAC_Disable_EEE();
}

void MHal_EMAC_Reset_EEE( void )
{
    u8 uRegVal0;

    uRegVal0 = MHal_EMAC_ReadReg8(0x0034, 0xec);
    uRegVal0 = uRegVal0 | 0x01;
    MHal_EMAC_WritReg8(0x0034, 0xec, uRegVal0);
    
    mdelay(1);
    
    uRegVal0 = uRegVal0 & 0xfe;
    MHal_EMAC_WritReg8(0x0034, 0xec, uRegVal0);
}
...
void MHal_EMAC_trim_phy( void )
{
    ...
    uRegVal = MHal_EMAC_ReadReg8(0x0034, 0x60);
    uRegVal &= 0x7f;
    uRegVal |= (uEfuVal1 & 0x40) << 1;
    MHal_EMAC_WritReg8(0x0034, 0x60, uRegVal);

    uRegVal = MHal_EMAC_ReadReg8(0x0034, 0x61);
    uRegVal |= (uEfuVal1 >> 7);
    uRegVal |= (uEfuVal2 & 0x7f) << 1 ;
...
void MHal_EMAC_Power_On_Clk( void )
{
    ...
    //Chip revision ID
    u8Revision = MHal_EMAC_ReadReg8(0x001e, 0x03);
    ...
    MHal_EMAC_WritReg8(0x0034, 0xa1, 0x80);
    MHal_EMAC_WritReg8(0x0033, 0xcc, 0x40);
    MHal_EMAC_WritReg8(0x0033, 0xbb, 0x04);
    MHal_EMAC_WritReg8(0x0034, 0x8f, 0x0a);
    MHal_EMAC_WritReg8(0x0034, 0xd5, 0x08);
    MHal_EMAC_WritReg8(0x0034, 0xd9, 0x08);
    MHal_EMAC_WritReg8(0x0034, 0xf7, 0x0a);
    MHal_EMAC_WritReg8(0x0034, 0xfb, 0x0a);
    MHal_EMAC_WritReg8(0x0034, 0xfd, 0x0a);
    MHal_EMAC_WritReg8(0x0034, 0x3a, 0x00);
    MHal_EMAC_WritReg8(0x0034, 0xf1, 0x00);
    ...
    //en_100t_phase
    if(u8Revision > 0) //More than U01
    {
        MHal_EMAC_WritReg8(0x0034, 0x39, 0x41);
    }
    else 
    {
        MHal_EMAC_WritReg8(0x0034, 0x39, 0x01);
    }
    ...
    MHal_EMAC_WritReg8(0x0032, 0xac, 0x19);
    MHal_EMAC_WritReg8(0x0032, 0xad, 0x19);
    MHal_EMAC_WritReg8(0x0032, 0xae, 0x19);
    ...
    //enable EEE
    MHal_EMAC_WritReg8(0x0032, 0x2d, 0x3c);

    //RX
    //MHal_EMAC_WritReg8(0x0033, 0x34, 0x33);
    MHal_EMAC_WritReg8(0x0033, 0x34, 0x73);
    MHal_EMAC_WritReg8(0x0033, 0x35, 0x05);
    MHal_EMAC_WritReg8(0x0033, 0x37, 0xef);
    MHal_EMAC_WritReg8(0x0034, 0x50, 0xff);
    MHal_EMAC_WritReg8(0x0034, 0x51, 0xff);
    MHal_EMAC_WritReg8(0x0034, 0x4c, 0x04);
    MHal_EMAC_WritReg8(0x0034, 0x4d, 0xff);
    MHal_EMAC_WritReg8(0x0034, 0x52, 0x01);
    MHal_EMAC_WritReg8(0x0034, 0x53, 0x00);
    MHal_EMAC_WritReg8(0x0033, 0x48, 0x32);
    MHal_EMAC_WritReg8(0x0033, 0x49, 0x00);
    
    //TX
    MHal_EMAC_WritReg8(0x0034, 0xc6, 0x82);
    MHal_EMAC_WritReg8(0x0034, 0xc7, 0x14);
    MHal_EMAC_WritReg8(0x0034, 0xc2, 0xc8);
    MHal_EMAC_WritReg8(0x0034, 0xc3, 0x02);
    MHal_EMAC_WritReg8(0x0034, 0xc4, 0x08);

    //TX power saving
    MHal_EMAC_WritReg8(0x0034, 0x54, 0x01);
    MHal_EMAC_WritReg8(0x0034, 0x57, 0x80);
#endif
    ...
    //Enable PHY LED
    uRegVal = MHal_EMAC_ReadReg8(0x101e, 0xb4);
    uRegVal |= 0x10;
    MHal_EMAC_WritReg8(0x101e, 0xb4, uRegVal);
