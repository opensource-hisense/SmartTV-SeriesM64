...
#define INTERNEL_PHY_REG_BASE               0xFD006400
...
#define REG_ADDR_BASE                       0xFD204000      // The register address base. Depends on system define.
#define RBQP_LENG                           0x80//0x0100  0x40//                // ==?descriptors
...
#define MAX_INT_COUNTER                     100
    ...
    #define JULIAN_100_VAL                      (0x0000F051)
#else
    #define JULIAN_100_VAL                      (0x0000F057)
#endif
