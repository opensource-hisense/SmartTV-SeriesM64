#ifndef __eMMC_MONACO_LINUX__
#define __eMMC_MONACO_LINUX__
...
#define reg_pad_emmc_rst_io                GET_REG_ADDR(GPIO_MODE_BASE, 0x3f)
#define BIT_PAD_EMMC_RST_OUTPUT            BIT8
#define BIT_PAD_EMMC_RST_OEN               BIT9
