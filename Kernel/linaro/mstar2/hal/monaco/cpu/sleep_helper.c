...
void save_a12_generic_timer(appf_u32 *pointer)
{
    __asm__ volatile (
            "ldr r1, %0\n"
            "mrc p15, 0, r2, c14, c0, 0\n"
            "str r2, [r1],#4\n"
            "mrc p15, 0, r2, c14, c2, 0\n"
            "str r2, [r1],#4\n"
            "mrrc p15, 2, r2, r3, c14\n"
            "str r2, [r1],#4\n"
            "str r3, [r1],#4\n"
            "mrc p15, 0, r2, c14, c2, 1\n"
            "str r2, [r1],#4\n"
            ::"m"(pointer):"r1","r2","r3");
}
void restore_a12_generic_timer(appf_u32 *pointer)
{
    __asm__ volatile (
            "ldr r1, %0\n"
            "ldr r2, [r1],#4\n"
            ...
            "ldr r2, [r1],#4\n"
            "ldr r3, [r1],#4\n"
            "mcrr p15, 2, r2, r3, c14\n"
            "ldr r2, [r1],#4\n"
            "mcr p15, 0, r2, c14, c2, 1\n"
            ::"m"(pointer):"r1","r2","r3");
}
void save_a12_scu(appf_u32 *pointer)
{
    __asm__ volatile (
            "mrc p15, 1, r1, c9, c0, 4\n"
            "str r1, %0\n"
            :"=m"(pointer[0])::"r1");
}
void restore_a12_scu(appf_u32 *pointer)
{
    __asm__ volatile (
            "ldr r1, %0\n"
            "mcr p15, 1, r1, c9, c0, 4\n"
            ::"m"(pointer[0]):"r1");
}
