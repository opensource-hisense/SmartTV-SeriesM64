...
INTERFACE MS_BOOL MHal_GFLIP_SetTLBFlipToGop(MS_U32 u32GopIdx, MS_U32 u32GwinIdx, MS_U32 u32MainAddr, MS_U32 u32SubAddr, MS_BOOL bForceWriteIn);
...
INTERFACE void MDrv_HDR_Main(void);
...
INTERFACE void msHDRFixDlcWriteCurve(BOOL bWindow);
