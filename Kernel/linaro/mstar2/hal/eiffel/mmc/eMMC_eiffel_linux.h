#ifndef __eMMC_EIFFEL_LINUX__
#define __eMMC_EIFFEL_LINUX__
...
#define eMMC_FCIE_VALID_CLK_CNT         4
...
#define reg_nand_pe                     GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x0D)
...
#define CFG_NAND_PAD_MASK               (BIT6|BIT7|BIT8)
...
#define FCIE_SLOW_CLK                   BIT_FCIE_CLK_27M
