#ifndef __UNFD_KAYLA_LINUX_H__
#define __UNFD_KAYLA_LINUX_H__
...
// overwrite definition in mdrv_nand.c
//#define DMA_MODE                            0
...
#define reg_ci_a_ps            				GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x2a)
#define reg_ci_c_pe            				GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x25)
#define reg_ci_c_ps            				GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x2b)
#define reg_ci_d_pe            				GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x26)
#define reg_ci_d_ps            				GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x2c)
#define reg_gpio_pe            				GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x27)
#define reg_gpio_ps            				GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x26)

#define reg_sd_mode							GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x08)
#define reg_emmc_mode						GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x08)
#define reg_emmc_swrst						GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x36)
