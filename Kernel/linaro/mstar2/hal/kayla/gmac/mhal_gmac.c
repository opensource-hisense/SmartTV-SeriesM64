...
void MHal_GMAC_Power_On_Clk( void )
{
    ...
    /* Set gmac ahb clock to 144MHZ */
    MHal_GMAC_WritReg8(0x1033, 0x64, 0x0c);
    ...
    MHal_GMAC_WritReg8(0x0032, 0x77,  0x10);     // snr len (emc noise)
    ...
    MHal_GMAC_WritReg8(0x0031, 0xaa,  0x1c);
    MHal_GMAC_WritReg8(0x0031, 0xab,  0x28);     //

    //10T LTP width
    MHal_GMAC_WritReg8(0x0031, 0xb4, 0x5a);
    MHal_GMAC_WritReg8(0x0031, 0xb6, 0x50);
    MHal_GMAC_WritReg8(0x0031, 0xff, 0x1a);

    //Disable eee
    MHal_GMAC_WritReg8(0x0031, 0x2d, 0x7c);

    //Set to 16x128 mode
    uRegVal = MHal_GMAC_ReadReg8(0x121c, 0x1b);
    uRegVal |= 0x60;
    MHal_GMAC_WritReg8(0x121c, 0x1b, uRegVal);
#else
#endif    
