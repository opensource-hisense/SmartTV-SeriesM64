...
typedef enum
{
    ...
    E_FIQ_DMDCU2HK_INT                  = E_FIQH_START + 4,
    ...
    E_IRQEXPL_UHC2P2                    = E_IRQEXPL_START + 5,
    E_IRQEXPL_AEON                      = E_IRQEXPL_START + 6,
    ...
    E_IRQEXPL_PM_IRQ                    = E_IRQEXPL_START + 14,
    ...
    E_FIQ_TEMPERATURE_RISE              = E_FIQEXPL_START + 0,
    ...
    E_FIQ_CA9_SCUEVABORT                = E_FIQEXPL_START + 9,
    E_FIQEXPL_ARM_TO_8051               = E_FIQEXPL_START + 10,
    E_FIQEXPL_EXT_GPIO1                 = E_FIQEXPL_START + 11,
    E_FIQEXPL_ARM_C1_TO_SECU            = E_FIQEXPL_START + 12,
	...
	E_FIQEXPH_GPIOINIT7                 = E_FIQEXPH_START + 15,
...
#define IRQ_DISP                        (0x01 << (IRQ_DISP                - E_IRQL_START))
...
#define IRQ_SMART                       (0x01 << (IRQ_SMART                 - E_IRQH_START))
...
#define IRQEXPL_ERROR                   (0x01 << (E_IRQEXPL_MSPI0           - E_IRQEXPL_START))
#define IRQEXPL_USB2P2                  (0x01 << (E_IRQEXPL_ERROR           - E_IRQEXPL_START))
#define IRQEXPL_UHC2P2                  (0x01 << (E_IRQEXPL_TSO             - E_IRQEXPL_START))
#define IRQEXPL_AEON                    (0x01 << (E_IRQEXPL_EXT_GPIO2       - E_IRQEXPL_START))
#define IRQEXPL_UART1                   (0x01 << (E_IRQEXPL_AEON2HI         - E_IRQEXPL_START))
#define IRQEXPL_UART2                   (0x01 << (E_IRQEXPL_UART1           - E_IRQEXPL_START))
#define IRQEXPL_MSPI1                   (0x01 << (E_IRQEXPL_PM_IRQ_OUT      - E_IRQEXPL_START))
#define IRQEXPL_MIU_SECURITY            (0x01 << (E_IRQEXPL_EXT_GPIO3       - E_IRQEXPL_START))
#define IRQEXPL_DIPW                    (0x01 << (E_IRQEXPL_DIPW            - E_IRQEXPL_START))
#define IRQEXPL_MIIC2                   (0x01 << (E_IRQEXPL_EXT_GPIO4       - E_IRQEXPL_START))
#define IRQEXPL_JPD                     (0x01 << (E_IRQEXPL_MIU_SECURITY    - E_IRQEXPL_START))
#define IRQEXPL_PM_IRQ                  (0x01 << (E_IRQEXPL_JPD             - E_IRQEXPL_START))
#define IRQEXPL_MFE                     (0x01 << (E_IRQEXPL_MSPI1           - E_IRQEXPL_START))
...
#define IRQEXPH_UART2MCU             (0x01 << (IRQEXPH_UART2MCU             - E_IRQEXPH_START))
...
#define IRQHYPH_D2B                     (0x01 << (E_IRQHYPH_D2B              - E_IRQHYPH_START))
#define IRQHYPH_AUDMA                   (0x01 << (E_IRQHYPH_AUDMA            - E_IRQHYPH_START))
...
#define IRQHYPH_SDIO_OSP                (0x01 << (E_IRQHYPH_SDIO_OSP         - E_IRQHYPH_START))
