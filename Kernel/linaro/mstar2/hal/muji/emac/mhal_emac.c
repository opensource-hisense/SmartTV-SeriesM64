...
void MHal_EMAC_Power_On_Clk( void )
{
	...
	MHal_EMAC_WritReg8(0x0033, 0x37, 0xff);
...
void MHal_EMAC_Enable_EEE(unsigned int delayms)
{
    ...
    uRegVal  = MHal_EMAC_ReadReg8(0x0034, 0x7a);
	uRegVal2 = MHal_EMAC_ReadReg8(0x0034, 0x78);

    if((uRegVal & 0x02) && (uRegVal2 & 0x02))
    {
        if(delayms > 0)
        {
            mdelay(delayms);
...
void MHal_EMAC_Reset_EEE( void )
{
	...
	uRegVal = MHal_EMAC_ReadReg8(0x32, 0x01);
    uRegVal |= 0x04;
    MHal_EMAC_WritReg8(0x32, 0x01, uRegVal);
	
    MHal_EMAC_WritReg8(0x32, 0xcb, 0x90);
	...
	MHal_EMAC_WritReg8(0x32, 0xcb, 0x10);
}
