...
void MHal_EMAC_Power_On_Clk( void )
{
    ...
    if (*(volatile unsigned int *)(0xFD203D9C) == 0x0100) // current mode, for K3
    {
    ...
    else // voltage mode, for all other K3S series
    {
        //Trime Value
        //100T:         4d00173D74 [6:2]
        ...
        //Disable LDPS mode
        *(volatile unsigned int *)(0xFD0063D4) = 0x6900;
    ...
    ///    *(volatile unsigned int *)(0xFD006560) = 0x6002; // Power-on TX
        ...
        *(volatile unsigned int *)(0xFD006480) = ((*(volatile unsigned int *)(0xFD006480) & 0xFF00) | 0x00d0); // Fix LDPS mode 
    ...
    ///    *(volatile unsigned int *)(0xFD0062E4) = (*(volatile unsigned int *)(0xFD0062E4) & 0xFFF7); //unset loop_back_enable
        ...
        *(volatile unsigned int *)(0xFD006584) = 0x0020; // 100T TX performance (TEST)
        ...
        //Enable LDPS mode
        *(volatile unsigned int *)(0xFD0063D4) = 0xe900;
