...
void MHal_GMAC_trim_phy( void )
{
    ...
    //efuse read
    uEfuVal0 = *( ( volatile u8* )0xBF323C88 );
    uEfuVal1 = *( ( volatile u8* )0xBF323C89 );
    uEfuVal2 = *( ( volatile u8* )0xBF323C8a );
...
void MHal_GMAC_Power_On_Clk( void )
{
    ...
    MHal_GMAC_WritReg8(0x121f, 0x23, 0x08);

    /* Enable gmac rx clock */
    MHal_GMAC_WritReg8(0x121f, 0x24, 0x08);
    MHal_GMAC_WritReg8(0x121f, 0x25, 0x00);

    /* Init ePHY */
    uRegVal = MHal_GMAC_ReadReg8(0x000e, 0x60);
    uRegVal &= 0xfe;
    MHal_GMAC_WritReg8(0x000e, 0x60, uRegVal);

    MHal_GMAC_WritReg8(0x0032, 0x4F,  0x02);     // det max
    MHal_GMAC_WritReg8(0x0032, 0x51,  0x01);     // det min
    MHal_GMAC_WritReg8(0x0032, 0x77,  0x18);     // snr len (emc noise)

    MHal_GMAC_WritReg8(0x0031, 0x72,  0x80);     // lpbk_enable set to 0

    MHal_GMAC_WritReg8(0x0032, 0xfc,  0x00);     // Power-on LDO
    MHal_GMAC_WritReg8(0x0032, 0xfd,  0x00);     // Power-on LDO
    MHal_GMAC_WritReg8(0x0032, 0xb7,  0x07);     // Power-on ADC
    MHal_GMAC_WritReg8(0x0032, 0xc4,  0x00);     // TEST[0] TEST[1] for PD_VBUF
    MHal_GMAC_WritReg8(0x0032, 0xcb,  0x11);     // Power-on BGAP
    MHal_GMAC_WritReg8(0x0032, 0xcc,  0x80);     // Power-on ADCPL
    MHal_GMAC_WritReg8(0x0032, 0xcd,  0xd1);     // Power-on ADCPL
    MHal_GMAC_WritReg8(0x0032, 0xd4,  0x00);     // Power-on LPF_OP
    MHal_GMAC_WritReg8(0x0032, 0xb9,  0x40);     // Power-on LPF
    MHal_GMAC_WritReg8(0x0032, 0xbb,  0x05);     // Power-on REF
    MHal_GMAC_WritReg8(0x0032, 0xea,  0x46);     // PORST
    MHal_GMAC_WritReg8(0x0033, 0xa1,  0x00);     // VBUF
    MHal_GMAC_WritReg8(0x0033, 0x3a,  0x03);     // PD_TX_IDAC, PD_TX_LD = 0
    MHal_GMAC_WritReg8(0x0033, 0x3b,  0x00);     // PD_TX_IDAC, PD_TX_LD = 0

    MHal_GMAC_WritReg8(0x0033, 0xc5,  0x00);     // 100gat
    MHal_GMAC_WritReg8(0x0033, 0x30,  0x43);     // 200gat

    MHal_GMAC_WritReg8(0x0033, 0x39,  0x41);     // [0] en_100t_phase; [6] save2x_tx

    MHal_GMAC_WritReg8(0x0033, 0xe8,  0x06);     // shadow
    MHal_GMAC_WritReg8(0x0031, 0x2b,  0x00);     // LUT tail
    MHal_GMAC_WritReg8(0x0033, 0xe8,  0x00);     // shadow
    MHal_GMAC_WritReg8(0x0031, 0x2b,  0x00);     // LUT tail

    MHal_GMAC_WritReg8(0x0033, 0xe8,  0x06);     // shadow
    MHal_GMAC_WritReg8(0x0031, 0xaa,  0x1c);     // tin17_s2
    MHal_GMAC_WritReg8(0x0031, 0xac,  0x1c);     // tin18_s2
    MHal_GMAC_WritReg8(0x0031, 0xad,  0x1c);     // tin18_s2
    MHal_GMAC_WritReg8(0x0031, 0xae,  0x1c);     // tin19_s2
    MHal_GMAC_WritReg8(0x0031, 0xaf,  0x1c);     // tin19_s2

    MHal_GMAC_WritReg8(0x0033, 0xe8,  0x00);     // shadow (back)
    ...
    MHal_GMAC_WritReg8(0x0033, 0xb4, 0x1c);
    MHal_GMAC_WritReg8(0x0033, 0xb0, 0xaf);

    /* enable RX delay */
    MHal_GMAC_WritReg8(0x0033, 0xbb, 0x0f);
    ...
    MHal_GMAC_WritReg8(0x110c, 0xc8, 0x08);
    MHal_GMAC_WritReg8(0x110c, 0xc9, 0x80);
    MHal_GMAC_WritReg8(0x110c, 0xca, 0x83);
    MHal_GMAC_WritReg8(0x110c, 0xcb, 0x06);
    MHal_GMAC_WritReg8(0x110c, 0xd0, 0x6a);
    MHal_GMAC_WritReg8(0x110c, 0xd1, 0xbc);
    MHal_GMAC_WritReg8(0x110c, 0xd2, 0x14);
    MHal_GMAC_WritReg8(0x110c, 0xd3, 0x00);
    MHal_GMAC_WritReg8(0x110c, 0xc0, 0x19);
    MHal_GMAC_WritReg8(0x110c, 0xc1, 0x00);
    MHal_GMAC_WritReg8(0x110c, 0xc2, 0x00);
    MHal_GMAC_WritReg8(0x110c, 0xc3, 0xaf);
    MHal_GMAC_WritReg8(0x110c, 0xc4, 0x0a);
    MHal_GMAC_WritReg8(0x110c, 0xc5, 0x00);
    MHal_GMAC_WritReg8(0x110c, 0xc6, 0x07);
    MHal_GMAC_WritReg8(0x110c, 0xc7, 0x00);
...
{
    MHal_GMAC_WritReg8(0x0032, 0x04, 0x31);    // Rest analog
    mdelay(100);
    MHal_GMAC_WritReg8(0x0032, 0xb7, 0x17);    // Power-down ADC
    MHal_GMAC_WritReg8(0x0032, 0xd4, 0x20);    // Power-down LPF_OP
    MHal_GMAC_WritReg8(0x0033, 0x3a, 0xf3);    // down PD_TX_IDAC, PD_TX_LD = 0
    MHal_GMAC_WritReg8(0x0033, 0x3b, 0x03);    // down PD_TX_IDAC, PD_TX_LD = 0
    MHal_GMAC_WritReg8(0x0032, 0xcd, 0xd9);    // Power-down ADCPL
    MHal_GMAC_WritReg8(0x0032, 0xea, 0x60);    // down PORST
    MHal_GMAC_WritReg8(0x0032, 0xbb, 0x85);    // Power-down REF
    MHal_GMAC_WritReg8(0x0032, 0xcb, 0x13);    // Power-down BGAP
    MHal_GMAC_WritReg8(0x0032, 0xc4, 0x03);    // TEST[0] TEST[1] for PD_VBUF
    MHal_GMAC_WritReg8(0x0032, 0xfc, 0x02);    // Power-down LDO
    MHal_GMAC_WritReg8(0x0032, 0xfd, 0x01);    // Power-down LDO
    MHal_GMAC_WritReg8(0x0033, 0xc5, 0x40);    // 100gat =1
    MHal_GMAC_WritReg8(0x0033, 0x30, 0x53);    // 200gat =1
    MHal_GMAC_WritReg8(0x0032, 0x04, 0x11);    // Release Rest analog
}
