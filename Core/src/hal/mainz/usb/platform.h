...
#if (ENABLE_MONACO) || (ENABLE_MIAMI) || (ENABLE_MUJI) || (ENABLE_CELTICS) || \
	(ENABLE_MONET) || (ENABLE_MUNICH) || (ENABLE_MANHATTAN) || (ENABLE_MESSI) || \
    (ENABLE_MASERATI) || (ENABLE_MACAN) || (ENABLE_MAINZ)
