...
#include "../../../sboot/inc/macan/board/Board.h"
...
#define CONFIG_GIC_PATCH 0

#define CONFIG_MBOOT 1

/* Get CPU defs */
#include <asm/arch/cpu.h>
#define CONFIG_TV_CHIP     1
...
#define CONFIG_SYS_MIU2_BUS 0xFFFFFFFF
...
#else
#define CONFIG_SYS_MALLOC_LEN		(CONFIG_ENV_SIZE + (1 << 23)) // 256K + 4M
#endif
...
#define CONFIG_SYS_PROMPT           "<< MStar >># "
