...
U32 eMMC_pads_switch(U32 u32Mode)
{
    ...
    REG_FCIE_CLRBIT(reg_emmcpll_0x1d, BIT8|BIT9);                // reg_use_dll_skew4 |reg_cmd_use_skew4
    ...
    REG_FCIE_CLRBIT(reg_emmcpll_0x7f, BIT1|BIT2|BIT3);
    ...
    switch(u32Mode)
    {
        case FCIE_MODE_GPIO_PAD_DEFO_SPEED:
            ...
            REG_FCIE_SETBIT(reg_emmcpll_0x1a, BIT10);               // c2 enable of emmc io 10
            break;
        ...
        case FCIE_eMMC_HS200:
			...
			REG_FCIE_SETBIT(reg_emmcpll_0x1a, BIT4|BIT5);
