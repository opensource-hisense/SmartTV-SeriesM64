...
#define USBHOST_LIB_VER	"2016.04.07"
...
#if (ENABLE_MACAN) || (ENABLE_KASTOR) || (ENABLE_MAXIM)
	// for 28 nm
...
#elif (ENABLE_MANHATTAN) || (ENABLE_MAXIM)
...
#elif (ENABLE_MANHATTAN) || (ENABLE_MACAN) || (ENABLE_MAXIM)
...
#elif (ENABLE_MONACO) || (ENABLE_MIAMI) || (ENABLE_MUJI) || (ENABLE_CELTICS) ||\
	(ENABLE_MANHATTAN) || (ENABLE_KANO) || (ENABLE_MASERATI) || (ENABLE_MAXIM)
