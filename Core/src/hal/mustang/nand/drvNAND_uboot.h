...
//******************************************************************************
//<MStar Software>
#ifndef __UNFD_MASERATI_UBOOT_H__
#define __UNFD_MASERATI_UBOOT_H__
...
#define DQS_MODE_SEARCH_TABLE	{DQS_MODE_0P0T, DQS_MODE_0P5T, DQS_MODE_1P0T, DQS_MODE_1P5T, DQS_MODE_2P0T}
...
#define NAND_MODE3                          (BIT8|BIT7) // EMMC
#define NAND_MODE4                          (BIT9) // EMMC_DQS

#define reg_pcm_d_pe                        GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x0B)
#define reg_pcm_a_pe                        GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x0C)
#define reg_nand_pe_0_15                    GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x7A)
#define reg_nand_pe_16_17                   GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x7B)
#define reg_nand_ps_0_15                    GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x7C)
#define reg_nand_ps_16_17                   GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x7D)
...
#define BIT_DQS_MODE_1_0T                   (2 << BIT_DQS_MDOE_SHIFT)
...
//@FIXME
#define REG_NAND_DQS_UL                     GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x7c)
#define BIT_DQS_PULL_H                      BIT3
...
#define reg_ckg_mpll                        GET_REG_ADDR(CLKGEN2_BASE, 0x3C)
#define BIT_CLKGEN2_CLK_SEL_MASK            (BIT1|BIT0)
#define BIT_CLKGEN2_CLK_SEL                 BIT1
...
#endif //__UNFD_MASERATI_UBOOT_H__
