...
U32 nand_pads_switch(U32 u32EnableFCIE)
{
    ...
    if(u16_NandMode == NAND_MODE1)
    {
        REG_SET_BITS_UINT16(reg_pcm_d_pe, 0xFF);
    }
    else if(u16_NandMode == NAND_MODE2)
    {
...
U32 nand_clock_setting(U32 u32ClkParam)
{
    ...
    {
        REG_CLR_BITS_UINT16(reg_ckg_mpll, BIT_CLKGEN2_CLK_SEL_MASK);
        REG_SET_BITS_UINT16(reg_ckg_mpll, BIT_CLKGEN2_CLK_SEL);
...
void nand_DumpPadClk(void)
{
    ...
    nand_debug(0, 1, "  reg_nand_pe_0_15(0x%08X): 0x%04X\n", reg_nand_pe_0_15, REG(reg_nand_pe_0_15));
    nand_debug(0, 1, "  reg_nand_pe_16_17(0x%08X): 0x%04X\n", reg_nand_pe_16_17, REG(reg_nand_pe_16_17));
    nand_debug(0, 1, "  reg_nand_ps_0_15(0x%08X): 0x%04X\n", reg_nand_ps_0_15, REG(reg_nand_ps_0_15));
    nand_debug(0, 1, "  reg_nand_ps_16_17(0x%08X): 0x%04X\n", reg_nand_ps_16_17, REG(reg_nand_ps_16_17));
