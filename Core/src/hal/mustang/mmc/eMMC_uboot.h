...
//******************************************************************************
//<MStar Software>
#ifndef __eMMC_MUSTANG_UBOOT__
#define __eMMC_MUSTANG_UBOOT__
...
//--------------------------------RVD------------------------------------
#define REG_BANK_RVD                0x0500	// (0x100A - 0x1000) x 80h
#define RVD_BASE                    GET_REG_ADDR(RIU_BASE, REG_BANK_RVD)
#define reg_rvd_0x0C                    GET_REG_ADDR(RVD_BASE, 0x0C)
...
#define reg_nand_pad_driving            GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x07)
...
#define BIT_NAND_MODE                   (BIT7|BIT8|BIT9)

#define reg_chiptop_0x57				GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x57)
#define BIT_SD_CONFIG                   (BIT11|BIT10|BIT9|BIT8)

#define reg_stat_bond_sw                GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x60)
#define BIT_BOND_BGA                    BIT8
...
#define BIT_EMMC_CONFIG_EMMC_MODE_2		BIT8
#define BIT_SD_CONFIG_ECO				BIT9

#define reg_chiptop_0x7A				GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x7A)
#define reg_chiptop_0x7B				GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x7B)
#define reg_chiptop_0x7C				GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x7C)
#define reg_chiptop_0x7D				GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x7D)

//--------------------------------gpio--------------------------------------
#define REG_BANK_GPIO                   (0x1580)
#define GPIO_BASE                           GET_REG_ADDR(RIU_BASE, REG_BANK_GPIO)
#define REG_GPIO_0x3F                   GET_REG_ADDR(GPIO_BASE, 0x3F)
...
//---------------------------------GPIO----------------------------------------
#define REG_BANK_1210               (0x1210-0x1000)*0x80	// (0x120b - 0x1000) x 80h
#define REG_BANK_1210_BASE          GET_REG_ADDR(RIU_BASE, REG_BANK_1210)
#define REG_1210_0x07               GET_REG_ADDR(REG_BANK_1210_BASE, 0x07)
#define REG_1210_0x08               GET_REG_ADDR(REG_BANK_1210_BASE, 0x08)
...
#define eMMC_RST_L()                    do{	\
                                         if((REG_FCIE(reg_stat_bond_sw)& BIT_BOND_BGA)== BIT_BOND_BGA) {\
                                         ...
                                         REG_FCIE_CLRBIT(reg_emmcpll_0x70, BIT1|BIT0);} while(0)
#define eMMC_RST_H()                    do{ \
                                         if((REG_FCIE(reg_stat_bond_sw)& BIT_BOND_BGA)== BIT_BOND_BGA) {\
                                             REG_FCIE_SETBIT(reg_chiptop_0x4F, BIT_reg_emmc_rstz_en);\
...
extern U32 eMMC_FCIE_DetectHS200Timing_TrigerLevel_SKEW4(U8 u8_enable_error_log);
#endif /* __eMMC_MASERATI_UBOOT__ */
