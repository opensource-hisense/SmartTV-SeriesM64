...
void MHal_EMAC_PadMux(void)
{
    ...
    /* chiptop pad_top [9:8]*/
    uRegVal = MHal_EMAC_ReadReg8(0x101e, 0xf8);
    uRegVal &= 0x01;
    MHal_EMAC_WritReg8(0x101e, 0xf8, uRegVal);
#endif
}
...
void MHal_EMAC_Ewavetest_10M_LTP(void)
{
    ...
    uRegVal = MHal_EMAC_ReadReg8(0x0031, 0x73);
    uRegVal &= ~(0x08);
    uRegVal |= 0x00;
    MHal_EMAC_WritReg8(0x0031, 0x73, uRegVal);

    uRegVal = MHal_EMAC_ReadReg8(0x0031, 0x87);
    uRegVal &= ~(0x04);
    uRegVal |= 0x00;
    MHal_EMAC_WritReg8(0x0031, 0x87, uRegVal);

    uRegVal = MHal_EMAC_ReadReg8(0x0031, 0x2d);
    uRegVal &= ~(0x38);
    uRegVal |= 0x00;
    MHal_EMAC_WritReg8(0x0031, 0x2d, uRegVal);

    uRegVal = MHal_EMAC_ReadReg8(0x0031, 0xeb);
    uRegVal &= ~(0x80);
    uRegVal |= 0x00;
    MHal_EMAC_WritReg8(0x0031, 0xeb, uRegVal);

	uRegVal = MHal_EMAC_ReadReg8(0x0031, 0x01);
    uRegVal &= ~(0x80);
    uRegVal |= 0x00;
    MHal_EMAC_WritReg8(0x0031, 0x01, uRegVal);
...
void MHal_EMAC_Ewavetest_10M_ALLONE(void)
{
    ...
    uRegVal = MHal_EMAC_ReadReg8(0x0032, 0x3f);
    uRegVal &= ~(0x40);
    uRegVal |= 0x00;
    MHal_EMAC_WritReg8(0x0032, 0x3f, uRegVal);
    ...
    uRegVal = MHal_EMAC_ReadReg8(0x0031, 0x80);
    uRegVal &= ~(0xff);
    uRegVal |= 0xff;
    MHal_EMAC_WritReg8(0x0031, 0x80, uRegVal);

    uRegVal = MHal_EMAC_ReadReg8(0x0031, 0x7e);
    uRegVal &= ~(0xff);
    uRegVal |= 0xff;
    MHal_EMAC_WritReg8(0x0031, 0x7e, uRegVal);
    
	uRegVal = MHal_EMAC_ReadReg8(0x0031, 0x7f);
    uRegVal &= ~(0xff);
    uRegVal |= 0x1f;
    MHal_EMAC_WritReg8(0x0031, 0x7f, uRegVal);
    
	uRegVal = MHal_EMAC_ReadReg8(0x0031, 0x7a);
    uRegVal &= ~(0xff);
    uRegVal |= 0xff;
    MHal_EMAC_WritReg8(0x0031, 0x7a, uRegVal);
    
	uRegVal = MHal_EMAC_ReadReg8(0x0031, 0x7b);
    uRegVal &= ~(0xff);
    uRegVal |= 0xff;
    MHal_EMAC_WritReg8(0x0031, 0x7b, uRegVal);
    
	uRegVal = MHal_EMAC_ReadReg8(0x0031, 0x7c);
    uRegVal &= ~(0xff);
    uRegVal |= 0xff;
    MHal_EMAC_WritReg8(0x0031, 0x7c, uRegVal);
    
	uRegVal = MHal_EMAC_ReadReg8(0x0031, 0x7d);
    uRegVal &= ~(0xff);
    uRegVal |= 0xff;
    MHal_EMAC_WritReg8(0x0031, 0x7d, uRegVal);
...
void MHal_EMAC_PHY_reset(void)
{
    /* LAN off */
    printf("PHY off\n");
    MHal_EMAC_WritReg8(0x0032, 0xb7,  0x17);     // Power-on ADC            
    MHal_EMAC_WritReg8(0x0032, 0xd4,  0x20);     // Power-on LPF_OP         
    MHal_EMAC_WritReg8(0x0033, 0x3a,  0x03);     // PD_TX_IDAC, PD_TX_LD = 0
    MHal_EMAC_WritReg8(0x0033, 0x3b,  0xf3);     // PD_TX_IDAC, PD_TX_LD = 0            
    MHal_EMAC_WritReg8(0x0032, 0xcd,  0xd9);     // Power-on ADCPL          
    MHal_EMAC_WritReg8(0x0032, 0xea,  0x60);     // PORST           
    MHal_EMAC_WritReg8(0x0032, 0xbb,  0x85);     // Power-on REF
    MHal_EMAC_WritReg8(0x0032, 0xcb,  0x13);     // Power-on BGAP           
    MHal_EMAC_WritReg8(0x0032, 0xc4,  0x03);     // TES[0] TEST[1] for PD_VBUF        
    MHal_EMAC_WritReg8(0x0032, 0xfc,  0x02);     // Power-on LDO    
    MHal_EMAC_WritReg8(0x0032, 0xfd,  0x01);     // Power-on LDO    
    MHal_EMAC_WritReg8(0x0033, 0xc5,  0x40);     // 100gat
    MHal_EMAC_WritReg8(0x0033, 0x30,  0x53);     // 200gat
    mdelay(200);
    ...
    MHal_EMAC_WritReg8(0x0032, 0xbb,  0x05);     // Power-on REF
    MHal_EMAC_WritReg8(0x0032, 0xcb,  0x11);     // Power-on BGAP           
    MHal_EMAC_WritReg8(0x0032, 0xc4,  0x00);     // TES[0] TEST[1] for PD_VBUF        
    MHal_EMAC_WritReg8(0x0032, 0xfc,  0x00);     // Power-on LDO    
    MHal_EMAC_WritReg8(0x0032, 0xfd,  0x00);     // Power-on LDO    
    MHal_EMAC_WritReg8(0x0033, 0xc5,  0x00);     // 100gat
    MHal_EMAC_WritReg8(0x0033, 0x30,  0x43);     // 200gat
