...
#if 0	/* old chip may not support last done Z ECO */
...
#if (ENABLE_MACAN) || (ENABLE_KASTOR) || (ENABLE_MUSTANG)
	// for 28 nm
...
#define MSTAR_UHC_BASE   (HW_BASE+(0x2400 << 1))
	...
	(ENABLE_MANHATTAN) || (ENABLE_MESSI) || (ENABLE_MASERATI) || (ENABLE_MACAN) || (ENABLE_MUSTANG) || (ENABLE_MILAN)
