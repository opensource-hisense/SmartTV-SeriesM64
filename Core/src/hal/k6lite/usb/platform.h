...
#if (ENABLE_MACAN) || (ENABLE_K6) || (ENABLE_K6LITE)
	// for 28 nm
...
/****** Porting environment setting ******/
	...
	/* virtual address to physical address translation */
			...
			#define MIU1_BUS_BASE_ADDR	CONFIG_MIU1_BUSADDR
			#define MIU1_PHY_BASE_ADDR	0x80000000UL
		#elif (ENABLE_K6) || (ENABLE_K6LITE)
			#define ENABLE_USB_NEW_MIU_SEL	1	/* Unit: 4GB / 16 = 256MB */
			#define USB_MIU_SEL0	0x30	/* MIU0: 1GB */
			#define USB_MIU_SEL1	0x74	/* MIU1: 1GB */
			#define USB_MIU_SEL2	0xEF	/* invalid (low bound > high bound) */
			#define USB_MIU_SEL3	0xEF	/* invalid (low bound > high bound) */
			#define MIU0_BUS_BASE_ADDR	CONFIG_MIU0_BUSADDR
			#define MIU0_PHY_BASE_ADDR	0x00000000UL
			#define MIU1_BUS_BASE_ADDR	CONFIG_MIU1_BUSADDR
			#define MIU1_PHY_BASE_ADDR	0x40000000UL
...
#if (ENABLE_MONACO) || (ENABLE_MIAMI) || (ENABLE_MUJI) || (ENABLE_CELTICS) || \
	(ENABLE_MASERATI)
#define XHCI_PORT0_ADDR		(HW_BASE+(0x090000 << 1)+0x0440)
#define XHCI_PORT1_ADDR		(HW_BASE+(0x090000 << 1)+0x0450)
#define MSTAR_U3TOP_BASE	(HW_BASE+(0x22500 << 1))
#define MSTAR_U3PHY_P0_A_BASE	(HW_BASE+(0x22100 << 1))
#define MSTAR_U3PHY_P0_D_BASE	(HW_BASE+(0x11C00 << 1))
#define MSTAR_U3PHY_P1_A_BASE	(HW_BASE+(0x53500 << 1))
#define MSTAR_U3PHY_P1_D_BASE	(HW_BASE+(0x53300 << 1))
#elif (ENABLE_KANO)
#define XHCI_PORT0_ADDR		(HW_BASE+(0xC0000 << 1)+0x0440)
#define XHCI_PORT1_ADDR		(HW_BASE+(0xC0000 << 1)+0x0450)
...
#define XHCI_PORT0_ADDR		(HW_BASE+(0x090000 << 1)+0x0430)
#define MSTAR_U3TOP_BASE	(HW_BASE+(0x22500 << 1))
#define MSTAR_U3PHY_P0_A_BASE	(HW_BASE+(0x22100 << 1))
#define MSTAR_U3PHY_P0_D_BASE	(HW_BASE+(0x11C00 << 1))
#elif (ENABLE_K6)
#define XHCI_PORT0_ADDR		(HW_BASE+(0x0F0000 << 1)+0x0430)
#define MSTAR_U3TOP_BASE	(HW_BASE+(0x40200 << 1))
#define MSTAR_U3PHY_P0_A_BASE	(HW_BASE+(0x02100 << 1))
#define MSTAR_U3PHY_P0_D_BASE	(HW_BASE+(0x02000 << 1))
#endif
...
#define MSTAR_UHC_BASE   (HW_BASE+(0x2400 << 1))
	...
	(ENABLE_MANHATTAN) || (ENABLE_MESSI) || (ENABLE_MASERATI) || (ENABLE_MACAN) || (ENABLE_K6LITE)
	#define MSTAR_BC_BASE	(HW_BASE+(0x23600 << 1))
#elif (ENABLE_KRATOS) || (ENABLE_KIWI)
	#define MSTAR_BC_BASE	(HW_BASE+(0x20500 << 1))
#elif (ENABLE_KANO) || (ENABLE_CURRY) || (ENABLE_K6)
