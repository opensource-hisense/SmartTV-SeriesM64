...
//****************************************************
// DAC Drive Chip           : Kronus1_DAC_Driver
...
// SC1_INIT  480I_60
//****************************************************
MS_U8 MST_DAC_480I_60_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT_SC 480I_60
//****************************************************
MS_U8 MST_DAC_480I_60_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  480P_60
//****************************************************
MS_U8 MST_DAC_480P_60_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT_SC 480P_60
//****************************************************
MS_U8 MST_DAC_480P_60_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  576I_50
//****************************************************
MS_U8 MST_DAC_576I_50_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT_SC 576I_50
//****************************************************
MS_U8 MST_DAC_576I_50_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  576P_50
//****************************************************
MS_U8 MST_DAC_576P_50_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT_SC 576P_50
//****************************************************
MS_U8 MST_DAC_576P_50_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  720P_50
//****************************************************
MS_U8 MST_DAC_720P_50_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT_SC 720P_50
//****************************************************
MS_U8 MST_DAC_720P_50_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  720P_60
//****************************************************
MS_U8 MST_DAC_720P_60_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT_SC 720P_60
//****************************************************
MS_U8 MST_DAC_720P_60_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  1080I_50
//****************************************************
MS_U8 MST_DAC_1080I_50_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
//****************************************************
MS_U8 MST_DAC_1080I_50_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  1080I_60
//****************************************************
MS_U8 MST_DAC_1080I_60_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
//****************************************************
MS_U8 MST_DAC_1080I_60_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  1080P_50
//****************************************************
MS_U8 MST_DAC_1080P_50_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
//****************************************************
MS_U8 MST_DAC_1080P_50_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  1080P_60
//****************************************************
MS_U8 MST_DAC_1080P_60_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
//****************************************************
MS_U8 MST_DAC_1080P_60_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  1080P_30
//****************************************************
MS_U8 MST_DAC_1080P_30_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
//****************************************************
MS_U8 MST_DAC_1080P_30_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  1080P_25
//****************************************************
MS_U8 MST_DAC_1080P_25_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
//****************************************************
MS_U8 MST_DAC_1080P_25_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  1080P_24
//****************************************************
MS_U8 MST_DAC_1080P_24_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
//****************************************************
MS_U8 MST_DAC_1080P_24_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  640x480_60
//****************************************************
MS_U8 MST_DAC_640x480_60_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
//****************************************************
MS_U8 MST_DAC_640x480_60_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
