...
//******************************************************************************
//<MStar Software>
#ifndef __eMMC_KERES_UBOOT__
#define __eMMC_KERES_UBOOT__
...
#define BIT_eMMC_RSTPIN_EN      BIT5

#define reg_chiptop_0x50        GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x50)
#define BIT_ALL_PAD_IN          BIT15

#define reg_nf_en               GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x08)
#define BIT_NAND_CFG_MASK       (BIT4|BIT5)
#define BIT_SD_CFG_MASK         (BIT8|BIT9)
#define BIT_EMMC_CFG_MASK       (BIT0|BIT1)
#define BIT_EMMC_MODE1          BIT0
#define BIT_EMMC_MODE2          BIT1
#define BIT_EMMC_MODE3          (BIT0|BIT1)

#define reg_gpio_pe            GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x27)
#define BIT_GPIO2_PE            BIT3
#define BIT_GPIO4_PE            BIT11

#define reg_ci_a_pe             GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x24)
#define reg_ci_c_pe             GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x25)
#define reg_ci_d_pe             GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x26)
#define BIT_GPIO8_PE            BIT14
#define BIT_GPIO8_PS            BIT15


#define eMMC_RST_L()    {REG_FCIE_SETBIT(reg_chiptop_0x36, BIT_eMMC_RSTPIN_EN);\
	                     REG_FCIE_CLRBIT(reg_chiptop_0x36, BIT_eMMC_RSTPIN_VAL);}
#define eMMC_RST_H()     REG_FCIE_SETBIT(reg_chiptop_0x36, BIT_eMMC_RSTPIN_EN|BIT_eMMC_RSTPIN_VAL)
...
#define DMA_MBOOT_ADDR                      0x82000000
