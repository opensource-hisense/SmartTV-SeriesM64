...
//******************************************************************************
//<MStar Software>
#ifndef __eMMC_CURRY_UBOOT__
#define __eMMC_CURRY_UBOOT__
...
#define BIT_CKG_MPLL_GATING             BIT0
#define BIT_CKG_MPLL_INVERSE            BIT1
#define BIT_CLKGEN2_CLK_SEL_MASK        (BIT3|BIT2)
#define BIT_CLKGEN2_CLK_SEL             BIT2
...
#define BIT_SD_CONFIG                   (BIT9|BIT8|BIT7)
#define BIT_NAND_MODE                   (BIT6|BIT5|BIT4)
...
#define reg_emmcpll_0x01                GET_REG_ADDR(EMMC_PLL_BASE, 0x01)
#define REG_EMMC_PLL_RX01               reg_emmcpll_0x01
...
#define reg_emmcpll_0x72                GET_REG_ADDR(EMMC_PLL_BASE, 0x72)
...
#define FCIE_SLOW_CLK                   BIT_CLK_XTAL_12M
