...
//******************************************************************************
//<MStar Software>
#ifndef __UNFD_MARLON_UBOOT_H__
#define __UNFD_MARLON_UBOOT_H__
...
// Pads Switch
//=====================================================
#define REG_NAND_MODE_MASK					(BIT1|BIT0)
#define NAND_MODE1							(BIT0)				//NAND_AD
#define NAND_MODE2							(BIT1)				//PCM_A
#define NAND_MODE3							(BIT1|BIT0)			//TCON

#define reg_pcm_a_pe                        GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x06)

#define reg_allpad_in           			GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x50)
#define reg_nf_en                           GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x27)

#define BIT_SPI_NOR_MODE					BIT3
#define BIT_SPI_NAND_MODE					BIT4
#define reg_spi_mode						GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x04)

#define BIT_NAND_SHARE_TCON					BIT14
#define BIT_NAND_SHARE_MODE					BIT15
#define reg_nand_share_mode					GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x1D)
...
#define NFIE_CLK_75K                        (11<<2)
#define NFIE_CLK_86_25M                     (12<<2)
