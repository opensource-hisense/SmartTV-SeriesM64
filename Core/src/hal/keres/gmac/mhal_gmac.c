...
void MHal_EMAC_trim_phy(void)
{
    ...
    uRegVal = MHal_EMAC_ReadReg8(0x0033, 0x60);
    uRegVal |= 0x04;
    MHal_EMAC_WritReg8(0x0033, 0x60, uRegVal);

    uRegVal = MHal_EMAC_ReadReg8(0x0033, 0x69);
    uRegVal |= 0x80;
    MHal_EMAC_WritReg8(0x0033, 0x69, uRegVal);

    // Set efuse value
    MHal_EMAC_WritReg8(0x0033, 0x68, uEfuVal0);
    ...
    uRegVal = MHal_EMAC_ReadReg8(0x0033, 0x61);
    uRegVal &= 0xF0;
    uRegVal |= uEfuVal2 << 2;
    uRegVal |= (uEfuVal1 & 0xC0) >> 6;
    MHal_EMAC_WritReg8(0x0033, 0x61, uRegVal);
}
