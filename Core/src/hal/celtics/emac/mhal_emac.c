...
void MHal_EMAC_ClkGen(void)
{
    ...
    MHal_EMAC_WritReg8(0x0034, 0xa1, 0x90);
    MHal_EMAC_WritReg8(0x0033, 0xcc, 0x40);
    MHal_EMAC_WritReg8(0x0033, 0xbb, 0x04);
    MHal_EMAC_WritReg8(0x0034, 0x8f, 0x02);
    MHal_EMAC_WritReg8(0x0034, 0xd5, 0x00);
    MHal_EMAC_WritReg8(0x0034, 0xd9, 0x00);
    MHal_EMAC_WritReg8(0x0034, 0xf7, 0x02);
    MHal_EMAC_WritReg8(0x0034, 0xfb, 0x02);
    MHal_EMAC_WritReg8(0x0034, 0xfd, 0x02);
