...
//******************************************************************************
//<MStar Software>
#ifndef __UNFD_K5TN_UBOOT_H__
#define __UNFD_K5TN_UBOOT_H__
...
#define reg_hv_sync_out            			GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x3e)
#define reg_s_gpio            			    GET_REG_ADDR(CHIPTOP_REG_BASE_ADDR, 0x3f)
