...
//******************************************************************************
//<MStar Software>
#ifndef __eMMC_KEYLA_UBOOT__
#define __eMMC_KEYLA_UBOOT__
...
#define eMMC_FCIE_VALID_CLK_CNT         12 // FIXME
...
#define eMMC_RST_L()                    {REG_FCIE_SETBIT(reg_chiptop_0x36, BIT_EMMC_SWRSTZ_EN);\
                                         REG_FCIE_SETBIT(FCIE_REG13h, BIT15);\
                                         REG_FCIE_CLRBIT(FCIE_REG13h, BIT14);}
#define eMMC_RST_H()                    {REG_FCIE_SETBIT(reg_chiptop_0x36, BIT_EMMC_SWRSTZ_EN);\
                                         REG_FCIE_SETBIT(FCIE_REG13h, BIT15);\
