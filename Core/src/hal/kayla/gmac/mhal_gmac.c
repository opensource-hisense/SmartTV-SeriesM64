...
void MHal_EMAC_ClkGen(void)
{
    ...
    MHal_EMAC_WritReg8(0x1033, 0x64, 0x0c);
    ...
    MHal_EMAC_WritReg8(0x0032, 0x77,  0x10);     // snr len (emc noise)
    ...
    MHal_EMAC_WritReg8(0x0033, 0xa1,  0x00);     // VBU
    ...
    MHal_EMAC_WritReg8(0x0031, 0xaa,  0x1c);
    ...
    //Set to 16x128 mode
    uRegVal = MHal_EMAC_ReadReg8(0x121c, 0x1b);
    uRegVal |= 0x60;
    MHal_EMAC_WritReg8(0x121c, 0x1b, uRegVal);
