...
void eMMC_DumpPadClk(void)
{
    ...
    switch(g_eMMCDrv.u8_PadType)
    {
        ...
        case FCIE_eMMC_GPIO_SDR:    eMMC_debug(0, 0, "FCIE_eMMC_GPIO_SDR\n");   break;
        case FCIE_eMMC_SDR:         eMMC_debug(0, 0, "FCIE_eMMC_SDR\n");        break;
        case FCIE_eMMC_DDR:         eMMC_debug(0, 0, "FCIE_eMMC_DDR\n");        break;
        case FCIE_eMMC_HS200:       eMMC_debug(0, 0, "FCIE_eMMC_HS200\n");      break;
        case FCIE_eMMC_HS400:       eMMC_debug(0, 0, "FCIE_eMMC_HS400\n");      break;
        default:
...
U32 eMMC_pads_switch(U32 u32Mode)
{
    ...
    REG_FCIE_CLRBIT(reg_emmcpll_0x20, BIT9|BIT10);                // reg_sel_internal

    REG_FCIE_CLRBIT(reg_emmc_test, BIT10|BIT5|BIT4);
    ...
    REG_FCIE_CLRBIT(reg_emmcpll_0x69, BIT11);
    ...
    REG_FCIE_CLRBIT(reg_emmcpll_0x70, BIT11|BIT10|BIT8);    // reg_sel_flash_32bif
    ...
    REG_FCIE_CLRBIT(reg_emmcpll_0x7f, BIT3|BIT2|BIT1);
    ...
    switch(u32Mode)
    {
        ...
        case FCIE_eMMC_GPIO_SDR:
            REG_FCIE_SETBIT(FCIE_DDR_MODE, BIT_CLK2_SEL|BIT_PAD_IN_SEL_SD|BIT_FALL_LATCH);
        ...
        case FCIE_eMMC_HS200:
            ...
            eMMC_debug(eMMC_DEBUG_LEVEL_LOW, 0, "FCIE_eMMC_HS200 AFIFO\n");
            #else
            eMMC_debug(eMMC_DEBUG_LEVEL_LOW, 0, "FCIE_eMMC_HS200\n");
            #endif
            ...
            REG_FCIE_SETBIT(reg_emmc_test, BIT5|BIT4); //Brian debug

            REG_FCIE_SETBIT(reg_emmcpll_0x1c, BIT8);            //meta issue of clk4x and skew
            REG_FCIE_CLRBIT(reg_emmcpll_0x1c, BIT9);

            REG_FCIE_CLRBIT(reg_emmcpll_0x1d, BIT8);               //meta issue of clk4x and skew
            REG_FCIE_CLRBIT(reg_emmcpll_0x1d, BIT9);            // reg_cmd_use_skew4
            ...
            REG_FCIE_SETBIT(reg_emmcpll_0x68, BIT0);            // reg_emmc_en
            REG_FCIE_CLRBIT(reg_emmcpll_0x68, BIT1);
        ...
        case FCIE_eMMC_HS400:
            #if defined(ENABLE_eMMC_AFIFO) && ENABLE_eMMC_AFIFO
            eMMC_debug(eMMC_DEBUG_LEVEL_LOW, 0, "FCIE_eMMC_HS400 AFIFO\n");
            #else
            eMMC_debug(eMMC_DEBUG_LEVEL_LOW, 0, "FCIE_eMMC_HS400\n");
            #endif
            ...
            REG_FCIE_CLRBIT(reg_emmcpll_0x7f, BIT3|BIT1);
            #endif
