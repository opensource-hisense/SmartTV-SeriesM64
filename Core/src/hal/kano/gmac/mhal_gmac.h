...
#define CONFIG_GMAC_ETHERNET_ALBANY
...
#define BMCR_SPEED_MASK  0x2040         /* Speed mask*/
#define BMCR_1000        0x0040         /* 1000Mbps*/
#define BMCR_100         0x2000         /* 100Mbps*/
#define BMCR_10          0x0000         /* 10Mbps*/
#define BMCR_DUPLEX_MASK 0x0100         /* Duplex mask*/
#define BMCR_FULL_DUPLEX 0x0100         /* Full duplex*/
#define BMCR_HALF_DUPLEX 0x0000         /* Half duplex*/
...
// Base address here:
#ifndef KANO_GMAC0
#define REG_ADDR_BASE						0x1F244000 		// The register address base. Depends on system define.
#else
#define REG_ADDR_BASE						0x1F243600 		// The register address base. Depends on system define.
#endif
#define RIU_REG_BASE                        0x1F000000
