...
s32 MHal_EMAC_CableConnection(void)
{
    ...
    {
        /* Disable reg_rgmii_slow */
        uRegVal = MHal_EMAC_ReadReg8(0x121f, 0x25);
        uRegVal &= 0xbf;
        MHal_EMAC_WritReg8(0x121f, 0x25, uRegVal);
...
void MHal_EMAC_ClkGen(void)
{
    ...
    /* Set GMAC ahb clock to 172MHZ */
    MHal_EMAC_WritReg8(0x100a, 0x03, 0x04);

    /* Enable GMAC tx clock */
    /* Enable GMAC rx clock */
    /* IO setting, enable TX delay */
    MHal_EMAC_WritReg8(0x121f, 0x22, 0x88);
    MHal_EMAC_WritReg8(0x121f, 0x23, 0x00);
    MHal_EMAC_WritReg8(0x121f, 0x24, 0x80);
    MHal_EMAC_WritReg8(0x121f, 0x25, 0x28);
    MHal_EMAC_WritReg8(0x121f, 0x26, 0x02);
    MHal_EMAC_WritReg8(0x121f, 0x27, 0x0e);
    MHal_EMAC_WritReg8(0x121f, 0x20, 0x00);
    MHal_EMAC_WritReg8(0x121f, 0x21, 0x02);

    /* Enable GT0 */
    MHal_EMAC_WritReg8(0x101e, 0x0c, 0x01);
    ...
    MHal_EMAC_write_phy(0x0,0x1f,0x0007);
    MHal_EMAC_write_phy(0x0,0x1e,0x00a4);
    MHal_EMAC_write_phy(0x0,0x1c,0xad91);
    MHal_EMAC_write_phy(0x0,0x1f,0x0000);
#endif
#endif
}
